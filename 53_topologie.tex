...
\begin{propositionDef}[Groupe des isométries]
    ...
    \begin{enumerate}
        \item
            l'ensemble des isométries de \( X\), noté \( \Isom(X)\)\nomenclature[Y]{$\Isom(X)$}{Le groupe des isométries de \( X\)} est un groupe pour la composition\index{isométrie!groupe}\index{groupe!des isométries}.
        \item
...
\begin{InternalLinks}
    Quelque résultats autour de la connexité.
    \begin{enumerate}
        \item
    ...
    \end{enumerate}
            Par ailleurs \( \SO(n)\) est connexe mais ce n'est pas encore démontré.
\end{InternalLinks}
