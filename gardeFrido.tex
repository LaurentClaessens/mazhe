...
% Ce fichier est inclu à 'gardeVolume' pour être compilé séparément pour la division en volumes.
% Il est donc inutile de faire des choses ici lorsque 'isBook' est true. En effet 'isBook' sert
% à créer la version qui va être divisée en volumes, et pour cette division, une recompilation 
...
\begin{center}
    ...
    \today\\
    \notbool{isBook}{ \texttt{\GitCommitHexsha} }{}
