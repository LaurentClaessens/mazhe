...
\begin{definition}      \label{DefFMTEooMjbWKK}
    ...
    \begin{enumerate}
        ...
        \item
            ...
            \begin{equation}
                m(B)=\int\{ m(\Omega)\tq\text{\( \Omega\) est ouvert et \( B\subset \Omega\)} \}
            \end{equation}
        \item
            ...
            \end{equation}
        \item
            \( m\) est une \defe{mesure de Radon}{mesure!de Radon} si elle est de Borel et régulière dans les deux sens.
    \end{enumerate}
\end{definition}
...
\begin{proof}
    ...
    Si \( a<m(B)\) alors il existe \( k\geq 1\) tel que \( a<m(B\cap X_k)\). La (restriction de la) mesure \( m\) à \( X_k\) est bornée (parce que \( m\) est une mesure de Borel). Par conséquent \( m\) est une mesure régulière sur \( \big( X_k,\Borelien(X_k) \big)\) par le théorème \ref{ThoPKGEooVrpsGU} et il existe un compact \( K\) de \( (X_k,\tau_k)\) tel que \( K\subset B\cap X_k\) et 
    \begin{equation}
        m(B\cap X_k)-m(K)<a.
    \end{equation}
    <++>
