...
De la même façon nous construirons le produit d'une mesure par une fonction en la propriété \ref{PropooVXPMooGSkyBo}.
...
\begin{proof}
    La fonction caractéristique est une fonction simple. Donc elle réalise le supremum de la définition \ref{EqDefintYfdmu}.
\end{proof}
