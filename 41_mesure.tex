...
%--------------------------------------------------------------------------------------------------------------------------- 
\subsection{Mesurabilité des fonctions à valeurs réelles}
%---------------------------------------------------------------------------------------------------------------------------
...
\begin{theorem}\label{THOooXHIVooKUddLi}       
    Une fonction mesurable à valeurs dans \( \bar \eR^+\) est limite croissante de fonctions étagées.
    % position 17992-24111
\end{theorem}
<++>
...
\begin{proposition}[\cite{MonCerveau}]  \label{PropooJMWAooDzfpmB}
    Si \( f\) et \( g\) sont des fonctions mesurables alors \( f\cdot(g\cdot\mu=(fg)\cdot \mu)\).
\end{proposition}
<++>
