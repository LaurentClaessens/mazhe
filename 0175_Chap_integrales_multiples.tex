...
Une des nombreuses formes du théorème de Stockes (théorème \ref{ThoATsPuzF}) est que si la forme différentielle \( \omega\) est exacte alors son intégrale est facile.
...
Justifions le fait que cela soit un cas particulier de la formule de Stockes du théorème \ref{ThoATsPuzF}. Nous considérons la forme différentielle
\begin{equation}
    \omega=Pdx+Qdy,
\end{equation}
...
\end{equation}
Par conséquent la formule de Stockes nous donne la formule \eqref{EqYLblSqV}.
