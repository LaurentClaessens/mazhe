...
%\item Soit $\mathbf{v}_\theta=(\cos\theta,\sin\theta)$. Calculer $\frac{\partial f}{\mathbf{v}_\theta}(0,0)$ pour tout $\theta$ dans l'intervalle $[0,2\pi]$. Attention, puisque $f$ n'est pas différentiable on ne peut pas utiliser la formule $\nabla f\cdot \mathbf{v}_\theta$, il faut utiliser définition.
\end{enumerate}
