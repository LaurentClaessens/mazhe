...
\begin{remark}[Assurances et réservoir percé]
...
\begin{remark}[Terminologie anglaise]
...
\FIG{llid}{1}{htbp}{Illustration de la loi du log. itéré de Strassen (distance
  à $[-\si,+\si]$).}
%
\begin{remark}[Sens des simulations]
...
%DCD section 4.4, pages 101 et suivantes. 
% «Ãchantillon d'une loi et estimation de cette loi»
...
$$
(\dP_\te)_{\te\in\Te}:=\BRA{\cN(m,\si^2),\,(m,\si^2}\in \eR\times \eR^2}.
$$
...
Considérons un phénomène aléatoire de loi inconnue $P=p_1\de_1+\cdots+p_k\de_k$ oÃ¹
...
\begin{remark}[Fonctions de répartition et densité]
...
\begin{remark}[Densité au sens de la théorie des distributions]
...
%
\begin{remark}[Schéma de Bernoulli]\label{ss:loi:schema-bernoulli}
...
La loi hypergéométrique de paramètres $(N,N_1,n)\in\dN^*Ã\dN^*Ã\dN^*$
