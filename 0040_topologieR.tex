...
\begin{lemma}\label{LemOACGWxV}[\cite{JUwQXOF}]
...
\begin{theorem}[\cite{OCBrmKo}] % Ne pas mettre de label ici parce que ce résultat n'est pas censé être utilisé dans l'agrégation.
