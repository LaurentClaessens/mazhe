...
La convergence normale est à ne pas confondre avec la convergence uniforme. La somme \( \sum_nf_n\) \defe{converge uniformément}{convergence!uniforme!série de fonctions} si la suite des sommes partielles converge uniformément, c'est à dire si 
\begin{equation}
