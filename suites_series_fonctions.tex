...
\begin{proof}
    ...
    \end{equation}
    Étant donné que la série de gauche diverge, celle de droite diverge\footnote{Nous utilisons le fait que si \( u_n\sumv_n\) en tant que suites et si \( \sum_nu_n\) diverge, alors \( \sum_nv_n\) diverge.}.
    ...
    \end{equation}
    Il suffit de prouver que \( \phi_m\in \bar V\) pour tout \( m\) parce que le théorème de Stone-Weierstrass \ref{} montre que \( \Span\{ \phi_k\tq k\in \eN \}\) est dense dans \( C\).
