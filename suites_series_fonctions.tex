...
Nous allons donner deux énoncés. Le théorème \ref{ThoWTMSthY} insiste sur la mesurabilité des fonctions intermédiaires, tandis que le théorème \ref{ThoFubinioYLtPI} insiste sur l'intégrabilité. De plus le premier demande que la fonction soit à valeurs positives.
\begin{theorem}[Fubini-Tonelli] \label{ThoWTMSthY}
...
\begin{theorem}     \label{ThoFubinioYLtPI}
    Soient \( \mu_i\) des mesures \( \sigma\)-finies sur les espaces mesurables \( (\Omega_i,\tribA_i)\) ($i=1,2$). Nous considérons une fonction \( f\colon \Omega_1\otimes\Omega_2\to \eR,\eC\) mesurable pour la tribu \( \tribA_1\otimes \tribA_2\) et intégrable pour la mesure \( \mu_1\otimes \mu_2\). Alors
    \begin{enumerate}
        \item
