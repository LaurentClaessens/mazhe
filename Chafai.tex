Cette partie est entièrement pompée du cours \cite{ChaDjelil}. Je vous conseille d'aller lire là-bas parce que pour des raisons techniques j'ai dû enelever des figures et un bon paquets d'exemples. Bref, l'original est bien meilleur que ce que vous allez trouver ici.
...
la calculer.
Comme nous allons le voir ultérieurement dans la section \ref{ss:test-ks} page \pageref{ss:test-ks}, cette convergence en loi permet de
...
nulle.
Quelques exemples de transformées de Cramér sont donnés dans la table \ref{tab:exple-transfo-cramer}.
