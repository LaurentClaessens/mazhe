...
\begin{theorem}[Lax-Milgram\cite{ooRIEKooXIQYhE}]
    ...
    \begin{subproof}
        ...
        \item[\( A\) est linéaire]
            ...
            \item[Une contraction]
                ...
                Nous allons choisir une valeur de \( \rho\) telle que l'application
                \begin{equation}
                    T\colon w\mapsto w-\rho\big( A(w)-f \big)
                \end{equation}
                soit une contraction\footnote{Définition \ref{DEFooRSLCooAsWisu}.}.
