...
%TODO : je verrais bien ici le résultat qui dit qu'une appl linéaire est continue si et seulement si elle est bornée.
...
\begin{proposition} \label{PropEDvSQsA}
    Si \( E\) est un espace vectoriel (pas spécialement de dimension finie), alors la norme opérateur est une norme d'algèbre sur \( \GL(E)\) :
    \begin{equation}
        \| AB \|\leq \| A \|\| B \|
    \end{equation}
