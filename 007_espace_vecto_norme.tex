...
\begin{definition}  \label{DefJWRWQue}
    ...
    \end{equation}
\end{definition}
L'intérêt d'une norme matricielle est entre autres de mieux se comporter pour les séries, voir par exemple \ref{subsecEVnZXgf}.

\begin{proposition} \label{PropEDvSQsA}
    Si \( E\) est un espace vectoriel (pas spécialement de dimension finie), alors la norme opérateur est une norme matricielle sur \( \GL(E)\) :
    \begin{equation}
        \| AB \|\leq \| A \|\| B \|
    \end{equation}
