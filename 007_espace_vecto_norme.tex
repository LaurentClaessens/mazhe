...
\begin{proof}
    D'abord la série converge normalement\footnote{Définition \ref{DefVBrJUxo}.} parce que \( \| h^k \|\leq \| h \|^k\) et que la série des \( \| h \|^k\) est la série géométrique qui converge.
