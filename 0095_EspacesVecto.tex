...
Étant donné une forme quadratique, la forme bilinéaire peut être retrouvée grâce aux \defe{identités de polarisation}{identité!polarisation}\index{polarisation (identité)} :
