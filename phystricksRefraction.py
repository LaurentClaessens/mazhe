...
def Refraction():
    ...
    theta1.put_mark(0.3,theta1.advised_mark_angle,r"$\theta_1$",automatic_place=pspict)
    theta2.put_mark(0.3,theta2.advised_mark_angle,r"$\theta_2$",automatic_place=pspict)
