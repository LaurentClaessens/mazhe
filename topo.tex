...
\begin{example}[Riemann sphere]
    The \defe{Riemann sphere}{Riemann!sphere} is the one point compactification of \( \eC\). As far as the arithmetic is concerned we define \( \frac{1}{ 0 }=\infty\) and \( \frac{ 1 }{ \infty }=0\). 
\end{example}
