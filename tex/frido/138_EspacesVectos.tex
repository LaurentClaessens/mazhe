...
\begin{definition}[\cite{ooAFBYooYvTCCN}]
    ...
    \end{equation}
%TODO: je trouve qu'il faudrait une definition pour cette notation \( [\lambda,v]\), parce que sinon, c'est le crochet de Lie ?   Ou alors n'utiliser que \( \lambda\otimes v\) ?
...
\begin{equation}
    \begin{aligned}
%TODO: iota ou tau comme la preuve l'utilise ci-dessous ?
        \tau \colon E & \to E_{\eL}     \\
                    v & \mapsto [1,v].
    \end{aligned}
\end{equation}
...
%TODO: faux quelque part: les domaines ne correspondent pas f o h doit aller comme g, de E vers G   ??
