...
\begin{lemma}[\cite{BIBooVRRDooOMSQYt}]       \label{LEMooIRVQooHvoNBq}
...
\begin{proof}
    Nous commençons par donner une expression à notre \( \rho\). Un élément de \( \Poly_n(A)\) est de la forme \( \sum_{m\in \eN^n}a_me_m\), et nous avons
    \begin{equation}
