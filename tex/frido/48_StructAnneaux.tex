...
Voici pour commencer la table de multiplication de \( A=\eZ/6\eZ\) :
...
\begin{lemma}[\cite{MonCerveau}]
    L'anneau \( \eZ/6\eZ\) est noetherien.
\end{lemma}

\begin{proof}
    Vu que c'est un anneau fini, toute suite croissante de quoi que ce soit devient stationnaire.
\end{proof}
<++>
