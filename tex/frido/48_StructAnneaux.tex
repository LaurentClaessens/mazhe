...
%---------------------------------------------------------------------------------------------------------------------------
Je veux \myurl{https://fr.wikipedia.org/wiki/Idéal_premier} et c'est tout.
...
\begin{proposition}[\cite{ooJHFCooSbHtEC,MonCerveau}, thème \ref{THEMEooVIQIooOcFAQS}]     \label{PROPooZICGooNmblhl}
	...
	\begin{enumerate}
		...
		\item   \label{ITEMooHPAIooYoQzqD}
		      \( (p)\) est un idéal maximum propre\quext{Ce «propre» n'est pas dans l'énoncé sur Wikipédia. Je ne comprends pas pourquoi, et j'ai posé la question sur la page de discussion.\\\myurl{https://fr.wikipedia.org/wiki/Idéal_premier}}.
	\end{enumerate}
\end{proposition}
