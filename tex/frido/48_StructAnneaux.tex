...
\end{equation}
De plus \( \pgcd\{ a_n \}\) est l'unique diviseur commun des \( a_i\) à être un multiple des autres\quext{Je ne sais plus d'où j'ai recopié cette phrase et je ne comprends pas ce qu'elle veut dire. Si le lecteur a une idée, il peut me la faire savoir.}.
\end{proposition}
