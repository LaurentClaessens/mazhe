...
\begin{remark}
    La notion de module généralise celle d'espace vectoriel que nous verrons plus loin (définition \ref{DEFooKHWZooIfxdNc}).
\end{remark}
...
\begin{proposition}[\cite{MonCerveau}] \label{PropomqcGe}
...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[\ref{ITEMooMQWVooNocVEU} implique \ref{ITEMooJBXGooEISNuW}]
            ...
            Maintenant \( I\) est un idéal premier non réduit à \( \{ 0 \}\). Vu que \( A\) est un anneau principal, il existe \( x\in A\) tel que \( I=(x)\). Nous devons prouver que \( x\) peut être choisit irréductible; et nous allons faire plus : nous allons prouver que \( x\) ne peut être que irréductible\quext{ça me semble un peu trop facile. Lisez attentivement, et écrivez-moi pour dire sit vous êtes d'accord ou pas.}.
