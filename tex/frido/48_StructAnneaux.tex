...
\begin{proof}
	...
	\begin{subequations}\label{EqBinTrav}
		...
		\end{align}
	\end{subequations}
	Notez le passage de \eqref{PROPooYCLBooOLoDnM} à \eqref{SUBEQooRURMooGVIbbL} qui demande crucialement la commutativité de la multiplication. La formule binomiale ne se généralise pas de façon directe à un anneau non commutatif.
