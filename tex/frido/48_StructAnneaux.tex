...
\begin{probleme}
Il semble que l'on n'ait pas encore parlé d'idéal maximum... ni d'idéal premier au passage. De plus, la propriété a été dupliquée: voir proposition \ref{PROPooSHHWooCyZPPw2}.
\end{probleme}
...
\begin{proposition} \label{PROPooSHHWooCyZPPw2}
