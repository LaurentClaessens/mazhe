...
\begin{definition}  \label{DeirredBDhQfA}
    Soit \( A\) un anneau commutatif intègre. Un élément \( a\inA\) est \defe{irréductible}{irréductible!dans un anneau} si \( a\) n'est pas inversible, mais si \( a=xy\), alors soit \( x\) soit \( y\) est inversible.
\end{definition}
...
On dit qu'un triplet pythagoricien est \defe{primitif}{primitif!triplet pythagoricien} si les trois nombres solution sont premiers dans leur ensemble\footnote{Définition \ref{DefZHRXooNeWIcB}.}.
...
La \defe{valuation}{valuation!d'un polynôme} de \( P\) du polynôme \( P=\sum_n a_nX^n\), notée \( \val(P)\), est 
\begin{equation}
    \val(P)=\min\{ n\tq a_n\neq 0 \}.
\end{equation}
