...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[Si \( a>0\) et \( b<0\)]
            ...
            Alors \( a=-q_0b+r_0\), et le couple \( (-q_0,r_0)\) et le couple \( (q_0,r_0)\) vérifie les conditions de la définition \ref{DefAXitWRL}\ref{ITEMooLVJAooLpjgEz}.


        \item[Si \( a<0\) et \( b>0\)]
            Alors \( a=-q_0b-r_0\), et le couple \( (-q_0,-r_0)\) et le couple \( (q_0,r_0)\) vérifie les conditions de la définition \ref{DefAXitWRL}\ref{ITEMooLVJAooLpjgEz} parce que
            \begin{equation}
...
\begin{lemma}[\cite{ooRQHSooEBZpKe}]
...
\begin{proof}
    ...
    \item[Un idéal principal contenant \( a\) et \( X\) est \( A[X]\)]
            ...
            Vu que \( P\) divise \( X\), nous avons aussi \( X=kQ\) pour un certain \( Q\in \eZ[X]\). Les degrés disent qu'il existe \( k'\in A\) tel que \( Q=k'X\) et donc \( Q=k'X=k'kQ\). Par conséquent \( kk'=1\). Les seules possibilités sont \( k=k'=1\) et \( k=k'=-1\). Dans les deux cas, \( 1\) ou \( -1\) est dans \( (P)\) et donc \( (P)=A\).

        \item[Si \( (a,X)=A[X]\) alors \( a\) est inversible ]
    \end{subproof}
    <++>
\end{proof}
<++>
