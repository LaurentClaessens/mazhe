...
\begin{proof}
    ...
    \begin{equation}
        \bar Q_1=\{ Q_1+RP\tq R\in A[X] \}.
    \end{equation}
    Le produit donne
    \begin{subequations}
        \begin{align}
        (Q_1+R_1P)(Q_2+R_2P)&=Q_1Q_2+Q_1R_2P+R_1Q_2P+R_1PR_2P\\
        &=Q_1Q_2+(Q_1R_2+R_1Q_2+R_1PR_2)P\\
        &\in \overline{ Q_1Q_2 }.
        \end{align}
    \end{subequations}
\end{proof}
...
\begin{normaltext}
    Nous considérons un polynôme \( P\in A[X]\), et le quotient \( A[X]/(P)\). Vu la définition du produit nous avons en particulier
    \begin{equation}
        \bar X\bar X=\bar X^2=\overline{ X^2 }.
    \end{equation}
    Et aussi, pour tout polynôme \( Q\in A[X]\), les égalités importantes
    \begin{equation}
