...
\begin{definition}
    Un problème aux limite \defe{de Dirichlet}{problème!limite de Dirichlet} est d'imposer la condition
    \begin{equation}
        u(x)=g(x)
    \end{equation}
...
\begin{definition}
    ...
    \end{enumerate}
    La continuité est au sens des normes sur les fonction sur \( \partial\Omega\) et sur \( \Omega\) en ce qui concerne les fonctions «données» du problème et des normes pour les fonctions sur \( \Omega\) ou \( \bar\Omega\) en ce qui concerne la solution.
\end{definition}
