...
\begin{example}
    ...
    \begin{equation}
        ...
        \end{pmatrix}.
    \end{equation}
    Son polynôme caractéristique est \( \lambda^2-2\) dont les racines sont \( \pm\sqrt{2}\). La signature est donc \( (1,1)\) et nous sommes en présence d'une conique de genre hyperbole. Nous cherchons le centre en posant \( x=\tilde x+x_0\), \( y=\tilde y+y_0\) et en cherchant à annuler les termes du premier ordre. Le système à résoudre est
    \begin{subequations}
        \begin{numcases}{}
            x_0+y_0-3=0\\
            x_0-y_0+1=0,
    ...
    \begin{equation}
        X^2-Y^2-1=0.
    \end{equation}
    Cela revient à effectuer le changement de base
    ...
    \begin{equation}
        ...
        \end{pmatrix}.
    \end{equation}
%TODO: Inconsistent : l'inverse de la matrice ne donne pas le systeme d'equations !!!! ERROR
...
\begin{proposition}     \label{PROPooALXYooHoMdqQ}
    ...
    \end{enumerate}
%TODO: Kesako ? D'ou vient ce deuxieme ensemble affE'?   Melange f et u_{f} ????  injective <=> surjective ?
...
%TODO : a,b,c representent les poids, non ? Donc c'est leur somme qui vaut 1 et pas x+y+z ??!!!!
