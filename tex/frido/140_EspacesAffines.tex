...
\begin{proof}
    ...
    \end{equation}
    pour tout \( x\) et \( M\). De plus l'application \( u_f\) ne dépend ni de \( M\) ni de \( x\) (c'est la proposition \ref{ooSKCYooHyRZYN}\ref{ITEMooSKCYooHyRZYN}). En posant \( M=0\) nous avons :
    \begin{equation}
