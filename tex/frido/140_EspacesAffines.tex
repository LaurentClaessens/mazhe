...
\begin{definition}
    Soit \( E\), un espace vectoriel. Un \defe{espace affine modelé sur}{affine!espace} \( E\) est un ensemble \( \affE\) sur lequel le groupe \( (E,+)\) agit à droite transitivement et librement.
\end{definition}
...
\begin{definition}[Ensemble convexe]        \label{DEFooQQEOooAFKbcQ}
    Une partie \( A\) d'un espace vectoriel est \defe{convexe}{ensemble convexe} si pour tout \( a,b\in A\) et pour tout \( t\in \mathopen[ 0 , 1 \mathclose]\), le point \( ta+(1-t)b\) est dans \( A\).
