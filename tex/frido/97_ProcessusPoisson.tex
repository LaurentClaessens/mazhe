...
On trouve différentes définitions de processus de Poisson dans la littérature. Nous allons définir des processus de a-Poisson, de c-Poisson et de n-Poisson., Ensuite nous démontrerons les équivalences.
