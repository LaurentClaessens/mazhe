...
% Copyright (c) 2012-2013, 2019, 2022-2024
%   Laurent Claessens
...
\begin{proof}
	...
	\begin{equation}
		...
		\end{aligned}
	\end{equation}
	nous avons l'équation différentielle \( y'(t)=f\big( t,y(t) \big)\). Le théorème de Cauchy-Lipschitz \ref{ThokUUlgU}\quext{Qui n'est pas cité dans \cite{BIBooORZFooWKgLCH}, ce qui me fait penser que soit je suis en train d'en faire trop, soit que je suis juste meilleur.} dit qu'il existe une unique solution. Il n'est pas compliqué de vérifier que la fonction
	\begin{equation}
