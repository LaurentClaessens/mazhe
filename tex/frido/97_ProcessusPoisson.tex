...
\begin{definition}      \label{DEFooWXHEooEHQUJU}
	...
	\end{equation}
    Plus explicitement, un processus de Poisson sur espace probabilisé \( (\Omega,\tribA,P)\) est une famille de variables aléatoires \( N_t\colon \Omega\to \eR\) telles que qu'il existe des variables aléatoires \( T_k\colon \Omega\to \eR\) vérifiant
    \begin{equation}
