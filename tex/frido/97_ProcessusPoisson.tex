...
\begin{theorem}[\cite{BIBooRYROooNrCDGy,BIBooMECWooHQJweh, MonCerveau}]
    Soit un processus de Poisson \(  \{ N_t\colon \Omega\to \eN \}_{t\in \eR^+}  \). Pour chaque \( n\in \eN\) nous posons
    \begin{equation}
        \begin{aligned}
