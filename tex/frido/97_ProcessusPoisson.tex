...
\begin{proof}
	...
	\begin{subequations}
		\begin{align}
			\int_{I_n}g(x_1,\ldots, x_n) & =\int_{a_1}^{b_1}\cdots\int_{a_n}^{b_n}\mtu_{x_1\leq \ldots\leq x_n}\lambda^n e^{-\lambda x_n}\,dx_1\ldots dx_n                                                 \\
			                             & =\int_{a_1}^{b_1}\cdots\int_{a_n}^{b_n}\lambda^n e^{-\lambda x_n}\,dx_1\ldots dx_n                              & \text{cf. justif.}\label{SUBEQooPMLZooJhEjds} \\
