...
\begin{proof}
%TODO: Je ne vois pas le rapport avec la proposition \ref{PROPooMXCDooBffXbl}.   Pourquoi \( a_k=j!\) ??
	La formule de Hadamard de la proposition \ref{PROPooMXCDooBffXbl} est à utiliser avec \( a_k=j!\). Nous avons
	\begin{equation}
%TODO: pas k, mais n, l'indice ?
...
%TODO: A quoi sert ce subequations ?? Probleme de copier-coller ?
\begin{subequations}
	\begin{numcases}{}
		x=r\cos\theta\\
		y=r\sin\theta
...
%TODO: Je ne comprends pas le commentaire: c'est pas cosinus autour de x=pi/3 ??? Manque une légende sur les courbes !!!
