...
Soit un espace vectoriel \( E\) de dimension \( 2\) muni d'un produit scalaire\footnote{}<++>. Cela pourrait très bien être \( \eR^2\), mais nous allons nous efforcer de l'appeler \( E\) pour reste un peu général.
