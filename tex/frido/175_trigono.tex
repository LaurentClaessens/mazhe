...
Une des idées fortes de cette section est que l'application \( \varphi\) est bijective et continue, mais pas d'inverse continu. Elle sera toutefois borélienne d'inverse borélien, ce qui permet de transposer la structure d'espace mesuré de \( \mathopen[ 0 , 2\pi \mathclose[\) à \( S^1\) sans devoir faire la pirouette usuelle comme quoi \( \varphi\) est un difféomorphisme \( \mathopen] 0 , 2\pi \mathclose[\to S^1\setminus\{ (1,0) \}\), alors que un seul point n'est pas important pour les intégrales.
...
\begin{remark}
    Deux remarques concernant l'ordre du polynôme.
    \begin{enumerate}
        \item
