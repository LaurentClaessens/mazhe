...
\begin{lemma}[Lemme de regroupement\cite{VincentBa}]\index{lemme de regroupement}  \label{LemHOjqqw}
	Soit \( (\Omega,\tribA,P)\) un espace de probabilité.
	\begin{enumerate}
		\item
		      Soit  \( (\tribA_i)_{i\in I}\) une famille de tribus indépendantes dans \( \tribA\). Si \( (M_j)_{j\in J}\) est une partition de \( I\), alors les tribus
		      \begin{equation}
