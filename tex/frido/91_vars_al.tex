...
Ce calcul semble être correct, mais il ne l'est pas. Dans ce calcul, nous n'avons pas inclus le fait que nous avons une des deux filles devant nous. Certes, nous pouvons penser que cela ne change rien. Oui oui, on peut le penser. Mais ici, on ne doit pas penser, on doit \emph{démontrer}. 

Comment faire mieux ? En faisant un calcul qui inlcus réellement tous les paramètres de la question. Dans l'histoire de la fille qui ouvre la porte, il s'est produit \( 3\) événements aléatoires : deux naissances et le «choix» de l'enfant qui ouvre la porte.
...
L'internet regorge de sites discuttant du paradoxe des deux enfants\footnote{Par exemple \cite{BIBooBXKDooOTEkjy}.}. Beaucoup insistent sur le fait que non seulement certaines informations apparament anodines sont importantes, mais en plus \emph{la façon} dont on obtient l'information est importante. Dans la situation «une fille ouvre», nous obtenons l'information «il y a au moins une fille» en en voyant une; dans la situation «la parent dit qu'il y a au moins une fille», nous obtenons l'information «il y a au moins une fille» de façon plus «pure».

Personnellement je ne souscris pas vraiment à cette façon de penser. Ma conclusion est plutôt que «sachant que» en mathématique ne signifie pas la même chose que «sachant que» en français. Pour obtenir «la bonne réponse», il ne suffit pas d'écrire \( P(A|B)\) en substituant \( A\) par la question posée et \( B\) par l'information que nous avons. Il faut de plus correctement construire les espaces probabilisés dans lesquels sont \( A\) et \( B\), et être sûr d'ajouter une variable aléatoire pour chaque événement aléatoire qui intervient dans l'histoire.
