...
\begin{proof}
	...
	\begin{subproof}
		...
		hop.
	\end{subproof}
	Voilà. J'espère que toutes les idées sont en place, et que les parties manquantes sont seulement des vérifications qui se font mécaniquement de la même manière\quext{Je n'ai pas vérifié. Faites-le et écrivez-moi pour me dire ce qui en est.}.
\end{proof}
...
\begin{proof}
	...
	\begin{subproof}
		...
		\end{equation}
		Et voilà, ce groupe \( G''\) est un de la liste.
