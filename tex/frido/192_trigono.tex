...
%TODO: qu'est ce que tu veux dire par ce "hop" ?
				hop.
			\end{subproof}
...
%TODO: A(u_3)= - \sin(\theta), ... et pas + \sin(\theta) ? Pb de signe quelque part.
		\sin(\theta) \\
		\cos(\theta)
...
%TODO: indent avec un subproof de plus: nous sommes dans des sous-cas de r=3, non ?
		\item[Si \( n_2=2 \)]
	...
	\begin{enumerate}
		...
		\item
		      ...
		      \begin{itemize}
			      ...
			      \item En déduire que \( T^{-1}\) est également \( C^p\) pour tout \( p\) en invoquant le théorème d'inversion locale \ref{ThoXWpzqCn}.
		      \end{itemize}
