...
\begin{lemma}[\cite{BIBooXOWGooAPWTfT}]
...
\begin{lemma}[\cite{BIBooTGBVooObvIHq}]
...
\begin{proposition}[\cite{BIBooXOWGooAPWTfT}]       \label{PROPooBWXMooLsgyKm}
    Deux formes quadratiques sont équivalentes\footnote{Définition \ref{}.} si et seulement si elles ont même signature.
\end{proposition}
