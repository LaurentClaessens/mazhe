...
\begin{remark}
    Quelque remarques à propos du signe\quext{Attention : je crois qu'il y a des incohérences dans le Frido à propos de ce choix}. 
    \begin{itemize}
        \item 
...
Le corollaire \ref{CorNHKnLVA} donne un résultat de diagonalisation simultanée de deux matrices définies positives. 
Nous dirons qu'il s'agit d'une \emph{pseudo}-diagonalisation pour rappeler que la base commune de diagonalisation ne sera en général pas orthonormée, ou, de façon équivalente, la matrice qui diagonalisera ne sera pas orthogonale. Cependant rien dans la définition de la diagonalisation (définition \ref{DefCNJqsmo}) n'impose que la base soit orthonormée. Il s'agit donc, à proprement parler d'une diagonalisation simultanée.
