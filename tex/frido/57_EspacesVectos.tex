...
\begin{proof}
    ...
    \end{equation}
%TODO: ca n'a pas de sens ici : j n'est pas défini. Mais admettons 
    Nous appliquons l'opérateur \( \prod_{k\neq j}(T-\lambda_k\mtu)\) à l'égalité \eqref{EQooROAXooFpgxxF} :
    \begin{subequations}
        \begin{align}
%TODO: ca n'a pas de sens ici : j n'est pas défini. Ou alors on se passe de j et on dit "k\neq i" ?
...
%TODO: "l'espace complet" c'est E. Or \( \bigcup_{i=1}^rF_i=E\) c'est bien l'union finie !? Pas clair !!!
...
%TODO: pourquoi les RjQj(x)=0 pour j!=i ?? C'est ce qu'il faut démontrer.
    \begin{equation}
        (R_iQ_i)(u)x=x.
    \end{equation}
...
\begin{proof}
%TODO: cela ne montre pas que P=Q :(
    Pour l'unicité, soient \( P\) et \( Q\) deux polynômes annulateurs de \( f\) de même degré \( N\) et ayant tous deux \( 1\) comme coefficient de \( x^N\). Alors \( P-Q\) est de degré \( N-1\) tout en étant encore annulateur.
...
\begin{proof}
%TODO: La notion de dualite  e^* a été abordée avant ? Si oui, ou ?
...
\begin{proof}
    \begin{subproof}
       ...
       \item[\( \Leftarrow\)]
%TODO: pas tres clair cette explication
...
\begin{proof}
%TODO: l'écriture avec opérateur me semble déplacée ici, mal introduite... Pour prouver que \lambda est reelle ? Bof !
...
%TODO: Dans le lemme, c'est Q^{-1}AQ et pas QAQ^{-1}  ... Réécrire les équations ! :(
    ...
    \begin{equation}
%TODO: je ne comprends pas le passage de <Q^te_i, Q^te_j> à <e_i, Q^tQe_j>
...
%TODO: un petit lien vers la notation <x,Mx> ?
