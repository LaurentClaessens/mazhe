...
\begin{proof}
    ...
    \begin{equation}
        ...
        =\delta_{ij}
    \end{equation}
    où nous avons utilisé le fait que \( A\) était autoadjointe pour la passer de l'autre côté du produit scalaire (usuel). Au final nous avons effectivement \( P^tAP=\mtu\).
