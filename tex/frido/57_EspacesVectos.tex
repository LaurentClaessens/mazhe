...
\item[La matrice \( A\)]
    ...
    Nous avons prouvé que \( A\) est diagonalisable et \( \Spec(A)\subset S^1\).
    \end{subproof}
...
\begin{proposition}     \label{PROPooDEETooSOMiGO}
    Si \( A\) est opérateur diagonalisable dont les valeurs propres sont \( \lambda_i\), alors il existe un opérateur inversible \( Q\) telle que
    \begin{equation}
        A=Q^{-1} DQ
    \end{equation}
    où \( D \) est l'opérateur diagonal contenant les \( \lambda_i\) sur la diagonale.
\end{proposition}
