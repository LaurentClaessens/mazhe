...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[Si \( m_{ii}=0\) et \( m_{12}=0\) et \( m_{kl}\neq 0\) avec \( k<l\)]
            ...
            \begin{equation}
                (q\circ s)(x)=2\sum_{1\leq i\leq n}\sum_{i<j\leq n+1}  m_{ij}x_{\sigma(i)}x_{\sigma(j)}
            \end{equation}
            parce que \( s(x)_i=x_{\sigma(i)}\). Nous allons changer l'ordre de sommation. Au lieu de sommer sur tous les \( i\) entre \( 1\) et \( n\), nous allons sommer sur tous les \( i\) tels que \( \sigma(i)\) est entre \( 1\) et \( n\). Et pour la somme sur \( j\), nous allons prendre les \( j\) tels que \( \sigma(j)\) est entre \( \sigma(i)\) et \( n+1\) :
            \begin{equation}
                (q\circ s)(x)=2\sum_{1\leq \sigma(i)\leq n}\,\sum_{\sigma(i)<\sigma(j)\leq n+1}  m_{\sigma(i)\sigma(j)}x_{\sigma\sigma(i)}x_{\sigma\sigma(j)}.
            \end{equation}
            Nous savons que \( \sigma^{-1}=\sigma\) et nous posons \( a_{ij}=m_{\sigma(i)\sigma(j)}\).
    \end{subproof}
