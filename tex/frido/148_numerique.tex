...
\begin{example}
	...
	De plus notre approximation est \( x_n=1.3125\), dont déjà deux chiffres sont corrects. En deux itérations de bissection en partant de \( 0.5\), nous ne pouvons pas nous attendre à mieux.
