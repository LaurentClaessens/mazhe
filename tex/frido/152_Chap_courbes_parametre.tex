...
\begin{proposition}     \label{PROPooJYGVooShNewy}
    Soit une application \( \gamma\colon \mathopen[ 0 , 1 \mathclose]\to \eR^n\) telle que

    continue et injective. Nous posons \( \Gamma=\gamma\big( \mathopen[ 0 , 1 \mathclose] \big)\) sur lequel nous considérons la topologie induite\footnote{Définition \ref{DefVLrgWDB}.} de \( \eR^n\).
