...
\begin{lemma}[\cite{BIBooQKARooMHqitK}]     \label{LEMooCLVAooTaNGJk}
    Soit un espace topologique normal \( X\). Soient \( M\in \eR^+\) et \( A\) fermé dans \( X\), et une application continue \( f\colon A\to \mathopen[ -M , M \mathclose]\).
...
\end{definition}
%TODOooHFHRooYWVRAH Vérifier que cette définition n'est pas en contradiction ou en doublon avec DEFooPGIBooCrLNxs
