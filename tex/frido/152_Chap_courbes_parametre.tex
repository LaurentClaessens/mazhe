...
\begin{proof}
    ...
    \begin{subproof}
        ...
        % -------------------------------------------------------------------------------------------- 
        Laissé aux bons soins \randomGender{du lecteur}{de la lectrice}. J'ai pas vérifié, mais \cite{THOooKYYEooLFcNpg} dit que c'est similaire. Écrivez-moi si vous voyez un problème.
