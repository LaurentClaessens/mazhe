...
\begin{proof}
	...
	\begin{subproof}
		...
		\item[Connexité par arcs : le chemin]
		...
		\item[Minoration de la longueur de \( \alpha\)]
...
\begin{proof}
	...
	\end{equation}
    Cet ensemble est convexe comme intersection de convexes\footnote{Voir \ref{}.} et fermé comme intersection de fermés\footnote{Voir \ref{}.}. Nous prouvons que \( \Gamma=\partial D\).
