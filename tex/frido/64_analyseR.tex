...
\begin{proposition}     \label{PROPooUBUAooNIxjfg}
    Si \( f\colon \eR\to \eR\) est continue sur un voisinage de \( a\in \eR\) et si \( f(a)\neq 0\), alors \( f\) ne s'annule pas sur un voisinage de \( a\).
\end{proposition}
...
Le fait que \( f\) soit continue sur \( A\) signifie que la fonction \( f\colon A\to \eR\) est continue au sens de la proposition \ref{PROPooNPLBooPfmmym}. \ref{}. Ne pas oublier d'enlever cette ligne.
