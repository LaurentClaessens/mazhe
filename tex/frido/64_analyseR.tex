...
%TODO: il y a confusion entre x_i ou l'indice i est entier et represente les éléments de la suite, et x_{\delta_i/2} qui represente un rationnel. Je suggère de ne PAS prendre le "meme" x ! Je suggère la notation q_{\delta_i/2}
		\end{numcases}
	\end{subequations}
...
\begin{proof}
	...
	\end{equation}
%TODO: Mettre des | |  ? ou alors supposer que l et les a_k sont positifs ? (Probleme avec la relation d'ordre \leq )
...
%TODO: Il manque la demonstration pour \liminf
	\begin{equation}
...
\begin{proof}
	...
	\end{equation}
%TODO: Ben non ! les inegalites ne sont pas dans le meme sens !!!
...
\begin{remark}
% Pour ne pas confondre avec le i^2=-1, je prefere utiliser  x  comme indice (reel), ici...
