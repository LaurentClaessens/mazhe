...
\begin{proof}
	...
	\begin{subequations}
		...
		\end{align}
	\end{subequations}
    Comme la suite \( (a_i)\) est convergente, elle est bornée\footnote{Par \ref{}.}. Nous pouvons donc majorer \( | a_i |\) par \( R>0\) qui ne dépend pas de \( i\). Soit \( \eta>0\) tel que \( (R+b)\eta<\epsilon\). Alors en prenant \( i\) assez grand pour que \( | b_i-b |<\eta\) et \( | a_i-a |<\eta\), nous avons bien
	\begin{equation}
