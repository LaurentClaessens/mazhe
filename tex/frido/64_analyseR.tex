...
\begin{lemma}       \label{LEMooNMGWooTfQDeO}
    Soient un intervalle \( I\) de \( \eR\) ainsi qu'un recouvrement \( \{ \mO_i \}_{i=1,\ldots, n}\) de \( I\) par des ouverts connexes tels que \( \mO_i\cap I\neq\emptyset\) pour tout \( i\)\footnote{Il est cependant possible que les \( \mO_i\) ne soient pas inclus à \( I\).}. Alors il existe une bijection \( \psi\colon \{ 1,\ldots, n \}\to \{ 1,\ldots, n \}\) tel que
    \begin{enumerate}
        \item
    \begin{equation}
