...
\begin{proof}
    Nous savons que \( g_a\) est continue et donc bornée sur le compact \( \mathopen[ 0 , 1 \mathclose]\). Il n'y a donc pas de contre-indications à ce que le nombre \( A=\int_0^1g_a(t)dt\) existe et soit fini (lemme \ref{LEMooWKSWooPptdEm}).

    En utilisant le propriétés de l'intégrale,
    \begin{equation}
