...
\begin{proof}
	...
	\begin{subequations}
		\begin{align}
			s(A,B)\big( \sum_{st}a_{st}e_s\otimes e'_t \big)                 \\
			 & =\sum_{st}a_{st}A(e_s)\otimes B(e'_t)                         \\
	...
	Donc l'image de \( s\) engendre \( \aL(V_1\otimes V_2,W_2\otimes W_2)\) et la proposition \ref{PROPooKNNJooLSqzlD} conclu que \( s\) est un produit tensoriel pour \(\aL(V_1,W_1)\) et \( \aL(V_2,W_2)\).
\end{proof}
