...
\begin{proposition}[\cite{MonCerveau}]	\label{PROPooDJLTooHZjSrA}
	Si \( E\) est un espace vectoriel de dimension \( n\) et si \( N\) est un sous-espace de dimension \( k\), alors
	\begin{equation}
		\dim(E/N)=n-k.
	\end{equation}
	%TODOooFTAFooSmkWqq. Prouver ça.
\end{proposition}
...
\begin{proposition}[\cite{MonCerveau}]	\label{PROPooJDJJooInDpCd}
	Si \(f \colon \eR\to \eR  \) est dérivable en \( a\in \eR\), alors elle est différentiable en \( a\) et
	\begin{equation}
		df_a(u)=f'(a)u.
	\end{equation}
\end{proposition}
...
\begin{proof}
	Il faut calculer
	\begin{equation}
		\lim_{\epsilon\to 0}\frac{ f(a+\epsilon)-f(a)-f'(a)\epsilon }{ | \epsilon | }
	\end{equation}
	en faisant attention qu'au dénominateur nous avons bien \( | \epsilon |\) et non \( \epsilon\). Nous devons donc faire séparément la limite vers \( 0^+\) et \( 0^-\). Je fais celle vers \( 0^-\), et vous vous débrouillez pour l'autre.
	\begin{subequations}
		\begin{align}
			\lim_{\epsilon\to 0^-}\left( \frac{ f(a+\epsilon)-f(a) }{ | \epsilon | }-\frac{ f'(a)\epsilon }{ | \epsilon | } \right) & =\lim_{\epsilon\to 0^-}-\frac{ f(a+\epsilon)-f(a) }{ \epsilon }+f'(a) \\
			                                                                                                                        & =0.
		\end{align}
	\end{subequations}
\end{proof}
...
\begin{proposition}[\cite{MonCerveau}]	\label{PROPooFEUKooKHDuMM}
	Soient un espace vectoriel normé \( V\), \( x\in V\) et \(\alpha \colon \eR\to V  \) tel que \( \lim_{t\to 0}\alpha(t)/t=0\). Alors il existe \(\beta \colon \eR\to \eR  \) telle que \( \lim_{t\to 0}\beta(t)/t=0\) et
	\begin{equation}
		\| x+\alpha(t) \|^2=\| x \|^2+\beta(t).
	\end{equation}
\end{proposition}
...
\begin{proof}
	Nous posons
	\begin{equation}
		\beta(t)=\| x+\alpha(t) \|^2-\| x \|^2,
	\end{equation}
	et nous pouvons calculer
	\begin{subequations}
		\begin{align}
			\frac{ \beta(t) }{ t } & =\frac{ \| x+\alpha(t) \|^2-\| x \|^2 }{ t }                           \\
			                       & =\frac{ \| x \|^2+2x\cdot \alpha(t)+\| \alpha(t) \|^2-\| x \|^2 }{ t } \\
			                       & =\frac{ 2x\cdot \alpha(t)+\| \alpha(t) \|^2 }{ t }                     \\
			                       & =\frac{ 2c\cdot \alpha(t) }{ t }+\frac{ \alpha(t) }{ t }.
		\end{align}
	\end{subequations}
	En ce qui concerne la limite \( t\to 0\). Si \( t\) est petit, \( \| \alpha(t) \|<1\) et donc
	\begin{equation}
		\frac{ \| \alpha(t) \|^2 }{ t }\leq \frac{ \| \alpha(t) \| }{ t }\to 0.
	\end{equation}
	Nous restons avec \( \big(2x\cdot \alpha(t)\big)/t\). Nous utilisons Cauchy-Schwarz (théorème \ref{ThoAYfEHG}) :
	\begin{equation}
		\lim_{t\to 0}\frac{ 2| x\cdot \alpha(t) | }{ t }\leq 2\| x \|\lim_{t\to 0}\frac{ \| \alpha(t) \| }{ t }=0.
	\end{equation}
\end{proof}

\begin{lemma}[\cite{MonCerveau}]	\label{LEMooXRDQooIAVgTm}
	Soit une application \(\beta \colon \eR\to \eR  \) telle que \( \lim_{t\to 0} \beta(t)/t= 0\). Soit \( \lambda>0\). Alors il existe \( \delta>0\) tel que si \( 0<t<\delta\), alors \( -\lambda t+\beta(t)<0\).
\end{lemma}

\begin{proof}
	Soit \( \epsilon<\lambda\). Nous considérons \( \delta\) tel que \( | \beta(t)/t<\epsilon |\) pour tout \( 0<t<\delta\). Alors nous avons
	\begin{equation}
		\frac{ -\lambda t+\beta(t) }{ t }=-\lambda +\epsilon<0.
	\end{equation}
	Étant donné que le dénominateur est positif, nous déduisons que le numérateur est négatif.
\end{proof}
