...
\begin{lemma}[\cite{BIBooBVCRooAwDAqk, MonCerveau}]		\label{LEMooTGNUooZnxkrc}
	...
	\end{equation}
	et \( \epsilon(\pi)\) est la signature de \( \pi\), c'est à dire ce que nous notons souvent \( (-1)^{\pi}\).
\end{lemma}
	...
	\begin{subproof}
		...
		\begin{equation}
			\begin{aligned}
				...
				i                                             & \mapsto \begin{cases}
					                                                        (\pi_0\circ\pi^{-1})(i) & \text{si } i=1,\ldots,k \\
					                                                        i                       & \text{sinon. }
				                                                        \end{cases}
			\end{aligned}
		\end{equation}
		...
		\begin{equation}
			\begin{aligned}
				...
				i                                           & \mapsto \begin{cases}
					                                                      i                       & \text{si } i=1,\ldots,k     \\
					                                                      (\pi_0\circ\pi^{-1})(i) & \text{si }i=k+1,\ldots,k+l.
				                                                      \end{cases}
			\end{aligned}
		\end{equation}
