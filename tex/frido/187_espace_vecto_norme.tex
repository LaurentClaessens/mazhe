...
\begin{proposition}[Règle de Leibnitz pour le produit extérieur\cite{BIBooBVCRooAwDAqk,MonCerveau}]		\label{PROPooYCRXooSOsqCb}
...
\begin{definition}
	Si \(f \colon W\to V  \) est linéaire, nous définissons le \defe{pull bakc}{pull back} \(f^* \colon \Wedge^kV^*\to \Wedge^kW^*  \) par
	\begin{equation}
...
%-------------------------------------------------------
\subsection{Invariance du domaine}
%----------------------------------------------------
...
\begin{proof}
	...
	Nous posons
	\begin{equation}
		\Sigma_1=\{ y\in b\big( \overline{B(0,1)} \big)\tq \| y \|\geq \epsilon \},
	\end{equation}
	ainsi que
	\begin{equation}
		\Sigma_2=\{ y\in \eR^n\tq \| y \|=\epsilon \},
	\end{equation}
	et \( \Sigma=\Sigma_1\cup \Sigma_2\). La partie \( \Sigma_2\) est compacte en tant que fermée et bornée\footnote{Borel-Lebesgue \ref{ThoXTEooxFmdI}.}. La partie \( \Sigma_1\) est compacte en tant que intersection entre le compact \( f\big( \overline{B(0,1)} \big)\) et le fermé \( \| y \|\geq \epsilon\) (corolaire \ref{CORooSSFFooNkNmlS}). Finalement la partie \( \Sigma\) est également compacte\footnote{Union de compacts, lemme \ref{LEMooFJZDooSxYWVW}.}

	De plus la partie \( \Sigma\) ne contient pas \( f(0)\) parce que \( \| f(0) \|<\epsilon\).
\end{proof}
