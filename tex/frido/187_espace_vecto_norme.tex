...
\begin{normaltext}
	Sur le Wikipédia anglophone\footnote{\url{https://en.wikipedia.org/wiki/Diffeomorphism}}, on demande que la différentielle de l'inverse soit continue. Ce que Wikipédia anglophone a nommé \emph{diffeomorphism} est ici un \( C^1\)-difféomorphisme.
\end{normaltext}
