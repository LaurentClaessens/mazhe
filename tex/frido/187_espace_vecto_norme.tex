...
\begin{proof}
	...
	Le polynôme \( P\) est de classe \( C^{\infty}\) (proposition \ref{PROPooMGFBooHWGXyC}). Vu que \( \Sigma_2\) est de mesure nulle, la proposition \ref{PROPooSEJJooIfGUkW} dit que \( P(\Sigma_2)\) est de mesure nulle dasn \( \eR^n\).
\end{proof}
