...
\begin{example}[Série exponentielle] \label{ExIJMHooOEUKfj}
    ...
    Toutes les propriétés de la fonction de \( t\) ainsi définie sont dans le théorème \ref{ThoRWOZooYJOGgR}. Plus généralement, cette série est utilisée dans la définition \ref{DEFooSFDUooMNsgZY} de l'exponentielle.
\end{example}
...
\begin{enumerate}
    ...
    \item
        La fonction exponentielle est donnée par la définition \ref{DEFooSFDUooMNsgZY}.
\end{enumerate}
