...
\begin{subequations}
    ...
    &=(\Delta f)(x,y)+\frac{1}{ 12 }h^2(\partial_x^4f+\partial_y^4f)(x,y)\\
    &=\Delta f+\frac{ h^2 }{ 12 }\Delta\Delta f-\frac{ h^2 }{ 12 }2\partial^4_{xxyy}f\\
    &=\Delta f+\frac{ h^2 }{ 12 }\Delta\Delta f-\frac{ h^2 }{ 6 }\partial^4_{xxyy}f
    \end{align}
\end{subequations}
...
\begin{equation}
        (\Delta'_hf)(x,y)=\frac{ 1 }{2}\Big[  \frac{ 1 }{2}4\Delta f+\frac{h^2}{ 4! }(4\partial_x^4f+24\partial_x^2\partial_y^2f+4\partial_y^2f)   \Big].
\end{equation}
Ça donne :
\begin{equation}
...
\begin{equation}
    a\Delta_hf+b\Delta_h'f=(a+b)\Delta f+(a+b)\frac{ h^2 }{ 12 }\Delta^2f+h^2\frac{1}{ 6 }(a-2b)\partial^4_{xxyy}f.
\end{equation}
...
\end{equation}
En faisant quelque additions nous trouvons
\begin{equation}
    \begin{aligned}[]
        6h^2(L_hu)(x_i,y_j)=-20u_{ij}&+4\big( u_{i+1,j}+u_{i-1,j}+u_{i,j+1}+u_{i,j-1} \big)\\
        &+u(i+1,j+1)+u_{i-1,j+1}+u_{i+1,j-1}+u_{i-1,j-1}.
    \end{aligned}
\end{equation}
