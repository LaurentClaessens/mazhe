...
Le théorème suivant donne quelque informations à propos de groupes monogènes. Il impliquera dans le corollaire \ref{CORooMBLSooMHKmAq} qu'un groupe monogène d'ordre \( n\) possède \( \varphi(n)\) générateur où \( \varphi\) est la fonction indicatrice d'Euler définie en \ref{DEFooWYIGooRVBTil}.
...
Le groupe \( A_n\)\nomenclature[R]{\( A_n\)}{groupe alterné} des permutations paires dans \( S_n\) est la \defe{groupe alterné}{alterné!groupe}\index{groupe!alterné}.
\end{definition}
