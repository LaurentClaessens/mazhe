...
\begin{proposition}[\cite{MonCerveau,BIBChatGPT}]	\label{PROPooYNAXooWlUwfJ}
...
\begin{proof}
	...
	La partie \( \gO(n,\eR)\) de \( \eM(n,\eR)\) est donc non-connexe par la proposition \ref{PROPooQHJXooMNrxOJ}.
\end{proof}
