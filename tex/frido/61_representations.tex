...
\begin{proposition}[\cite{BIBChatGPT, MonCerveau}]	\label{PROPooNCKGooTuaYeq}
...
\begin{lemma}[\cite{MonCerveau}]	\label{LEMooYTUSooKqDJce}
	Quelque trucs à propos des transvections\footnote{Définition \ref{ThoooAZKDooNDcznv}.}.
	\begin{enumerate}
