...
\begin{proof}
    Les éléments de matrice d'une application linéaire sont définis par la définition \ref{DEFooSNDJooXODUgR}. Dans le cas des bases canoniques de \( \eR^m\) et \( \eR^n\) nous savons qu'extraire une composante revient à prendre le produit scalaire. Nous avons donc
    \begin{equation}
