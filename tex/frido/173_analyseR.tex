...
\begin{lemma}
    Soit une application \( f\colon \eR^2\to \eR\) telle qu'il existe une application dérivable \( g\colon \eR\to \eR\) satisfaisant
    \begin{equation}
        f(x,y)=g(x).
    \end{equation}
...
\begin{proof}
    Soit \( h\in \eR^2\). Nous avons
    \begin{equation}
        \frac{ f(x+h_1,y+h_2)-f(x,y)-g'(x)h_1 }{ \| h \| }=\frac{ g(x+h_1)-g(x)-g'(x)h_1 }{ \| h \| }\leq \frac{ g(x+h_1)-g(x)-g'(x)h_1 }{ | h_1 | }
    \end{equation}
    Donc
    \begin{subequations}
        \begin{align}
            \lim_{(h_1,h_2)\to (0,0)} \frac{ f(x+h_1,y+h_2)-f(x,y)-g'(x)h_1 }{ \| h \| }&\leq\lim_{(h_1,h_2)\to(0,0)}  \frac{ g(x+h_1)-g(x)-g'(x)h_1 }{ | h_1 | }\\
            &=\lim_{h_1\to 0} \frac{ g(x+h_1)-g(x)-g'(x)h_1 }{ | h_1 | }=0.
        \end{align}
    \end{subequations}
    Justifications :
    \begin{itemize}
        \item Si \( s\colon \eR^2\to \eR\) est de la forme \( s(x,y)=u(x)\), alors \( \lim_{(x,y)\to (0,0)} s(x,y)=\lim_{x\to 0} u(x) \).
        \item La définition de la dérivée.
    \end{itemize}
\end{proof}
...
%///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
\subsubsection{Différentielles de fonctions composées}
%///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
