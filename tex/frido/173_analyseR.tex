...
\begin{proof}
    ...
    \end{equation}
    Par définition de la dérivée, la limite de cela est zéro lorsque \( h\to 0\), parce qu'en particulier si \( h\stackrel{\eR^2}{\longrightarrow}0\), alors \( h_1\stackrel{\eR}{\longrightarrow}0\).
\end{proof}
