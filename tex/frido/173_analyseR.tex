...
Dans la plus grande tradition fridiesque, nous allons donner définition assez abstraite et traiter seulement ensuite les cas particuliers.
...
Le théorème suivant reprend les principales propriétés d'une fonction différentiable. Il est à ne pas confondre avec la proposition \ref{Diff_totale} qui dira que si les dérivées partielles \emph{sont continues} sur un voisinage de $a$, alors $f$ est différentiable en $a$.
