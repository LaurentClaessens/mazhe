...
Le théorème suivant peut être vu soit comme un dénombrement de solutions d'une certaine équation diophantienne, soit comme partition d'un entier en parts fixées.

\begin{theorem}[\cite{fJhCTE,NHXUsTa,BIBooLIDJooYWosFk}] \label{ThoDIDNooUrFFei}
...
\end{equation}
que nous avons déjà rencontré en \eqref{EQooJCBSooMSbaCd}.
