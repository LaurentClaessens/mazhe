...
\begin{lemma}[\cite{UQerHHk}]       \label{LEMooBKTNooTmtUNQ}
	Un nombre complexe algébrique dont tous les conjugués\footnote{Définition \ref{DEFooJQQYooMKqWov}.} sont de module \( 1\) est une racine de l'unité\footnote{Définition \ref{DEFooDUWPooZaAByH}.}.
	%TODOooQKYGooEvLsgP. Prouver ça.
\end{lemma}
