...
\begin{proposition}  \label{PROPooOYNRooQFpBly}  
	Soit \( (a_i)_{i\in I}\) une famille de nombres réels positifs indexés par un ensemble quelconque \( I\). Alors nous avons
	\begin{equation}
		\sum_{i\in I}a_i=\sup_{ J\text{ fini dans } I}\sum_{j\in J}a_j
	\end{equation}
    au sens où si un des deux membre existe alors l'autre existe et est égal.
\end{proposition}
