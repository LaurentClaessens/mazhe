...
\begin{proof}
	...
	\end{equation}
	Cela prouve le point \ref{ITEMooDHVSooBkVWOP}. En ce qui concerne le point \ref{ITEMooDHVSooBkVWOP}, si la série entière \( \sum_k(a_k+b_k)z^k\) convergeait, la somme \( \sum_ka_kz^k-\sum_k(a_k+b_k)z^k\) convergerait, et elle vaudrait \( -\sum_kb_kz^k\).
\end{proof}
