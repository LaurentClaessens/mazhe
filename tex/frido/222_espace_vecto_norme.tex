...
La notion de somme sur un ensemble infini est donnée en \ref{DefIkoheE}.
...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \end{equation}
        Pour tout \( K\) contenant \( J_0\) nous avons aussi \( \sum_{j\in J_0}a_j\leq \sum_{k\in K}a_k\) et donc
        \begin{equation}
