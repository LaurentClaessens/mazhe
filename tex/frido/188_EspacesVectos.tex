...
% Copyright (c) 2008-2018, 2020-2021
%   Laurent Claessens
...
\begin{lemma}       \label{LEMooOMVNooVBlQMD}
	...
	\begin{enumerate}
		\item
            Un point $a\in D$ est dit isolé\footnote{Définition \ref{DEFooXIOWooWUKJhN}.} dans $D$ relativement à $V$ s'il existe un $\varepsilon>0$ tel que
			\begin{equation}
...
\begin{proof}
    ...
    Cela pour dire que \( I_s\cap I_t\) possède une intersection que si \( s=t\).
