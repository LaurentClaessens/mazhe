...
% Copyright (c) 2008-2018, 2020-2022
%   Laurent Claessens
...
\begin{definition}
	...
	\end{enumerate}
    La fermeture \( \overline{ B(a,r) }\) est nommée «boule fermée».
\end{definition}

\begin{normaltext}
    Les différences entre ces trois ensembles sont très importantes. D'abord, les \emph{boules} sont pleines tandis que la \emph{sphère} est creuse. En comparant à une pomme, la boule ouverte serait la pomme «sans la peau», la boule fermée serait «avec la peau» tandis que la sphère serait seulement la peau. 
\end{normaltext}
...
\begin{lemma}       \label{LEMooDYYYooHZitMZ}
    ...
    \begin{enumerate}
        \item
		   La sphère est donnée par $S(a,r)=\{ x\in V\tq \| x-a \|=r \}$.
		\item
            La fermeture de la boule est $\overline{ B(a,r) }=\{ x\in V\tq \| x-a \|<r \}$;
        \item
