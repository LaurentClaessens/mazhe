...
\begin{lemma}
    Soient deux espaces vectoriels \( V\) et \( W\) dont \( V\) est de dimension finie. Alors l'application définie par
    \begin{equation}
        \begin{aligned}
        ...
        \end{aligned}
    \end{equation}
    sur la base «canonique» de \( G(V^*\times W)\) passe aux classes.
\end{lemma}
...
\begin{lemma}
    Si \( V\) est de dimension finie, alors \( \aL(V,W)\) muni de 
    \begin{equation}
        \begin{aligned}
