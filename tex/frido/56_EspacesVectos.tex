...
\begin{proof}
    ...
    \end{equation}
    C'est un polynôme de degré au plus \( n-1\) en \( X\) et il s'annule aux points \( T_1,\ldots, T_{n-1}\). Par conséquent\footnote{Proposition \ref{}.} il existe \( \alpha\in \eK[T_1,\ldots, T_{n-1}]\) tel que
