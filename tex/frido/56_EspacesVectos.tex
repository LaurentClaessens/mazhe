...
\begin{normaltext}
	...
	Cela soit dit en passant, ça rend plus compliqué que prévu la preuve que \( \GL(E,F)\) est ouvert dans \( \aL(E,F)\). Il ne suffira pas de dire que le déterminant est une application continue.
\end{normaltext}
...
%-------------------------------------------------------
\subsection{Entre espaces différents}
%----------------------------------------------------
