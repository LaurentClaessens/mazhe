...
\begin{propositionDef}[\cite{MonCerveau}]	\label{DEFooTAUWooNDJJEO}
	Soient des espaces vectoriels normés \( E_1,\ldots,E_n\) et \( F\). Si \(\alpha \colon E_1\times\ldots \times E_n\to F  \) est \( n\)-multilinéaire, alors
	\begin{enumerate}
		\item
		      Nous avons
		      \begin{equation}
...
\end{propositionDef}
Voir aussi la définition \ref{DefKPBYeyG}.
