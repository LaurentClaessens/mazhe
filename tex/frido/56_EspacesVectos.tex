...
\begin{propositionDef}[\cite{BIBooEMJPooWLMWSd}]
...
\begin{definition}
    Soit un esapce affine \( \affE\) modelé sur \( E\). Les repères cartésiens\footnote{Définition \ref{}.} \( (O,\mB)\) et \( (O',\mB')\) ont \defe{même orientation}{ortientation affine} si les bases \( \mB\) et \( \mB'\) ont même orientation.
