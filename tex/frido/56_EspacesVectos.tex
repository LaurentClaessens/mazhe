...
\begin{example}
	...
	\begin{equation}
		\res(P,P')=-a(b^2-4ac).
	\end{equation}
	Donc un polynôme du second degré a une racine double si et seulement si \( b^2-4ac=0\). Cela est un résultat qu'on reverra en détail dans la proposition \ref{PROPooEZIKooKjJroH}, mais qui fait toujours plaisir à revoir.
\end{example}
