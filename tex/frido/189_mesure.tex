...
\begin{proof}
  ...
  Par le lemme~\ref{lem:convergence-module-cont}, il existe~$N \geq 0$ tel que
  \begin{equation}\label{eq:1}
    \forall \delta > 0, \omega_i(\delta) \leq \omega_g(\delta) + \epsilon.
  \end{equation}
...
Voici une preuve alternative du théorème \ref{THOooXZQCooSRteSr}. Elle utilise des intégrales et demande donc plus de dependences.
