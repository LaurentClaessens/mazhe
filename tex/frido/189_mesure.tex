...
\begin{theorem}[Théorème fondamental de l'analyse]    \label{ThoRWXooTqHGbC}      \label{CORooKRBZooEMDobC}
...
Énormément d'exemples sont disponibles avec les coordonnées polaires et toutes leurs variations. Cependant les fonctions trigonométriques ne seront vues que plus tard, et ce sera pour~\ref{SUBSECooUUAKooMSJHsL}.
...
\begin{example}[Ce n'est pas la mesure que nous voulons]
    La mesure donnée par la proposition \ref{PROPooILOEooBiumKD}<++>
\end{example}
<++>
