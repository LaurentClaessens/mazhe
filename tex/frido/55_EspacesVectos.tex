...
\begin{definition}      \label{DEFooYCKRooTrajdP}
    ...
    \end{equation}
    où la somme est effectuée sur tous les éléments du groupe symétrique\footnote{Définition~\ref{DEFooJNPIooMuzIXd}.} \( S_n\) et où \( (-1)^{\sigma}\) représente la parité de la permutation \( \sigma\).
\end{definition}
...
\begin{proof}
    ...
    \begin{subproof}
        \item[\ref{ITEMooSOHWooEHJFZD}]
            ...
            donc
            \begin{equation}
                \det(A)=\sum_{\sigma\in S_{n}}\epsilon(\sigma)\prod_{i=1}^nA_{i\sigma(i)}=\sum_{\sigma\in S_{n}}\epsilon(\sigma)\prod_{i=1}^nA_{i(\alpha\sigma)(i)}.
            \end{equation}
            <++>
