...
\begin{definition}[Espace vectoriel\cite{ooQLVLooEUrNLS}]       \label{DEFooKHWZooIfxdNc}
    Soit un corps commutatif\footnote{Pour la millième fois : dans le Frido, tous les corps sont commutatifs, même si on oublie de le préciser de temps en temps.} \( \eK\). Un \defe{espace vectoriel}{espace!vectoriel} sur \( \eK\) est un ensemble \( V\) muni de deux opérations : 
    \begin{itemize}
