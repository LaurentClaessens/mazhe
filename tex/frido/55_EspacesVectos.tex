...
\begin{theorem}[\cite{MonCerveau}]
    Soit un corps commutatif. Lorsque \( A\in \eM(n,\eK)\), nous considérons l'application linéaire\footnote{Définition \ref{DEFooULVAooXJuRmr}.} \( f_A\in \End(\eK^n)\) donné par
    \begin{equation}
        \begin{aligned}
