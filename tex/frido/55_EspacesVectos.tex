...
\begin{proposition}[\cite{MonCerveau}]
    Soient deux matrices \( A,B\in \eM(n,\eK)\) et les applications linéaires associées \( f_A,f_B\colon \eK^n\to \eK^n\). Alors
    \begin{equation}
        f_{AB}=f_A\circ f_B.
    \end{equation}
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    est un morphisme\footnote{Il n'est cependant pas question de dire que c'est un isomorphisme parce qu'il y a des éléments non inversibles autant dans \( \eM(n,\eK)\) que dans \( \End(\eK^n)\).}.
\end{proposition}
