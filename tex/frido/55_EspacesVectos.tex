...
\begin{proof}
	...
	\begin{subproof}
		...
		%-----------------------------------------------------------
		C'est le théorème \ref{ThonmnWKs}\ref{ItemBazxTZ}. La partie \( \{ e_{i_0} \}\) est libre et la partie \( \{ e_i \}_{i\in I}\) est génératrice. Donc il existe une base \( B\) telle que \( \{ e_{i_0} \}\subset B\subset\{ e_i \}_{i\in I}\). Si \( B=\{ e_i \}_{i\in J}\), alors \( J\) est fini\footnote{Sauf si \( I\) est choisit de façon traitresse. Il se peut que \( e_{i_1}=e_{i_2}\) avec \( i_1\neq i_2\).} parce que toutes les bases d'un espace vectoriel de dimension finie ont le même nombre d'éléments.
