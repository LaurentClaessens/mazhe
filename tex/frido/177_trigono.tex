...
\begin{theorem}[\cite{BIBooULRWooPsjtBE}]       \label{THOooKDMUooUxQqbB}
    ...
    \begin{enumerate}
        ...
        \item       \label{ITEMooGELWooFFAqkc}
            Si \( G\) ne contient pas de réflexions, alors il est cyclique et engendré par la rotation d'angle \( 2\pi/n\) autour de \( C\).
        \item       \label{ITEMooDHKEooFpCfmX}
            ...
            \begin{enumerate}
                ...
                \item       \label{FOO}
                    \( n\) est pair,
                \item
                    Si \( \sigma\) est une réflexion dans \( G\), alors nous avons $G=\gr(\sigma,r_{4\pi/n})$ où \( r_{\theta}\) est la rotation d'angle \( \theta\) autour de \( C\),
                \item
...
\begin{proof}
    ...
    \begin{subproof}
        \item[Pour \ref{ITEMooYEONooCOMpeb}]
            Soit \( A\in \eR^2\). Nous considérons son orbite \( \mA=\{ g(A)\tq g\in G \}\). Vu que \( G\) est un groupe fini, \( \mA\) est une partie finie de \( \eR^2\) et il n'y a pas de probèmes à considérer son barycentre
            \begin{equation}
                B=\frac{1}{ n }\sum_{g\in G}g(A).
            \end{equation}
            <++>
