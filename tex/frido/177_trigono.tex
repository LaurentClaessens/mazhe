...
\begin{definition}
    ...
    \end{equation}
    Nous notons \( \Lebesgue(S^1)\) la tribu et encore \( \mu\) la mesure.
\end{definition}

\begin{proposition}[Lebesgue sur \( S^1\)\cite{MonCerveau}]
    Soit la structure usuelle d'espace mesurable \( (\eC,\Borelien(\eC))\). Nous posons
    \begin{itemize}
        \item la tribu \( \Borelien(\eC)_{S^1}\) induite de la tribu des boréliens  de \( \eC\) vers \( S^1\),
        \item la bijection \( \varphi\colon \mathopen[ 0 , 2\pi \mathclose[\to S^1\),
    \end{itemize}
...
\begin{proposition}[Espaces de fonctions sur \( S^1\)\cite{MonCerveau}]
    Soit la structure usuelle d'espace mesurable \( (\eC,\Borelien(\eC))\). Nous posons
    \begin{itemize}
        \item la tribu \( \Borelien(\eC)_{S^1}\) induite de la tribu des boréliens  de \( \eC\) vers \( S^1\),
        \item la bijection \( \varphi\colon \mathopen[ 0 , 2\pi \mathclose[\to S^1\),
