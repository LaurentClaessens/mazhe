        ...
        \item[Ouvert ne contenant pas zéro]
            ...
            \item[Pause]
                ...
                \item[Boréliens]
                    ...
                    Nous utilisons le lemme de transfert \ref{LemOQTBooWGYuDU} avec l'application \( \varphi^{-1}\) et l'ensemble des ouverts :
                    \begin{equation}
...
\begin{proposition}[\cite{MonCerveau}\quext{Je ne suis pas encore certain de la véracité de tous les points de cette proposition. Vérifiez bien et écrivez moi pour me dire ce que vous en pensez.}]      \label{PROPooHMSCooRIjcJq}
    ...
    \begin{itemize}
        \item \( \tribA'=\{ A\in \Lebesgue(\eC)\tq A\subset S^1 \}\),
    ...
    \begin{enumerate}
        \item
            le triple \( (S^1,\tribA',\mu')\) est un espace mesuré fini tel que
            \begin{equation}
                \mu'(S^1)=1.
            \end{equation}
        \item
            ...
            \end{equation}
            où \( \Lebesgue'\) est la tribu induite\footnote{Définition \ref{DefDHTTooWNoKDP}.} sur \( \mathopen[ 0 , 2\pi \mathclose[\) depuis la tribu de Lebesgue de \( \eR\), c'est à dire
                \begin{equation}
                    \Lebesgue'=\{ M\cap S^1\tq M\in\Lebesgue(\eC) \}.
                \end{equation}
                <++>
            \item
                La formule
...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[\( (S^1,\tribA',\mu')\) est mesurable, fini]
            ...
            \end{equation}
        \item[Prmière inclusion : \( \tribA'\subset \varphi(\Lebesgue')\)]
            Un élément \( A\in \tribA'\) est une partie \( A\in\Lebesgue(\eC)\) telle que \( A\subset S^1\). Nous posons \( M=\varphi^{-1}(A)\subset \mathopen[ 0 , 2\pi \mathclose[\) et nous voudrions prouver que \( M\in\Lebesgue(\eC)\).
                ...
                \item[Si \( A\) est un borélien]
                    Si \( A\) est un borélien de \( \eC\), alors \( \varphi^{-1}(A)\) est un borélien de \( \mathopen[ 0 , 2\pi \mathclose[\) parce que \( \varphi\) est continue\footnote{Le fait que \( \varphi\) soit continue est \ref{}<++> et cela en fait une fonction borélienne par le théorème \ref{ThoJDOKooKaaiJh}.}.
                \end{subproof}
                <++>
    \end{subproof}
    <++>
