...
\begin{proposition}[\cite{MonCerveau}]      \label{PROPooHMSCooRIjcJq}
    ...
    \begin{itemize}
        ...
        \item la bijection \( \varphi\colon \mathopen[ 0 , 2\pi \mathclose[\to S^1\),
            \item la mesure sur \( (S^1,\Lebesgue(\eC)_{S^1})\) donnée par
    ...
    \begin{enumerate}
        \item       \label{ITEMooSUNEooRhAdep}
            ...
            \begin{subequations}
                \begin{align}
                    \Lebesgue(\eC)_{S^1}&=\{A\in\Lebesgue(\eC)\tq A\subset S^1\} \\
                    &=\{A\cap S^1\tq A\in\Lebesgue(\eC)\}       \label{SUBEQooYZGCooDqXmft}
                \end{align}
            \end{subequations}
       \item
           Pour \( A\in \Lebesgue(\eC)_{S^1}\), la formule
            \begin{equation}
...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[Pour \ref{ITEMooFUXKooFQdoaw}]
            L'expression \eqref{SUBEQooYZGCooDqXmft} montre que les éléments de \( \Lebesgue(\eC)_{S^1}\) sont des mesurables de \( \mu\). Il n'y a donc pas de problèmes pour que \( (S^1,\Lebesgue(\eC)_{S^1}, \mu')\) soit un espace mesuré.
