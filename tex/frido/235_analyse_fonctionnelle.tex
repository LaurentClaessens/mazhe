...
\begin{proof}
    ...
    Avant de commencer le gros morceau, nous donnons une borne pour \( q\). L'hypothèse \( p>1\) permet d'écrire \( q\) sous la forme
    \begin{equation}
        q=\frac{ p }{ p-1 }.
    \end{equation}
    En voyant \( q\) comme fonction de \( p\),
    \begin{equation}
        q'(p)=\frac{ -1 }{ (x-1)^2 }.
    \end{equation}
    donc \( q\) est décroissante et \( q(2)=2\). Nous en déduisons que \( q>2\) parce que \( p\in\mathopen] 1 , 2 \mathclose[\). Gardez en tête que \( q>2\); ce sera utile.
...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \spitem[Prolongement dans les boules unité fermées]
        ...
        \spitem[Prolongement pour les boules ouvertes]
...
\begin{subproof}
    \spitem[Mise en place du décors]
