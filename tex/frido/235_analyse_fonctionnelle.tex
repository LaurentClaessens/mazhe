...
\begin{proof}
	...
	\begin{subproof}
		...
		Nous sommes maintenant prêts à prouver le théorème. Soit \( g_0\in C^0(Y,\eR)\). Nous allons nous ramener au cas de la boule unité ouverte en utilisant un homéomorphisme\footnote{Existence par \ref{}.} \( \phi\colon \eR\to \mathopen] -1 , 1 \mathclose[\).
