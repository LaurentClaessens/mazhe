...
\begin{proof}
    ...
    En conclusion, nous avons \( \eN=\bigcup_{i=1}^n I_{a_i}\), ce qui prouve que \( \eN\) est un ensemble fini. Contradiction avec la proposition \ref{ooKPDKooGRhFik}\ref{ITEMooKPDKooGRhFik} qui dit que \( \eN\) est infini.
\end{proof}
