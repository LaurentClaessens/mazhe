...
\begin{proposition}     \label{PROPooNPLBooPfmmym}
    Soit une fonction \( f\colon X\to Y\), continue sur l'ouvert \( A\) de \( X\) au sens où elle est continue en chaque pour de \( A\). Alors la fonction restriction \( f\colon A\to Y\) est également continue pour la topologie sur \( A\).
\end{proposition}
