...
\begin{definition}[Limite d'une fonction, thème \ref{}<++>]\label{DefYNVoWBx}
...
\begin{remark}
    Nous ne saurions trop insister sur la condition \( x\neq a\) dans la définition. Il n'est donc pas nécessaire qu'une fonction existe en un point pour qu'elle admette une limite. Par exemple nous avons
    \begin{equation}
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    nous avons \( \lim_{x\to 0} f(x)=0\) malgré que \( f(0)=4\).
