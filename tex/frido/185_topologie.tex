...
\begin{proof}
	...
	\end{equation}
    Cela est un polynôme du second degré en $t$ dont le signe est toujours positif (ou nul). Par \ref{} nous en déduisons que le fameux \( b^2-4ac\) doit être négatif ou nul. Nous avons donc
	\begin{equation}
...
\begin{proof}[Preuve alternative]
	...
	\end{equation}
    Cela est un polynôme du second degré en $t$. Par conséquent le discriminant doit être négatif\footnote{par \ref{}}. Nous avons donc
	\begin{equation}
