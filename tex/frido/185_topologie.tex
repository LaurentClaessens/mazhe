...
\begin{example}     \label{EXooNRMCooNNWODu}
 ...
 A_2 = \{ ( t , \sin(1/t) ) \in \eR^2 \; | \; t \in ]0, 1/2] \; \}
    ...
    L'ensemble $A_2$ est une courbe. Comme la fonction sinus est bornée\footnote{Voir \ref{}.} $A_2$ est borné. L'intérieur de $A_2$ est vide, touts ses points sont de points de frontière. $A_2$ n'est pas fermé parce que il lui manque le morceau de droite verticale $I=\{0\}\times\{-1,1\}$, qui est partie de sa fermeture. En fait, lorsque $t$ tend vers $0$ la fonction sinus oscille de plus en plus vite et on peut trouver au moins un point du type $(t,\sin(t))$ dans tout voisinage d'un point en $I$.
