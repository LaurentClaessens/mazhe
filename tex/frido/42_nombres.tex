...
La proposition suivante exprime le fait que \( \eR\) est commutatif.

\begin{proposition}[\cite{MonCerveau}]
    Soient un ensemble fini \( I\), deux bijections \( \varphi_1\colon \{ 0,\cdots N \}\to I\), \( \varphi_2\colon \{ 0,\ldots, N \}\to I\) et une fonction \( f\colon I\to \eR\). Alors
    \begin{equation}
