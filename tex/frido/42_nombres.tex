...
\begin{proof}
    Il existe évidemment une injection \( A\to A\times A\). Donc, le théorème de Cantor-Schröder-Bernstein \ref{THOooRYZJooQcjlcl} nous permet de ne rechercher qu'une surjection \( A\to A\times A\).
\end{proof}
<++>
