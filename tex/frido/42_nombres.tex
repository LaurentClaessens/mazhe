...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item
            Ensuite,
%TODO: je ne comprends pas  h  ici ? C'est pas \beta plutot ?? Et voila quoi ?
            \begin{equation}
...
%TODO: Vue l'unicite de quoi ? C'est ce que l'on cherche a demontrer !
...
\begin{normaltext}
    Nous supposons que \randomGender{le lecteur}{la lectrice} connaît déjà la priorité des opérations. \randomGender{Il}{Elle} saura donc interpréter des expressions comme \( a\times b+c\) comme voulant dire \( (a\times b)+c\) sans que nous ayons à ajouter des parenthèses.
\end{normaltext}
...
\begin{proof}
    ...
    \item[Unicité]
        ...
        \end{equation}
%TODO: Qu'est ce que \( P(a)=1\) ici ?  Reference ?
...
%TODO: Qu'est-ce que  a  vient faire ici ???
...
\begin{lemma}
%TODO: Faire reference a la notion de classe utilisant la notation  \overline
