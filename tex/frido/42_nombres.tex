...
\begin{definition}[\cite{RWWJooJdjxEK}]
...
\begin{proof}
    ...
    \item[\( s(b)\in A\)]
        Nous savons que \( s(b)\notin B\). Il y a deux possibilités pour cela : soit \( s(b)\in A\), soit il existe \( a\in A\) tel que \( a\geq s(b)\). Ces deux possibilités ne sont à priori pas exclusives. Nous montrons à présent que la seconde possibilité est impossible.
    \item[Petit calcul]
...
\begin{probleme}
    Il me semble très douteux que la partie «existence» du théorème suivant (\ref{THOooFUXMooJuigHK}) puisse être faite sans être au raz d'utiliser les axiomes de la théorie des ensembles.
