...
\begin{lemma}       \label{LEMooNKKDooUvSYPO}
    Si \( A\) est infini, et si pour tout \( i\in \eN\) nous avons \( A_i\simeq A\), alors
    \begin{equation}
        \bigcup_{i\in \eN}A_i\simeq A.
    \end{equation}
\end{lemma}
...
\begin{proof}
    ...
    \begin{subequations}
        \begin{align}
            A&\simeq A\times A          \label{SUBEQooVFIQooAmRuiU}\\
            &\succeq A\times \eN        \label{SUBEQooICFEooTLuFHZ}\\
    ...
    Justifications :
    \begin{itemize}
        \item Pour \eqref{SUBEQooVFIQooAmRuiU}, c'est le théorème \ref{THOooDGOVooRdURVi}.
        \item Pour \eqref{SUBEQooICFEooTLuFHZ}, c'est la proposition \ref{PROPooUIPAooCUEFme}.
...
\begin{proposition}
    Si \( A\) est un ensemble infini, alors \( A\times \eN\approx A\).
\end{proposition}
...
\begin{proof}
    ...
    \begin{equation}
        A_i=\{ (a,i)\tq a\in A \}.
    \end{equation}
    Pour chaque \( i\in \eN\) nous avons \( A_i\approx A\). En utilisant le lemme \ref{LEMooNKKDooUvSYPO}, nous avons
    \begin{equation}
        A\times \eN=\bigcup_{i\in \eN}A_i\approx A.
    \end{equation}
\end{proof}
