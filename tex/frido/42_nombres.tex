...
\begin{remark}      \label{RemooJCAUooKkuglX}
	% TODOooRemarkFoundWhichOne Bertrand a trouvé ça en mergeant: un nouvel environnement remark vide... En lisant par ailleurs, c'est peut-être la remarque qui dit que l'inégalité triangulaire est costaude. En tout cas, cette remarque est référencée à 020-64_analyseR.tex.
\end{remark}
...
\begin{proposition}	\label{PROPooGroupeEntiersRelatifs}\label{PROPooIKAZooFdhVWQ}
...
\begin{definition}[\cite{MonCerveau}]	\label{DEFooYMRHooCyEKtr}
