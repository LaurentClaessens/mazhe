...
\begin{definition}\label{DefEnsemblesDisjoints}
  Deux ensembles $A$ et $B$ sont \defe{disjoints}{ensembles!disjoints} si leur intersection est vide; en d'autres termes, s'il n'existe aucun élément commun à $A$ et $B$.
\end{definition}
