...
\begin{probleme}
    Attention : l'énoncé \ref{LEMooDHWSooFqhano} est faux, comme le montre l'exemple \( \eZ\setminus \eN\) contre \( \eZ\setminus \eZ\). Il faut sans doute ajouter l'hypothèse que \( A\) est strictement surpotent à \( B\) et \( B'\).

    On en parle ici : \url{https://github.com/LaurentClaessens/mazhe/issues/146}
\end{probleme}
