...
\begin{definition}
    Soit un ensemble ordonné \( (E,\leq)\) et une partie \( A\) de \( E\). Nous disons que \( m\in A\) est un \defe{minimum}{minimum!ensemble ordonné} si pour tout \( y\in E\), l'élément \( m\) est comparable à \( y\) et \( m\leq y\).
\end{definition}
...
\begin{definition}[Groupe]
    ...
    \begin{enumerate}
        \item
            pour tout \( g\), \( h\), \( k\) in \( G\), \( g\cdot(h\cdot k)=(g\cdot h)\cdot k\),
        \item
    ...
    \end{enumerate}
    Notons que nous avons noté \( g\cdot h\) et non \( \cdot(g,h)\) comme une notation purement fonctionnelle nous l'aurait suggéré. Le plus souvent il sera simplement noté \( gh\).
\end{definition}
...
\begin{lemmaDef}[Unicités]
    ...
    \begin{enumerate}
        \item
            il existe un unique élément \( e\in G\) tel que \( e\cdot g=g\cdot e=g\) pour tout \( g\in G\),
        \item
            pour tout \( g\in G\), il existe un unique élément \( h\in  G\) tel que \(g\cdot h=h\cdot g=e \).
    \end{enumerate}
    Le \( e\) ainsi définit est nommé \defe{neutre}{neutre!dans un groupe} de \( G\). Le \( h\) tel que \( g\cdot h=h\cdot g=e\) est nommé l'\defe{inverse}{inverse!dans un groupe} de \( g\) et est noté \( g^{-1}\).
\end{lemmaDef}

\begin{definition}
    Un groupe \( G\) est \defe{abélien}{abélien!groupe} ou \defe{commutatif}{commutatif!groupe} si pour tout \( g\) et \( h\) dans \( G\), \( gh=hg\).
\end{definition}
...
\begin{theorem}[Complétude de \( \eR\), critère de Cauchy\cite{RWWJooJdjxEK}] \label{THOooUFVJooYJlieh}   \label{ThoTFGioqS} \label{ThoHGyzAva}
    Nous avons :
    \begin{enumerate}
        \item
...
Nous avons terminé avec la construction des réels. Les propriétés topologiques arrivent en \ref{SECooGKHYooMwHQaD}. 
