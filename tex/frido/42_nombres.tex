...
%-------------------------------------------------------
\subsection{Théorèmes-clefs qui cachent tout}
%----------------------------------------------------

Nous allons donner sans démonstration le lemme de Zorn \ref{LemUEGjJBc}. Il cachera toute la complexité de l'axiome du choix et la moitié de ce qu'apporte cet axiome par rapport à ZF.

Nous allons aussi donner sans démonstration l'existence d'un ensemble des naturels (théorème \ref{THOooOXMHooXYgMqb}). Il cachera toute la complexité qu'il y a entre les différentes définitions d'ensembles finis, d'existence de maximum, etc. Voir \cite{BIBooGVVDooDoQSaM,BIBooFGIWooMkmaKH}.
