...
\begin{proposition}[\cite{RWWJooJdjxEK,MonCerveau}]     \label{PROPooMZOWooHmsXzI}
    ...
    \begin{enumerate}
        \item       \label{ITEMooJLAHooDKukfH}
            L'élément \( 0\) est l'unique plus petit élément.
...
\begin{probleme}
    Il me semble très douteux que la partie «existence» du théorème suivant (\ref{THOooFUXMooJuigHK}) puisse être faite sans être au raz d'utiliser les axiomes de la théorie des ensembles. Si vous connaissez une façon de le prouver, écrivez moi.
\end{probleme}
...
\begin{proof}
    ...
    \begin{subproof}
    \item[Existence (???)]
        À mon avis, il y a moyen d'utiliser le lemme de Zorn sur l'ensemble des couples \( (X,\alpha)\) où \( X\) est une partie de \( \mN_1\) et \( \alpha\colon X\to \mN_2\) est une application vérifiant les deux propriétés. En particulier en faisant attention que \( \alpha\) ne  vérifie la seconde propriété que pour les \( x\in X\) tels que \( s_1(x)\in X\), et non sur \( X\) en entier.
    \item[Unicité]
