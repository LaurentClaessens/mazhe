...
\begin{definition}
    Soit un ensemble ordonné \( (E,\leq)\) et une partie \( A\) de \( E\). Nous disons que \( m\in A\) est un \defe{minimum}{minimum!ensemble ordonné} s'il est comparable à tout élément \( y\in E\), et que l'on a \( m\leq y\).
\end{definition}
