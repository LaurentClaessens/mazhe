...
Je propose d'introduire le concept de «théorème encapsulant». Un théorème encapsulant est un théorème qui encapsule toute une difficulté sous forme de boîte noire. Un théorème encapsulant a les propriétés suivantes :

\begin{enumerate}
	\item
	      Les concepts et techniques nécessaires à sa démonstration ne sont pas nécessaire à son énoncé.
	\item
	      Les concepts et techniques nécessaires à sa démonstration ne sont pas utilisés dans le contexte où le théorème est utilisé.
\end{enumerate}
