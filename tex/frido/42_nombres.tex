...
\begin{definition}[\cite{ooLKFGooTUrnhx}]  \label{DefTMNooKXHUd}
    Un anneau\footnote{Définition \ref{DefHXJUooKoovob}.} \( (A, +,\times)\) est un \defe{corps}{corps} dans lequel tout élément non nul est inversible pour l'opération \( \times\) (pour l'opération \( +\), tous les éléments sont inversibles parce que \( (A,+)\) est un groupe).
\end{definition}
