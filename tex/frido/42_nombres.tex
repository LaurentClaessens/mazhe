...
Lisez d'abord les parties qui vous intéressent, et remontez lorsque vous avez besoin de plus de justifications. Le petit jeu qui consiste, partant d'un résultat, à remonter toutes les démonstrations pour avoir une preuve complète de tous les résultats intermédiaires aboutit forcément aux axiomes.

Nous n'allons pas aller jusque là. Nous n'allons même pas préciser le système d'axiomes utilisé. Notre point de départ (qui ne devrait pas être le point de départ du lecteur normal, mais le point d'arrivée du lecteur réellement acharné) sera la théorie des ensembles. Nous la supposons construite de façon cohérente.

Pour information, la construction de la théorie des ensembles est \emph{très} difficile 

%--------------------------------------------------------------------------------------------------------------------------- 
\subsection{Le problème}
%---------------------------------------------------------------------------------------------------------------------------

Sachez pour votre culture générale que la construction de la théorie des ensembles n'a absolument rien ni d'évident ni de naïf. Des paradoxes arrivent très facilement si la théorie des ensembles n'est pas bien fondée. Par exemple, que dire de l'ensemble des ensembles qui ne se contiennent pas ? Ou encore ceci. Soit l'ensemble des nombres naturels qui peuvent être décrits par un texte en français de 28 mots. C'est un ensemble fini. Prenez le maximum, ajoutez un. Boum. Nous avons écrit un texte de 28 mots qui décrit un nombre qui n'est pas dans l'ensemble des nombres descriptibles en 28 mots.
...
\begin{definition}
    ...
    Un élément \( p\in E\) est un \defe{minorant}{minorant} de \( A\) si pour tout \( a\i A\), l'élément \( p\) et \( a\) sont comparables et \( p\leq a\).
