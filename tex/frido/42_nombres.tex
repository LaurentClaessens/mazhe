...
\begin{definition}
    Soit \( E\), un ensemble et \( A\), une partie de \( E\) (c'est-à-dire un sous-ensemble de \( E\)). Le \defe{complémentaire}{complémentaire} de l'ensemble \( \), dans \( E\), noté \( \complement A\)\nomenclature[T]{$\complement A$}{Le complémentaire de l'ensemble \( A\)} est l'ensemble des éléments de \( E\) qui ne font pas partie de \( A\) :
    \begin{equation}
