...
\begin{definition}[\cite{MonCerveau}]	\label{DEFooQEIAooGzzdiu}
	Un \defe{isomorphisme}{isomorphisme d'ensembles ordonnés} d'ensembles ordonnés est une bijection croissante dont l'inverse est croissante.
\end{definition}
