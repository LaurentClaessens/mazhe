...
\begin{proposition}[\cite{RWWJooJdjxEK}]     \label{PROPooTLTSooGNMTmV}
    ...
    \begin{enumerate}
        ...
        \item       \label{ITEMooNUTHooJWWzGv}
            Tous les éléments de \( \eN\) sont réguliers\footnote{Élément régulier pour une opération, définition \ref{}.} par rapport à l'addition.
    \end{enumerate}
\end{proposition}
...
\begin{proof}
    ...
    \item[Antisymétrique]
        ...
        \begin{equation}
            0+b=b+(x+y).
        \end{equation}
        En utilisant la régularité, \( 0=x+y\) et donc 
    \end{subproof}
    <++>
\end{proof}
<++>
