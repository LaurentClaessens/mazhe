...
%--------------------------------------------------------------------------------------------------------------------------- 
\subsection{Opérations sur les naturels}
%---------------------------------------------------------------------------------------------------------------------------

\begin{proposition}     \label{PROPooPOZDooVFTPdt}
    La somme et le produit sur \( \eN\) sont associatifs commutatifs.
\end{proposition}

\begin{lemma}           \label{LEMooPKJBooPnDFWW}
    Si \( a,b,x\in \eN\) vérifient \( a+x=b+x\), alors \( a=b\).
\end{lemma}
...
\begin{proof}
    ...
    \begin{subproof}
    \item[Symétrie]
        C'est la commutativité de la somme dans \( \eN\), proposition \ref{PROPooPOZDooVFTPdt}.
    \item[Réflexive]
        Immédiat.
    \item[Transitive]
        ...
        \begin{equation}
            a+v+u+y=u+b+v+x.
        \end{equation}
        La commutativité nous permet de mettre \( u\) et \( v\) à droite dans chacun des deux membres. Ensuite le lemme \ref{LEMooPKJBooPnDFWW} nous permet de simplifier par \( u+v\). Il reste \( a+y=b+x\), qui signifie \( (a,b)\sim(x,y)\).
