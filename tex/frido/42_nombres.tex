...
\begin{normaltext}  \label{NorooOrdreBienOrdonne}
	...
	\begin{enumerate}
		...
		\item
		      Nous verrons dans la remarque~\ref{REMooXOIOooHjwMvA}%\futureok
		      que l'intervalle \( \mathopen[ -1 , 1 \mathclose]\) dans \( \eR\) n'est pas bien ordonné.
		      % TODOooLabelMissing La remarque correspondante semble avoir disparu... ou bien elle a récemment bougé.
		\item
...
\begin{theorem}     \label{THOooOXMHooXYgMqb}
	Il existe un\footnote{Nous verrons plus tard -- en \ref{NORMooQXASooMXqhjI} %\futureok
...
>>>>>>> a6c8952bacaf213be4373c31fea13c70cab19178
