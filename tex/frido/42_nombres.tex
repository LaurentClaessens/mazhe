...
\begin{proof}
    ...
    \begin{equation}
        B\approx B_1\approx B_2.
    \end{equation}
    Le lemme \ref{LEMooDHWSooFqhano} nous indique alors que
    \begin{equation}
        A\setminus B\approx A\setminus B_2\approx A\setminus B_2.
    \end{equation}
    ...
    et donc
    \begin{equation}
         A\setminus B_1\succeq B_2\approx B.
    \end{equation}
...
\begin{proof}
    ...
    \begin{subequations}
        \begin{align}
            A&\approx A\times A          \label{SUBEQooVFIQooAmRuiU}\\
