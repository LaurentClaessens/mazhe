...
\begin{lemma}       \label{LEMooPXWEooNOdtij}
    Il existe une bijection \( \eN\to \eN\times \eN\)
\end{lemma}
...
Le théorème suivant est une généralisation de la proposition \ref{PropVCSooMzmIX}. Elle implique, entre autres choses, qu'il existe une bijection entre \( \eR\) et \( \eR\times \eR\).
\begin{theorem}
...
\begin{proof}
    ...
    \Big\}
    \end{equation}
    Cet ensemble est non vide parce que \( A\) est infini; il contient donc une partie dénombrables \( N\), et nous connaissons la surjection \( \eN\to \eN\times \eN\) du lemme \ref{LEMooPXWEooNOdtij}.
