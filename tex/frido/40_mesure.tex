...
\begin{normaltext}
    La proposition \ref{PropFDUooVxJaJ} est un cas particulier de~\ref{PropIUOoobjfIB} en utilisant~\ref{LemULSooBgZLI}. Nous en donnons cependant une preuve directe, qui est presque identique à celle de~\ref{PropIUOoobjfIB}, mais avec une ou deux simplifications.
\end{normaltext}
