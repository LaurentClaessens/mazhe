...
\begin{proof}
    ...
    \end{equation}
    Pour ce faire, nous nous rappelons du lemme de transfert \ref{LemOQTBooWGYuDU}. Soit l'injection canonique \( f\colon B\to X\); pour tout \( A\subset X\) nous avons \( f^{-1}(A)=A\cap B\). 
    ...
    \end{equation}
    Donc le lemme de transfert nous dit que
    \begin{equation}
