...
\begin{propositionDef}      \label{DefDHTTooWNoKDP}
    ...
    Elle est la \defe{tribu induite}{tribu!induite}\index{induite!tribu} de \( R\) depuis \( S\).
\end{propositionDef}
...
\begin{proposition}     \label{PROPooUNNSooMUQKfp}
    ...
    \begin{equation}
        \{ A\cap R\tq A\in\tribF \}=\{ S\in\tribA\tq S\subset R \},
    \end{equation}
    ces deux ensembles étant la tribu induite de \( \tribA\) sur \( R\).
\end{proposition} 

\begin{proof}
    Nous notons \( \tribA_R=\{ S\in \tribA\tq S\subset R \}\).
    ...
    Le fait que le tout soit la tribu induite est simplement la définition \eqref{EQooNOQNooYIdDOz} de la tribu induite.
\end{proof}
