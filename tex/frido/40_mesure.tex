...
% Copyright (c) 2011-2016,2018-2019,2022-2024, 2026
...
%-------------------------------------------------------
\subsection{\( \pi\)-système}
%----------------------------------------------------


\begin{definition}	\label{DEFooGYADooTudZmJ}
	Soit un ensemble \( X\). Un \defe{\( \pi\)-système}{\( \pi\)-système} sur \( X\) est un ensemble de parties \( \mS\subset\partP(X)\) tel que si \( A,B\in\mS\) alors \( A\cap B\in \mS\).
\end{definition}


\begin{proposition}[\cite{MonCerveau}]	\label{PROPooWFCWooCCzZLT}
	Deux mesures qui coïncident sur un \( \phi\)-système coïncident sur la tribu engendrée.
\end{proposition}


%-------------------------------------------------------
\subsection{Unicité des mesures}
%----------------------------------------------------
