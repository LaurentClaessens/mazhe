...
\begin{lemma}
    Soient un espace topologique \( X\) et un borélien \( B\) de \( X\). Nous considérons sur \( B\) la topologie induite de \( X\) et les boréliens \( \Borelien(B)\) correspondants. Nous avons :
    \begin{equation}
