...
\begin{proof}
    ...
    \begin{subproof}
        ...
        Justifications.
        \begin{itemize}
            \item Pour \eqref{SUBEQooRISGooRUqBzj}. La fonction racine carrée est croissante, proposition \ref{}.
...
\begin{proposition} \label{PropACHooLtsMUL}
    Si \( q\) est une forme quadratique\footnote{Définition \ref{}.} sur \( \eR^n\) et si \( x,y\in \eR^n\) alors
    \begin{equation}
...
%TODO ? oui c'est sur ma liste de choses à faire.
    \end{subproof}
\end{proof}
