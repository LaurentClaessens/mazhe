...
\begin{proposition}     \label{PROPooZOAFooRMeBgI}
    Soient des espaces vectoriels normés de dimension finie. Soient \( f\colon E\to V\) et \( g\colon E\to W\) des fonctions de classe \( C^1\). Alors \( f\tilde\otimes g\colon E\to V\otimes W\) est de classe \( C^1\) et
...
\begin{proof}
    ...
    Ceci prouve que \( f\tilde\otimes g\) est différentiable et nous donne une formule pour appliquer sa différentielle à un élément de \( E\).Pour terminer nous devons prouver que \( f(f\tilde\otimes g)\) est continue.
\end{proof}
