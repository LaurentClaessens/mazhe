...
\begin{proposition}
    Soient une suite de matrices \( A_k\) et une matrice \( B\). Nous supposons que la somme \( \sum_{k=0}^{\infty}A_k\) converge. Alors
    \begin{equation}
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item Pour \eqref{SUBEQooJPSJooAqXtOJ}, c'est que la norme de matrice est une norme d'algèbre, lemme \ref{LEMooFITMooBBBWGI}.
    \end{itemize}
