...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \begin{equation}
            N(x)=N(\sum_ix_ie_i)\leq \sum_ix_iN(e_i)\leq n\|  \|_{\infty}D.
        \end{equation}
...
\begin{proof}
    ...
    \begin{equation}
        \alpha\| x \|_1\leq \| x \|_2\leq \beta\| x \|_2
    \end{equation}
...
\begin{proposition}     \label{PropovlAxBbarAbraB}
    Soit \( A\subset\eR^m\) et \( B\subset\eR^m\). Alors \( \overline{ A\times B }=\bar A\times \bar B\) dans \( \eR^{m+n}\).
\end{proposition}
...
\begin{proposition}\label{exoEspVectoNorme0002}
    ...
    \begin{enumerate}
        \item
            La partie $A$ est ouveret dans $\eR^2$.
        \item
