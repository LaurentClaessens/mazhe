...
Pour le lemme suivant, nous rappelons que la topologie considérée sur \( \eR^n\) est celle de la définition \ref{DefFAJgTCE}.
...
\begin{proof}
    En vertu de la proposition \ref{PropXIAQSXr}, il est suffisant de prouver la continuité séquentielle. Soit donc une suite convergente
    \begin{equation}
