...
\begin{proof}
    ...
    \end{equation}
    Nous avons utilisé la propriété \ref{DefEVNetDistance}\ref{ItemDefNormeii} d'une norme ainsi que le lemme \ref{LEMooQPXHooJWfpmk} pour la norme sur \( \eR\otimes \eR\).
\end{proof}
