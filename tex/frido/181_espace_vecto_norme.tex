...
\begin{lemma}
    Soit une suite \( (a_k)\) dont la série converge.
...
\begin{proof}
    ...
    Pour \ref{ITEMooQNHMooUPjupB}, nous nommons \( \ell\) la somme; en utilisant le point \ref{ITEMooPFSQooDhKFGL} nous écrivons
    \begin{equation}
        \ell=\sum_{k=0}^Na_k+\sum_{k=N+1}^{\infty}a_k.
    \end{equation}
    En passant à la limite \( N\to \infty\),
    \begin{equation}
        \ell=\ell+\lim_{N\to \infty} \sum_{k=N+1}^{\infty}a_k.
    \end{equation}
    Donc la limite demandée est bien zéro.
\end{proof}
