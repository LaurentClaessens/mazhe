...
\begin{lemma}       \label{LEMooTVQMooFxrFaT}
	Soient deux espaces topologiques \( X\) et \( Y\), ainsi qu'un homéomorphisme\footnote{Définition \ref{DEFooYPGQooMAObTO}.} \(f \colon X\to Y  \). L'espace \( X\) est connexe par arcs\footnote{Définition \ref{DEFooOXVCooBizpgK}} si et seulement si \( Y\) l'est.
\end{lemma}
