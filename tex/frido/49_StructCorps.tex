...
\begin{lemma}[\cite{BIBooIXPJooEyrkRc,BIBooDYIOooNtTWFI}]
...
\begin{proof}
    ...
    \begin{equation}
        (m^p)^2\in[1]_q.
    \end{equation}
    Vu que \( q\) est premier, l'anneau \( \eZ/q\eZ\) est un corps par la proposition \ref{PropzhFgNJ}.
\end{proof}
<++>

\begin{theorem}[\cite{BIBooIXPJooEyrkRc,BIBooDYIOooNtTWFI}]     \label{THOooSZXWooVeHdrh}
...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[Utilisation d'un lemme]
            ...
            Pour rappel, \( p\) est impair.  Nous avons \( (-x)^p=(y+z)u\). Le lemme \ref{LEMooEVIZooPAkQZW} nous dit qu'il existe \( a,\alpha\in \eZ\) tels que \( (y+x)=a^p\) et \( u=\alpha^p\). Ce \( \alpha\) ne sera pas important pour la suite.
    ...
    Si \( k\) est un diviseur commun de \( x\), \( y\) et \( z\), alors \( (x/k,y/k,z/k)\) est encore une solution.
\end{proof}
