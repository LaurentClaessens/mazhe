...
\begin{normaltext}      \label{NORMooUJDJooWfijxT}
    En général, lorsque nous dirons «le» pgcd d'un ensemble, nous parlerons du pgcd unitaire, qui existe et est bien défini par le lemme~\ref{LEMooXISOooNAMeVX}. En particulier, si \( P\) et \( Q\) sont des polynômes, nous notons \( \pgcd(P,Q)\) l'unique polynôme unitaire parmi les PGCD de \( P\) et \( Q\).
\end{normaltext}
