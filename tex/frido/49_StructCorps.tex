...
\begin{lemma}
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    avec \( Q\in\eK[X]\) est un isomorphisme d'anneaux.
    % position 118885898. 
\end{lemma}
...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[Injective]
            ...
            Si \( \bar Q_1=\bar Q_2\), alors \( Q_1=Q_2+R\) avec \( R\) dans l'idéal engendré par \( \mu\), c'est à dire entre autres \( R(\alpha)=0\).
...
\begin{lemma}
    Soient une extension de corps \( \eL\) de \( \eK\) et un élément \( \alpha\in \eL\) algébrique sur \( \eK\). Soit \( \mu\) le polynôme minimal de \( \alpha\) sur $\eK$. Alors nous avons l'isomorphisme d'anneau
    \begin{equation}
        \begin{aligned}
            \varphi\colon \eK[\alpha]&\to \eK[X]/(\mu) \\
            Q(\alpha)&\mapsto \bar Q 
...
\begin{proof}
    ...
    \begin{subproof}
        \item[\ref{ITEMooYTEBooUuEfBz} implique \ref{ITEMooWMQTooLnepQl}]
            ...
            Soit \( \alpha\) algébrique sur \( \eK\). Nous considérons le polynôme minimal de \( \alpha\) sur \( \eK\) (définition \ref{DefCVMooFGSAgL}).
