...
\begin{proof}
    ...
    Un corps est toujours un anneau intègre par le lemme \ref{LemAnnCorpsnonInterdivzer}. Avec ça, le lemme \ref{LEMooIDSKooQfkeKp} fait de \( \eK[X]\) un anneau principal.  
