...
\begin{definition}[Thème~\ref{THEMEooKZHBooRCULcr}]  \label{DefActionGroupe}
	...
	Si \( G\) et \( E\) sont topologiques nous disons que \( G\) agit \defe{continûment}{action continue} si \( \phi\) est une application continue pour la topologie produit\footnote{Définition \ref{DEFooJHXKooQApPtQ}.} sur \( G\times E\).
\end{definition}
...
\begin{proof}
	...
	\begin{subproof}
		...
		%-----------------------------------------------------------
		Il y a quelque vérifications à faire pour l'associativité et la distributivité\quext{Je vous invite à les faire parce que je n'ai pas vérifié.}.
