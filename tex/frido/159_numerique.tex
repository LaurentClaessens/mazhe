...
\begin{subequations}
    ...
    \end{numcases}
\end{subequations}
Les matrices \( P_k\) n'ont pas besoin d'être enregistrées : seules les numéros de lignes permutées sont à retenir. La matrice \( L_k\) est enregistrée et modifiée à chaque étape. Notons que \( P_k\) est une matrice de permutation élémentaire.

La matrice \( M_k^{-1}\) est connue par ses paramètres; elle est de la forme
\begin{equation}
