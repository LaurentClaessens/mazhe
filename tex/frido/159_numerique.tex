...
%--------------------------------------------------------------------------------------------------------------------------- 
\subsection{Matrices à diagonale domainante}
%---------------------------------------------------------------------------------------------------------------------------

\begin{definition}[\cite{ooFAQUooRcQHZf}]
...
\begin{proposition}
    Soit \( A\in \eM(n,\eC)\) une matrice a diagonale dominante. Si \( A=D-M\) où \( D\) est la diagonale de \( A\) (et \( M\) est «le reste») alors
    \begin{equation}
        \rho(D^{-1}M)<1
    \end{equation}
