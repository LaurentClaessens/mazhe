...
\begin{proposition}[\cite{MonCerveau}]	\label{PROPooQWIUooFaNzTx}
	L'application \( x\mapsto \frac{1}{ x}\) est différentiable pour tout \( x\neq 0\).
\end{proposition}

\begin{proof}
	C'est un cas particulier de la proposition \ref{PROPooJDJJooInDpCd}.
\end{proof}
