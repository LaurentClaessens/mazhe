...
%-------------------------------------------------------
\subsection{Topologie des seminormes}
%----------------------------------------------------
...
\begin{propositionDef}[Topologie et seminormes\cite{SOdaAdx,MUbDonp,BIBooTDEOooFNoMUV}]      \label{DEFooZTKAooWYUyDa}
	Soient des seminormes \( \{ p_i \}_{i\in I}\) sur l'espace vectoriel \( E\). Pour tout \( J\) fini dans \( I\) nous définissons les \defe{boules ouvertes}{boule!avec seminormes}
	\begin{equation}
	...
	Nous posons
	\begin{equation}
		\tau=\{ \mO\subset E\tq \forall x\in\mO, \exists J,r\tq B_j(x,r)\subset \mO \}.
	\end{equation}
	...
	\begin{enumerate}
		...
		\item
		      L'espace topologique \( (E,\tau)\) est localement convexe.
	\end{enumerate}
