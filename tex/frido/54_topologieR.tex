...
\begin{proposition}[\cite{BIBooMXJCooRrhgWM}]		\label{PROPooDDURooJHfHLw}
...
\begin{proof}
	...
	\begin{subproof}
		...
		%-----------------------------------------------------------
		Nous supposons que \( p\) est continue en \( 0\in X\) et nous devons prouver qu'elle est continue en \( a\in X\). Nous ne préférons pas utiliser la caractérisation séquentielle de la continuité parce qu'il n'est absolument pas clair que la proposition \ref{PropXIAQSXr} soit applicable sans hypothèses sur l'espace vectoriel topologique \( X\). Nous démontrons donc la continuité à l'ancienne.
	\end{subproof}
\end{proof}
