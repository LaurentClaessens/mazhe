...
\begin{lemma}[\cite{SIdTHwW}]       \label{LEMooTOJDooQDtWUC}
	...
	%TODOooETVXooUZrfDs prouver ça. J'ai ajouté ce todo le 20 juillet 2024, mais à mon avis il est inutile.
\end{lemma}

\begin{theorem}[Théorème de Baire\cite{SIdTHwW,BIBooEFASooXGJiBG}]    \label{ThoBBIljNM}
