...
\begin{lemma}[\cite{MonCerveau}]	\label{LEMooRTXFooCMCaHC}
	...
	%TODOooETVXooUZrfDs prouver ça.
\end{lemma}


\begin{propositionDef}[Espacede Baire\cite{MonCerveau,BIBooDMFTooNXLOZr,SIdTHwW}]	 \label{DEFooYEMNooLSXLYa}
...
\begin{proof}
	...
	\begin{subproof}
		...
		\begin{equation}
			\bigcup_iF_i=\bigcup_i(X\setminus A_i)=X\setminus\big( \bigcup_iA_i \big).
		\end{equation}<++>

		% Je dois d'abord prouver LEMooRTXFooCMCaHC
