...
% Copyright (c) 2011-2018, 2020-2026
...
\begin{lemma}[\cite{ooYDVWooPWLUGW}]           \label{LEMooKEMRooYyqsBl}
	Soit une famille de fonctions \( f_i\colon X\to E\) indexée par un ensemble \( I\) où \( X\) est un espace topologique et \( E\) un espace métrique. Cette famille est équicontinue\footnote{Définition \ref{DEFooDHQDooFfIvsX}.} en \( x\in X\) si et seulement si pour tout \( \epsilon>0\), il existe un voisinage \( U\) de \( x\) tel que
	\begin{equation}
		\| f_i(x)-f_i(y) \|<\epsilon
	\end{equation}
	pour tout \( x\in U\) et \( i\in I\).
\end{lemma}
...
\begin{proof}
	...
	\begin{subproof}
		\spitem[\( \Rightarrow\)]
		%-----------------------------------------------------------
		Nous supposons que \( \{ f_i \}_{i\in I}\) est équicontinue en \( a\in X\). Soit \( \epsilon>0\). La partie \( B(0,\epsilon)\) est un voisinage de \( 0\) dans \( E\). Donc, par définition de l'équicontinuité, il existe un voisinage \( U\) de \( a\) dans \( X\) tel que \( f_i(U)\subset f_i(a)+B(0,\epsilon)\) pour tout \( i\in I\). C'est à dire que pour tout \( x\in U\) nous avons
		\begin{equation}
			f_i(x)\in f_i(a)+B(0,\epsilon),
		\end{equation}
		ce qui est équivalent à dire que \( \| f_i(x)-f_i(a) \|<\epsilon\).

		\spitem[\( \Leftarrow\)]
		%-----------------------------------------------------------
		Soit un voisinage \( V\) de \( 0\) dans \( E\). Nous considérons \( \epsilon>0\) tel que \( B(0,\epsilon)\subset V\). Il existe un voisinage \( U\) de \( a\) tel que \( \| f_i(a)-f_i(x) \|<\epsilon\) pour tout \( x\in U\). Cela signifie que \( f_i(x)\in f_i(a)+B(0,\epsilon)\), et à fortiori que \( f_i(x)\in f_i(a)+V\).
	\end{subproof}
\end{proof}
