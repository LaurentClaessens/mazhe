...
\begin{proof}
    ...
    \item[\ref{ITEMooCVFVooWltGqI}]
        ...
        \end{equation}
        pour tout \( h\). Nous utilisons encore Taylor\footnote{Théorème \ref{}.} : il existe une fonction \( \epsilon\) telle que \( \lim_{h\to 0} \epsilon(h)=0\) et
        \begin{equation}
...
\begin{example}
    ...
    \begin{equation}
        ...
        \end{pmatrix},
    \end{equation}
    dont les valeurs propres sont \( 4\) et \( -4\). Elle n'est donc ni définie ni semi-définie positive ou négative. La proposition \ref{} conclu donc \( (0,0)\) n'est pas un extrémum local.
