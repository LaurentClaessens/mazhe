...
% Copyright (c) 2011-2015,2018-2021
%   Laurent Claessens
...
\begin{proposition}     \label{PROPooUDFTooQyhAtq}
    Pour tout réels \( p\geq 1\), la formule
...
Si vous cherchiez l'inégalité de Hölder dans \( L^p\), c'est la proposition \ref{ProptYqspT}. Les normes \(  \ell^p\) sont définies dans \ref{PROPooUDFTooQyhAtq}.
