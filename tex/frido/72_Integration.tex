...
La définition suivante donne une notion de \( \int_Af\) lorsque \( A\) est une partie de \( \eR^n\) qui peut être mise en \( C^1\)-difféomorphisme avec un ouvert de \( \eR^m\).
...
\begin{propositionDef}[\cite{MonCerveau}]     \label{PROPooOAHWooAfxvyv}
    Soient des ouverts \( U_1\) et \( U_2\) de \( \eR^m\) ainsi que \( A\subset \eR^n\). Nous supposons que les applications \( \varphi_1\colon U_1\to A\) et \( \varphi_2\colon U_2\to A\) sont des bijections telles que \( \varphi_1^{-1}\circ \varphi_2\colon U_2\to U_1\) soit un \( C^1\)-difféomorphisme. Alors\footnote{Voir la définition de l'adjoint \ref{DEFooROVNooFlTbSK}.}
    \begin{equation}
