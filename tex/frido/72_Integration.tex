...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[Droite \( x=a\)]
            Nous utilisons la seconde possibilité laissée par l'égalité \eqref{EQooUTAHooUyFScq}. Pour tout \( y\), \( A_1(y)=\{ a \}\). Donc \( \lambda\big( A_1(y) \big)=0\) pour tout \( y\), et l'intégrale est nulle.
    \end{subproof}
\end{proof}
