...
% TODO : il n'existe pas de C^1-difféomorphismes d'un ouvert de  R^m vers le cercle S^1 dans R^2.
% ooGNZNooAUdDws
...
\begin{proof}
    ...
    \begin{enumerate}
        \item
            ...
            % todo TODOooDZRTooNjcLac : prouver mieux la proposition citée.
        \item
...
\begin{proof}
   ...
   Le point \( g(x) \) est la solution du système
    ...
    \begin{itemize}
        \item
            L'intégrale \( \int_{\partial B}\omega\) est l'aire de \( \partial B\) et est donc non nulle.       % citer
        \item
