...
\begin{lemma}[\cite{MonCerveau}]
    ...
    \begin{enumerate}
        ...
        \item
            ...
            \begin{equation}
                \det(d\varphi_x^*\circ d\varphi_x) \geq 0.
            \end{equation}
    \end{enumerate}
\end{lemma}
...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item
            Dans la base de vecteurs propres, la matrice est diagonale avec des nombres positifs sur la diagonale. Le déterminant est alors le produit des valeurs propres.
    \end{enumerate}
\end{proof}
