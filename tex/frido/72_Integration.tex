...
\end{equation}
Lorsque nous voulons intégrer sur une partie plus grande qu'une carte nous utilisons une partition de l'unité du lemme \ref{}. 
...
\begin{proof}
    ...
    Nous allons à présent construire une sorte de partition de l'unité subordonnée au recouvrement \eqref{EqKNPUVR} sur \( K\) (voir le lemme~\ref{}). Nous commençons par définir
    \begin{equation}
        \psi_j(x)=\begin{cases}
