...
% Ce théorème doit être démontré indépendamment de ThoRGjGdO. Et surtout sans utiliser Stokes.
\begin{theorem}[Brouwer dans \( \eR^n\), version continue]		\label{THOooZMUAooSPlqUx}
