...
\begin{proof}
	...
	\begin{enumerate}
		...
		\item
		      ...
		      Mais \( \varphi\colon U\to \varphi(U)\) est bijective, donc l'application \( \varphi^{-1}\colon \varphi(U)\to U\) l'est aussi et vu que \( \varphi\) est une carte, l'application \( \varphi^{-1}\circ\varphi\colon U\to U\) est égale à l'identité. L'identité est une application linéaire dont la différentielle est elle-même\footnote{Lemme \ref{LEMooZSNMooCfjzOB}.}, c'est-à-dire que
		      \begin{equation}
