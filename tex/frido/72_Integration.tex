...
\begin{definition}[Variété orientable]      \label{DEFooSWREooNdQpdA}
    Une variété $M$ est \defe{orientable}{variété orientable} s'il existe un atlas de $M$ tel que deux cartes quelconques ont toujours même orientation. Une variété est \defe{orientée}{variété !orientée} lorsque qu'un tel choix d'atlas est fait.
\end{definition}
