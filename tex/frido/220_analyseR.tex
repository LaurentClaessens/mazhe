...
\begin{proof}
	...
	\begin{subproof}
		...
		\spitem[Pour \ref{ITEMooUTNTooGNSTwd}]
		%-----------------------------------------------------------
		...
		\begin{equation}		\label{EQooYMTKooQXmNIB}
		...
		\begin{equation}		\label{EQooGFSKooQJfBse}
...
\begin{proposition}[Inégalité triangulaire dans \( \eC\)\cite{BIBooRRXPooQhgCsS}]     \label{PROPooEEFGooACcCll}
	...
	\begin{enumerate}
		...
		\item		\label{ITEMooWGAQooTvMOaG}
		      \( \big| | a |-| b | \big|\leq | a-b |\)
	\end{enumerate}
	Dans les deux cas, il y a égalité si et seulement si \( a\) et \( b\) sont positivement liés\footnote{Voir proposition \ref{PROPooYLVPooCVnpFw} pour des conditions équivalentes.}.
\end{proposition}
