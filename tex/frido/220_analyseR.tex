...
\begin{proof}
	Étant donné que \( y^2\geq0\), ce que dit le corolaire \ref{DEFooGQTYooORuvQb} est qu'il y a un unique \( p\geq 0\) tel que \( p^2=y^2\). Nous faisons quelque cas suivant la positivité de \( x\) et \( y\).
	\begin{subproof}
		\spitem[Si \( x,y\geq 0\)]
		%-----------------------------------------------------------
