...
Nous pouvons nous demander à quel point cette équation caractérise la fonction puissance. Nous posons une définition
\begin{definition}      \label{DEFooPJKMooOfZzgy}
    ...
    \begin{subequations}
        ...
        \end{numcases}
    \end{subequations}
    pour la fonction inconnue \( f\).
\end{definition}
Cette équation a au moins la solution \( f=g_a\).
...
\begin{definition}      \label{DEFooXMQTooSbZzqJ}
    ...
    \begin{subequations}
        ...
        \end{numcases}
    \end{subequations}
    pour la fonction inconnue \( y\).
\end{definition}

\begin{proposition}[\cite{BIBooXUZHooOHWxiF}]    \label{PROPooGBUPooWtWaFI}
    Soit \( a>0\). Nous considérons l'équation fonctionnelle \ref{DEFooPJKMooOfZzgy} et l'équation exponentielle \ref{DEFooXMQTooSbZzqJ}.
    \begin{enumerate}
        \item
        ...
        \item
            La fonction \( g_a\) vérifie l'équation exponentielle.
        \item
