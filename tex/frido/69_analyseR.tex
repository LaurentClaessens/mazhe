...
\begin{normaltext}
    Remarquons que la dérivabilité de \( g_a\) a été prouvée en utilisant une primitive. Or l'existence d'une primitive pour les fonctions continues demande un gros théorème, Stone-Weierstrass \ref{ThoGddfas}.

    La démonstration donnée dans \cite{BIBooXUZHooOHWxiF} s'assure d'abord de l'existence d'une intégrale (lemme \ref{LEMooWKSWooPptdEm}) et fait ensuite ce calcul :
    \begin{equation}
    ...
    Si vous êtes capable de montrer l'existence de la limite
    \begin{equation}
