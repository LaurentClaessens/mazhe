...
\begin{theorem}[\cite{TrenchRealAnalisys}]     \label{THOooXZQCooSRteSr}
    Soient une suite de fonctions \( f_i\), une fonction \( f\) et une fonction \( g\) telles que
    \begin{enumerate}
        \item
...
\begin{proof}
    Soient un intervalle compact \( K\), et \( x_0\in K\). Par hypothèse, les fonctions \( f_i\) sont continues, donc
    \begin{equation}
