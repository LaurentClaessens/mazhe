...
Dans la proposition suivante, \( S^1\) désigne l'ensemble des nombres complexes de norme \( 1\), dont un paramétrage est donnée dans la proposition \ref{PROPooXELTooYKjDav}\ref{ITEMooOHRHooRXvxrL} :
\begin{equation}
