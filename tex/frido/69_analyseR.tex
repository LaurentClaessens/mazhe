...
\begin{theorem}		\label{ThoSerUnifDerr}
    Soient des espaces vectoriels normés \( V\) et \( W\). Soient un ouvert \( U\) de \( V\) et des fonctions \( f_k\colon U\to W\), une autre fonction \( f\colon U\to W\) ainsi que, pout toute direction \( \alpha\in V\), des fonctions \( g_{\alpha}\colon U\to W\). Nous supposons que
    \begin{enumerate}
        \item
    ...
    \begin{enumerate}
        \item
            Nous avons la convergence \( f_k\to f\) uniformément sur tout compact.
        \item
