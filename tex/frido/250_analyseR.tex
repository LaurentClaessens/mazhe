...
\begin{proof}
	...
	\begin{subproof}
		...
		\begin{equation}
			i(A)=\phi(A-T)
		\end{equation}
		Vu que \( \phi\) est analytique et que \( A\mapsto A-T\) est analytique (proposition \ref{PROPooFEMWooDwAYyO}), par composition, l'application \( i\) est analyique (proposition \ref{PROPooXKHBooQvvNmN}).
	\end{subproof}
