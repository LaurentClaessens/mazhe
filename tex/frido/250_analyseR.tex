...
\begin{proof}
	...
	En ce qui concerne la seconde formule, un point arbitraire entre \( a\) et \( a+h\) est bien \( a+\theta h\) avec \( \theta\in\mathopen] 0,1\mathclose[\)\quext{Faites le calculs, je ne l'ai pas fait. Écrivez-moi pour me dire si c'est bon ou non.}.
\end{proof}
...
\begin{proposition}[Taylor avec reste de Lagrange]     \label{PropResteTaylorc}
...
\begin{theorem}		\label{ThoProuverDiffable}
	...
	%TODOooDOMSooKQAWQb. Prouver ça. Presque certain que c'est déjà ailleurs.
\end{theorem}
