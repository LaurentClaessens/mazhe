...
\begin{proof}
	...
	\begin{subproof}
		...
		\spitem[transitivité]
        Nous supposons que \( x\leq y\) et \( y\leq z\). L'hypothèse \( x\leq y\) signifie \( y-x\in\bar\modE^+\) ou encore que \( b-a\in\maodE^+\). Même chose pour \( y\leq z\) qui signifie que \( c-b\in\modE^+\). Nous avons alors
		\begin{subequations}
			\begin{align}
				c-a & =c-b+b-a            \\
				    & =(c-b)+(b-a)        \\
