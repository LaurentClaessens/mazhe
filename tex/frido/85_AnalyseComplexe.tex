...
% Copyright (c) 2012-2013,2016-2019, 2021-2022
%   Laurent Claessens
...
\begin{proof}
	...
	\begin{subproof}
		...
		\spitem[\ref{ITEMooEAUOooIWcxHS} implique \ref{ITEMooETRWooDTTpxs} dans le cas \( a=0\)]
		...
		\spitem[\ref{ITEMooETRWooDTTpxs} implique \ref{ITEMooMLXJooMfuifN}]
		...
		\spitem[\ref{ITEMooEAUOooIWcxHS} implique \ref{ITEMooETRWooDTTpxs} dans le cas \( a\neq 0\)]
