...
\begin{lemma}       \label{LEMooSHJMooYiEAnD}
    Une application bilinéaire est définie positive si et seulement si sa matrice symétrique associée l'est.
\end{lemma}
%TODOooHJECooFCAAHN Faire la preuve de LEMooSHJMooYiEAnD, et supprimer le itemize ooHXOGooEWYwQy

La preuve de ce lemme lie 
\begin{itemize}     % ooHXOGooEWYwQy
    \item 
        La définition~\ref{DefAWAooCMPuVM},
    \item
        la proposition \ref{PROPooUAAFooEGVDRC} 
    \item
        Les définitions \eqref{EqZYBooZysmVh} et \eqref{EQooJETQooIjxRWu}.
\end{itemize}
