...
\begin{definition}[Sous-groupe engendré]        \label{DefooRDRXooEhVxxu}
    ...
    En particulier, \( \gr(\emptyset)=\{ e \}\)\footnote{Vu que l'ensemble vide est une partie de tous les ensemble, la définition \( \gr(\emptyset)=\{ e \}\) est ambigüe : c'est l'identité de quel groupe ? C'est le contexte qui dira.}.
\end{definition}
