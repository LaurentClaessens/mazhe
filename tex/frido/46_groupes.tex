...
\begin{proof}
	Le point \ref{ITEMooOOOZooXTClck} est un cas particulier du lemme \ref{LEMooPCRFooXRGrUr}. Le point \ref{ITEMooKXLXooVVwpnj} dans un sens est le point \ref{ITEMooOOOZooXTClck} tandis que dans l'autre sens, c'est le lemme \ref{LEMooPCRFooXRGrUr}.
\end{proof}
