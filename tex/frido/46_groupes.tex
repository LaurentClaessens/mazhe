...
\begin{proof}
	...
	\begin{subproof}
		...
		%-----------------------------------------------------------
		Déjà l'union des orbites fait bien \( E\) parce que pour tout \( x\in E\) nous avons \( x\in\Omega_{\sigma}(x)\). Prouvons que ces orbites sont disjointes. Pour cela nous supposons que \( b\in \Omega_{\sigma}(a)\) et nous montrons que \( \Omega{\sigma}(a)=\Omega_{\sigma}(b)\). Posons \( b=\sigma^k(a)\) et allons-y pour la preuve.
		\begin{subproof}
