...
\begin{propositionDef}     \label{PROPooVZFHooKfSpfO}      % Voir si la DEFooZTKAooWYUyDa est très différence de ceci.
    Pour chaque \( K\) compact dans \( \Omega\) et multiindice \( \alpha\in \eN^d\) nous l'application
