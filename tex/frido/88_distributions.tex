...
\begin{normaltext}
    Nous verrons dans l'exemple \ref{EXooFTHGooPgOclr} que la dérivée de Heaveside au sens des distributions est le delta de Dirac.
\end{normaltext}
...
\begin{example}     \label{EXooFTHGooPgOclr}
    ...
    \item Pour \eqref{SUBEQooMRMBooEGeDra}, c'est que \( H(t)=0\) pour \( t\in \mathopen] -\infty , 0 \mathclose[\).
        \item Pour \eqref{SUBEQooZDSDooTbzgWD}, c'est \ref{}.
