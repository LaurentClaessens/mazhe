...
\begin{definition}  \label{DefFGGCooTYgmYf}
	...
	\end{enumerate}
	Note : pour l'ensemble des fonctions \( C^{\infty}\) à support compact dans \( A\), la notation devrait être \( C^{\infty}_c(A)\), et non \( \swD(A)\). Hélas je ne suis pas consistant dans les notations.
\end{definition}
