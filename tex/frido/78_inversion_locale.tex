...
\begin{normaltext}
    Il y a d'autres moyens de prouver qu'une solution existe sur tout \( \eR\). Si \( f\) est globalement bornée, le théorème d'explosion en temps fini donne quelque garanties, voir \ref{NORMooZROGooZfsdnZ}.
\end{normaltext}
