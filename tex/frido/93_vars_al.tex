...
% Copyright (c) 2011-2013,2016-2020, 2023-2025
%   Laurent Claessens
...
\begin{definition}
	La loi \( \chi^2\)\index{loi!\( \chi^2\)} à \( d\) degrés de liberté est la loi de la variable aléatoire \( Y_1^2+\cdots+Y_n^2\) si les \( (Y_i)\) sont des variables aléatoires normales indépendantes centrées et réduites.
