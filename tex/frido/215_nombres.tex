...
\begin{proposition}[\cite{MonCerveau}]	\label{PROPooOTHMooPzPzdW}
	...
	\end{enumerate}
	%TODOooVLQNooBumUlE. Prouver ça. On a une récurrence à faire, donc on ne peut en parlet plus tôt.
\end{proposition}
...
\begin{proof}
	...
	\end{subproof}
	% TODOooMKVUooOSJAzg. Faire l'existence et l'unicité du minimum.
	% Déjà dans la liste.
\end{proof}
...
% \label{SUBooEnsemblesDenombrables}  Il y a déjà ce label plus haut
%---------------------------------------------------------------------------------------------------------------------------
