...
\begin{theorem}[Dérivée de fonctions composées\cite{ooVNAOooAuQSse}]\label{THOooHCSFooFncqHO}
...
\begin{proposition}[Dérivation d'un quotient\cite{ooOGGJooCGQgDO}]        \label{PROPooMPSFooOASfDm}
...
\begin{proof}
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    La fonction \( g\) est dérivable en \( a\), la fonction \( i\) est dérivable en \( g(a)\). Donc par le théorème de dérivation des fonctions composées\footnote{Théorème \ref{THOooHCSFooFncqHO}.}, la fonction \( i\circ f\) est dérivable en \( a\) et
    \begin{equation}
    ...
    \begin{subproof}
        ...
        \item[Rationnel positif]
            ...
            \begin{equation}
                f_{p/q}(x)^q=x^p.
            \end{equation}
            Nous dérivons cette relation par rapport à \( x\) en utilisant à la fois la règle pour les entiers et la règle des fonctions composées\footnote{Théorème \ref{THOooHCSFooFncqHO}.} :
            \begin{equation}
