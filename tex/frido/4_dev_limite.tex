...
Nous avons laissé le nombre \( \pi\) avec l'approximation assez minable de \( 2\sqrt{ 2 }<\pi<4\) en le lemme \ref{LEMooJWSGooExmtDA}. Nous pouvons maintenant faire nettement mieux.
