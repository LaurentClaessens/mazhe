...
\begin{enumerate}
    ...
    \item
        Corps de rupture. Dans \ref{NORMALooTPOIooVZAfUo} nous discutons de \( A[X]/(P)\) lorsque \( A\) est un anneau et \( P\) est irréductible.

        Pour quelle classe d'anneaux peut-on définir un corps de rupture ?
    \item
