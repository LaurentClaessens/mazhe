...
\begin{enumerate}
    ...
    \item
        ...
        Faire le lien entre les fonctions trigonométriques (définies par leur série) et les relations dans un triangle serait une bonne affaire. Indice : la relation entre les fonctions trigonométriques et les rotations de \( \eR^2\) est dans le lemme \ref{LEMooHRESooQTrpMz} qui a besoin de quelque identités trigonométriques, données dans le lemme \ref{LEMooIJFVooPtEIpC}.
