...
% Copyright (c) 2011-2015,2017-2020,2023
%   Laurent Claessens
...
\begin{definition}      \label{DEFooRSLCooAsWisu}
	Une application \( f\colon (X,d_X)\to (Y,d_Y)\) entre deux espaces métriques est une \defe{contraction}{contraction} si elle est \( k\)-\defe{Lipschitz}{Lipschitz} pour un certain \( 0\leq k<1\), c'est-à-dire si pour tout \( x,y\in X\) nous avons
	\begin{equation}
