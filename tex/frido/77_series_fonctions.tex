...
\begin{remark}
    ...
    \end{equation}
%TODO: coup du compact est plus bas. Le deplacer... + Reference
...
\begin{proof}
    ...
    \end{equation}
    Le fait que l'intégrale existe est simplement parce qu'il s'agit d'une fonction continue sur un compact et donc majorée par une constante. Pour voir que \( g_i\) est de classe \( C^{p-1}\) nous pouvons calculer \( \frac{ \partial g_i }{ \partial x_k }\) en permutant dérivée et intégrale par la proposition~\ref{PropDerrSSIntegraleDSD} :
    \begin{equation}
...
\begin{proof}
    ...
    \begin{equation}
        \begin{aligned}
%TODO: je suis mal a l'aise avec cette def. Peut-etre qu'en deuxieme lecture, ça ira mieux ?
            \Phi\colon \mF  & \to \mF             \\
