...
\begin{proof}
	...
	\begin{equation}
		\omega=g\,dx^1\wedge\cdots\wedge dx^p
	\end{equation}
	où \( g\) est une fonction \(  C^{\infty}\). Pour soulager les notations nous allons noter \( dx^I=dx^1\wedge\cdots\wedge dx^{p-1}\). Nous avons
	\begin{subequations}
		\begin{align}
