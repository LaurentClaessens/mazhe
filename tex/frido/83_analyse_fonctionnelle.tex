...
\begin{theorem}[\cite{TUEWwUN}]         \label{THOooIAOPooELSNxq}
    ...
    \begin{enumerate}
        ...
        Si \( g\in L^p(\Omega)\) (\( 0\leq p<\infty\)) alors\footnote{Vous noterez les \( p\in \mathopen] 0 , 1 \mathclose[\) en bonus par rapport au cas de \( \eR^n\).}
            \begin{equation}
                \varphi_k*g\stackrel{L^p}{\to}g.
            \end{equation}
...
\begin{proof}
    ...
    \begin{subproof}
        \item[Le point \ref{ITEMooNUDFooYLFIwR}]
        ...
        \item[Convergence \( L^{\infty}\)]
            ...
            Non, la convergence \( L^{\infty}\) n'est pas la convergence pour la norme \( \| . \|_{\infty}\).
    \end{subproof}
    <++>
\end{proof}
<++>
