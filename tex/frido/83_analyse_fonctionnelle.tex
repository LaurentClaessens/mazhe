...
\begin{theorem}[Inégalité de Hanner\cite{ooKGWWooAybolH}]       \label{THOooZRRYooBTBQKW}
...
\begin{proof}
    ...
    \end{equation}
    Vu que nous avons une inégalité pour tout \( t\), la seule manière d'avoir une égalité dans \eqref{EQooNFIAooQjjuOn} est d'avoir une égalité dans \eqref{EQooICUMooPhECbN} pour presque tout \( t\).
