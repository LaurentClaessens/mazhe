...
\begin{definition}
    ...
    \end{equation}
\end{definition}
Le but de \( z\mapsto z^n\) dans cette défintion est d'être lu \(  t\mapsto e^{in t}\) lorsqu'on considère les fonctions sur \( \mathopen[ 0 , 2\pi \mathclose[\).
...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
qui est une bijection par la proposition \ref{PROPooZEFEooEKMOPT}.
