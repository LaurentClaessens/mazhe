...
\begin{proposition}
    ...
    \begin{enumerate}
        ...
        \item
            La formule définit une distance sur \( S^1\).
        \item
            La topologie de cette distance est la topologique induite de \( \eC\).
    \end{enumerate}
\end{proposition}
...
\begin{proof}
    ...
    \begin{enumerate}
        \item
            Soient \( x',y'\in \eR\) tels que \(  e^{ix'}= e^{ix}\) et \(  e^{iy'}= e^{iy}\). Alors \( x'=x+2l\pi\) et \( y'=y+2l'\pi\) pour certains entiers \( l,l'\in \eZ\).
    \end{enumerate}
    <++>
\end{proof}
<++>
