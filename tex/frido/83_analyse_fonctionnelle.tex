...
\begin{theorem}[\cite{ooQCDSooCpqDvB}]      \label{THOooPCHDooITWKpC}
	...
	Ce théorème ne donne pas une partition de l'unité à support compact subordonnée au recouvrement. Soit la partition est à support compact, soit elle est subordonnée. En général les deux.
\end{theorem}
