...
\begin{proof}
    ...
    Et enfin,
    \begin{equation}
        \langle f, \rangle f=\int_a^b| f(x) |^2dx\geq 0.
    \end{equation}
...
\begin{theorem}[\cite{BIBooZYKMooGGbwyI}]
...
\begin{proof}
    Nous devons prouver que la famille donnée est dénombrable, orthonormée et totale. Pour dénombrable, c'est que \( \eZ\) est dénombrable (lemme \ref{LEMooJNXIooBmdOVi}). Pour orthonormée, 
\end{proof}
...
\begin{proof}
    Nous prouvons d'abord que le système est orthogonal. Nous avons
    \begin{equation}
