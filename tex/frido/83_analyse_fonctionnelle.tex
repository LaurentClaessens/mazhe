...
\begin{theorem}[Inégalité de Hanner\cite{ooKGWWooAybolH}]
    Soit \( 1<p<2\). Nous avons :
    \begin{equation}
        \big( \| f \|_p+\| g \|_p \big)^p+| \| f \|_p+\| g \|_p |^p\leq \| f+g \|_p^p+\| f-g \|_p^p\leq 2\| f \|_p^p+2\| g \|_p^p.
    \end{equation}
\end{theorem}
...
\begin{proof}
    ...
    Soit \( z_1,z_2\in \eC\). Nous posons
    \begin{equation}
