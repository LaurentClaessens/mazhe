...
Nous considérons le polynôme trigonométrique \( Q\) du lemme \ref{}<++>

Cette fonction \( Q\) est un polynôme trigonométrique, et ses puissances le sont aussi parce que si \( z= e^{ix}\), alors
\begin{equation}
    e_1(z)^n=( e^{ix})^n= e^{inx}=e_n(z).
\end{equation}
Il y a là une utilisation du lemme \ref{LEMooTDGKooWdpUTD}.

Par le lemme \ref{LEMooUNFBooRCzwIn}, en posant
\begin{equation}
    kkml
\end{equation}
<++>
