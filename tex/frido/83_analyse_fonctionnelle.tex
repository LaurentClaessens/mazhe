...
\begin{proof}
    ...
    \begin{subproof}
        \item[Pour \ref{ITEMooNCVEooTyNsoJ}]
            ...
            Soient \( f\in L^p\) et \( \varphi\in (L^p)'\). Il existe \( g\in L^q\) tel que \( \varphi=\alpha_2(g)\). Nous pouvons donc calculer d'une part
            \begin{subequations}
                \begin{align}
                    (\beta_2\circ \alpha_1)(f)\varphi&=\beta_2\big( \alpha_1(f) \big)\varphi\\
                    &=\alpha_1(f)\big( \alpha_2^{-1}(\varphi) \big)   &  \text{par \eqref{EQooTSVHooEQGuNw}}\\
                    &=\alpha_1(f)(g)\\
                    &=\int_{\Omega}g\bar f,
                \end{align}
            \end{subequations}
