...
\begin{proof}
    ...
    \item[Nouvelle base de topologie]
        ...
        \begin{subequations}
            ...
            \end{align}
        \end{subequations}
        Le fait est que \( A_k\cap U_k\) est un ouvert autour de \( 0\); donc le lemme \ref{PROPSommeTopologique} permet de construire un ouvert \( U_{k+1}\) autour de \( 0\) ayant la propriété \eqref{SUBEQooECMVooLllLhu}.
