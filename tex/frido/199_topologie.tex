...
La valeur absolue est essentielle pour introduire les notions de limite et de continuité pour les fonctions d'une variable. La proposition \ref{} nous dit en effet que la fonction \( f\colon \eR\to \eR\) est continue en \( a\) si et seulement si pour tout $\varepsilon > 0$, il existe un $\delta > 0$ tel que
  \begin{equation}
