...
Nous notons \( e_k\) le \defe{vecteur d'erreur}{erreur} qui est défini par \( e_k=x-x_k\). Et le \defe{vecteur résidu}{résidu!méthode itérative} \( r_k=b-Ax_k\). Attention : ici \( k\) n'est pas un indice mais un numéro de vecteur.
