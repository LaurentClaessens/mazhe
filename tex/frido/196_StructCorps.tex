...
\begin{definition}
    Soit \( \eK\) un corps et \( \eL \) une exitension de \( \eK \). On dit que l'extension est \defe{algébriquement close}{algébriquement clos} si tout polynôme non-constant à coefficients dans \( \eK\) admet des racines dans \( \eL \).
\end{definition}
