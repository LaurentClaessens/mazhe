...
\begin{proof}
    ...
    Par hypothèse de récurrence, le polynôme \( Q\) est scindé : il existe \( \{ a_i \}_{i=1,\ldots, n-1}\) dans \( \eK\) tels que \( Q=\bigprod_{i=1}^{n-1}(X-a_i)\). Au final,
    \begin{equation}
        P=(X-a_n)Q=\bigprod_{k=1}^n(X-a_n)
    \end{equation}
    et \( P\) est scindé.
\end{proof}
