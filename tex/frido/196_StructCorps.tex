    ...
    \begin{subproof}
        ...
        \item[Si \( \eK\) est infini]
            ...
            \begin{equation}
                ...
                \end{aligned}
            \end{equation}
            mais cette fois nous devons nous battre avec la cardinalité de \( \eK\). Le lemme \ref{LEMooHWPHooZeWqns} nous assure que \( \eK[X]\approx \eK\) parce que \( \eK\) est infini.
    \end{subproof}
\end{proof}
<++>
