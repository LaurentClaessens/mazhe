...
\begin{proof}
    Nous considérons un ensemble \( \Omega\) qui contient \( \eK\), qui est strictement surpotent\footnote{Définition \ref{}.} à \( \eK\) et qui est infini non dénombrable si \( \eK\) est fini.
\end{proof}
<++>
