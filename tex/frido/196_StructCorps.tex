...
\begin{example}
    ...
    Notons que même si \( \eK\) est un corps, \( \eK[X]\) reste un anneau parce qu'un éventuel inverse de \( X\) n'est pas dedans. Par contre, \( \eK(X)\) est un corps parce qu'il contient également les fractions rationnelles.
\end{example}
...
\begin{proof}
    ...
    \begin{equation}\label{EqMultiExtensions55:915}
    ...
    \begin{equation}\label{EqMultiExtensions55:921}
...
On vient ainsi de montrer que tout élément \( x \in  \big( \eK(\alpha_1,\ldots, \alpha_n)_{\eL_n} \big)(\alpha_{n+1})\) était dans tout sous-corps de \( \eL_{n+1} \) qui contient \( \eK \) et les \( \alpha_i\)  (\( i=1,\ldots, n+1\)); en d'autres termes:
    ...
    \end{equation}
Ceci, avec \eqref{EqMultiExtensions55:921}, prouve l'égalité d'ensembles \eqref{EqMultiExtensions55:915} que l'on voulait montrer.
\end{proof}
