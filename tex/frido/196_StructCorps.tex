...
\begin{normaltext}      \label{NORMALooTPOIooVZAfUo}
    ...
    Nous discuterons brièvement le pourquoi de cela dans la section \ref{SUBSECooEDMJooTXBfOu} et surtout dans la question \ref{ITEMooUBZIooDDcfWg} dans la sections de questions difficiles d'algèbre.
\end{normaltext}
