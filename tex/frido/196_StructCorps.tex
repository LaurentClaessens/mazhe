...
\begin{normaltext}
    Nous insistons sur le fait que nous ne définissons le concept de corps de rupture que pour un polynôme irréductible. 
\end{normaltext}
...
\begin{normaltext}
    Une autre raison pour vouloir que \( P\) soit irréductible sera le lemme \ref{LEMooWYYFooXYacdF} qui dira que \( \eK[X]/(P)\) est un corps si et seulement si \( P\) est irréductible.
\end{normaltext}
