...
\begin{definition}[Extension algébrique, clôture algébrique]      \label{DEFooREUHooLVwRuw} \label{DEFooFXGUooQlnfwq}
...
\begin{lemma}       \label{LEMooRDIZooRjWNMa}
    Le corps \( \eC\) n'est pas une clôture algébrique\footnote{Clôture algébrique, définition \ref{DEFooFXGUooQlnfwq}.} de \( \eQ\).    
\end{lemma}
