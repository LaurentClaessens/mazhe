...
\begin{proposition}[Composition des degrés\cite{ooGIIFooVMVloY}]
...
\begin{proof}
    ...
    \end{equation}
    pour des éléments \( a_{\alpha}\in \eL_1\). Mais les \( v_i\) forment une \( \eK\)-base de \( \eL_1\), donc chacun des \( a_{\alpha}\) peut être décomposé comme \( a_{\alpha}=\sum_ia_\alpha_iv_iw_{\alpha}\). Donc :
    \begin{equation}
