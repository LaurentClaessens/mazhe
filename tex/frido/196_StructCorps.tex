...
\begin{lemma}[\cite{BIBooYYZPooMgFzkp}]     \label{LEMooIIKYooHMNqYn}
    Soit un corps \( \eK\). Nous considérons une extension \( \alpha\colon \eK\to \eL\) et une extension \( \beta\colon \eK\to \eF\) où
    \begin{enumerate}
        \item
            il existe \( a\in \eK\) tel que \( \eL=\eK(a)\) (cette extension est monogène),
        \item
            le corps \( \eF\) est algébriquement clos.
    \end{enumerate}
