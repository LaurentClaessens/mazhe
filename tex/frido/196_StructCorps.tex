...
%TODO: pourquoi le terme "sans faire appel à un corps ->ambiant<-  de K" ? Bonjour l'ambiance ?
...
%TODO je ne comprends pas "est inclue à L" ni ce qui est prouvé ci-dessous
...
\begin{proof}
    ...
    \begin{subproof}
        \item[\ref{ITEMooYTEBooUuEfBz} implique~\ref{ITEMooWMQTooLnepQl}]
            ...
            Les deux inclusions montrées prouve l'égalité.
...
\begin{proof}
    ...
    \begin{subequations}
        ...
        \end{align}
    \end{subequations}
    Même si \( Q(a), Q(b)\) sont calculés dans \( \eL\), \( I_a, I_b\) sont des idéaux de \( \eK[X]\). Le polynôme \( \mu_a\) est par définition le générateur unitaire de \( I_a\), et comme \( a\) est une racine de \( P\), nous avons \( P\in I_a\) et il existe un polynôme \( Q\in \eK[X]\) tel que
...
\begin{lemma}[\cite{BIBooYYZPooMgFzkp}]     \label{LEMooIIKYooHMNqYn}
    ...
    \end{enumerate}
%TODO j'ai un doute sur \sigma|_{\alpha(\eL)} : \eL ou \eK ?   c'est la restriction a K, non ?
...
\begin{proof}
    Comme \( \eL\) est monogène, si \( \mu_a\in \eK[X]\) est le polynôme minimal de \( a\in \eL\), alors les points \ref{ItemJCMooDgEHaji} et \ref{ItemJCMooDgEHajii} de la proposition \ref{PropURZooVtwNXE} disent que \( \eL\simeq \eK[a]\simeq \eK[X]/(\mu_a)\).
...
%TODO c'est lequel l'isomorphisme dont nous parlions plus haut ? Il y en a plein !
