...
% Copyright (c) 2011-2021, 2023-2024
%   Laurent Claessens
	...
	\begin{enumerate}
		...
		\item
		      ...
		      \begin{equation}
			      ...
			      \end{aligned}
		      \end{equation}
		      est analytique\quext{Je ne sais même pas comment on définit le mot «analytique» dans le cas d'une application entre espaces de Banach. Si vous le savez, écrivez-moi.}.
	\end{enumerate}
...
\begin{proof}
	...
	\begin{equation}
		f^{(n)}(x)=\begin{cases}
			\frac{ P_(x) }{ (x^2-1) }f(x) & \text{si } | x |<1 \\
			0                             & \text{sinon }
		\end{cases}
	\end{equation}
