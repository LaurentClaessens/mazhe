...
\begin{probleme}
	Les lemmes \ref{LEMooRRUMooRqDwYr} et théorèmes \ref{THOooZHXMooICpUZx} de ceux qui demanderaient une bonne relecture. Soyez \randomGender{attentif}{attentive} en lisant la preuve; il peut encore y avoir pas mal de pièges que je n'aurais pas vus. Si ça peut vous motiver à relire avec un œil critique, sachez que la preuve est entièrement due à chatGPT.
\end{probleme}
