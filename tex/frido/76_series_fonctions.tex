...
\begin{proposition}[Thème \ref{THEMEooPQKDooTAVKFH}\cite{ooETMNooSrtWet}]     \label{PROPooIUUWooQTRtkg}
...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[\ref{ITEMooEJSQooTqkBbo} implique \ref{ITEMooCGLSooZsMXSt}]
            ...
            La convergence d'une série implique que la norme du terme général converge vers zéro par la proposition \ref{propnseries_propdebase}\ref{point3-seriepropdebase}. Nous avons donc \( \| A^k \|\to 0\), ce qui signifie \( A^k\to 0\), et donc \( \rho(A)<1\) parce que \ref{ITEMooCGLSooZsMXSt} implique \ref{ITEMooYBGEooXAzVbD}.
