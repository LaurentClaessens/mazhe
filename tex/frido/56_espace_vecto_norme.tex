...
\begin{definition}[Norme opérateur\cite{ooTZRDooWmjBJi}] 
...
\item       \label{ITEMooPEQJooFYONJX}
    Une application linéaire \( E\to F\) est continue si et seulement si elle est bornée.
        ...
        \item\label{ITEMooHTVXooPNPQqN}
            La norme opérateur est une norme d'algèbre\footnote{Définition \ref{DefJWRWQue}.} sur \( \aL(E,F)\) :
    \begin{equation}
        \| AB \|\leq \| A \|\| B \|
    \end{equation}
