...
\begin{example}     \label{EXooFLBJooYfuRsG}
    Soient \( r\in \eR\) et la fonction donnée par
    \begin{equation}
        f(x)=(1+x)^r.
    \end{equation}
    ...
    En ce qui concerne les dérivées\footnote{Nous utilisons la proposition \ref{PROPooKUULooKSEULJ}.} : \( f'(x)=r(1+x)^{r-1}\) et plus généralement
    \begin{equation}
