...
\begin{proof}
	...
	Ensuite si \( e_n\) est de classe \( C^{\infty}\), alors \( e_{n+1}(x)=xe_n(x)\) est \( C^{\infty}\) parce qu'il s'agit du produit de \( e_n\) par \( x\mapsto 0\) et que le produit conserve le caractère \( C^{\infty}\) par la proposition \ref{PROPooJAUVooBhhDkD}.
\end{proof}
