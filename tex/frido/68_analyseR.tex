...
\begin{proof}
    ...
    \end{equation}
    pour tout \( s\in  B(a,\delta)\), et pour tous les \( j\) en même temps\footnote{Ce qui peut n'être pas possible en dimension infine. Je dis ça comme ça, juste pour faire remarquer que cette proposition n'est peut-être pas vraie en dimension infine.}.
