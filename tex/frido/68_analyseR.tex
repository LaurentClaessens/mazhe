...
\begin{proposition}[\cite{MonCerveau}]
    ...
    \begin{enumerate}
        ...
        \item
            ...
            \begin{equation}
                (d^nf)_a=\sum_{i_1,\ldots, i_n}\frac{ \partial^nf }{ \partial x_{i_1}\ldots \partial x_{i_n} }(a)\times_n\phi_n(\omega_{i_n,\ldots, i_1})
            \end{equation}
...
\begin{proof}
    ...
    \begin{equation}
        (d^kf)_a=\sum_{i_1,\ldots, i_k}(\partial_{i_1,\ldots, i_k}f)(a)\times_k\phi_k(\omega_{i_k,\ldots, i_1})
    \end{equation}
    est continuement différentiable par rapport à \( a\).
\end{proof}
<++>
