...
\begin{definition}[polynôme primitif au sens du pgcd]
    Soit un anneau factoriel\footnote{Définition \ref{refDEFooVCATooPJGWKq}.} \( A\). Un polynôme \( P\in A[X]\) est \defe{primitif au sens du pgcd}{primitif!polynôme!au sens du pgcd} si le pgcd de ses coefficients est inversible.
\end{definition}
...
\begin{proof}
    Un polynôme unitaire a un \( 1\) parmi ses coefficients, donc le pgcd est forcément \( 1\). En particulier inversible.
\end{proof}
