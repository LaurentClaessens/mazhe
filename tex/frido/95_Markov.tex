...
\begin{definition}      \label{DefGJEBooZvuIAV}
	Une matrice dont tous les éléments sont positifs ou nuls et dont la somme de toutes les lignes sont \( 1\) est une \defe{matrice stochastique}{matrice stochastique}.
\end{definition}
...
\begin{proposition} \label{PropMrkIrreLoishLCkpjkptXk}
	Soit \( (X_n)\) est une chaine de Markov irréductible. Nous notons \( T\) le temps de première atteinte\footnote{Définition \ref{}.} Alors
	\begin{enumerate}
		\item
