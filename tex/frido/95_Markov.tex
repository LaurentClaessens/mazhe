...
\begin{proof}
    Nous considérons la mesure de comptage sur \( E\) (définition \ref{DEFooILJRooByDzhs}). Cela nous permet d'écrire la somme comme une intégrale. Nous devons donc démontrer la convergence de
