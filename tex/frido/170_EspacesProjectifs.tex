...
\begin{lemma}[\cite{ooBVODooOTHLEk,ooSEHIooEkvXHJ}]
...
\begin{lemma}[\cite{ooIPNKooPIzpxy}]
    Soit \( a,b,c\in \eC\) colinéaires. Soit \( m\) un point hors de cette droite. Nous considérons une droite issue de \( c\) coupant \( [ma]\) en \( p\) et \( [mq] \) en \( b\).
