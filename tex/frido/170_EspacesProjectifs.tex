...
\begin{proof}
    ...
    Pour être certain de ne pas nous planter, nous allons faire ça en détail et séparer les cercles, les droites, ceux qui passent par \( z=0\) et les autres. Dans chacun des cas nous allons voir que l'image par une inversion est un cercle ou une droite.
