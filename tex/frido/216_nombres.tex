...
\begin{lemma}       \label{LEMooQAYSooCYJXkC}
	L'ensemble \( 2\eZ\) est un idéal\footnote{Idéa, définition \ref{}.} de \( \eZ\). On peut aussi le noter \( (2) \).
\end{lemma}
...
\begin{definition}      \label{DEFooMZRKooBPLAWH}
	Un idéal\footnote{Idéal, définition \ref{DefooQULAooREUIU}.} \( I\) dans \( A\) est \defe{principal à gauche}{idéal!principal!à gauche} si il existe \( a\in I\) tel que \( I= A a\). Il est \defe{principal à droite}{idéal!principal!à droite} si il existe \( a\in I\) tel que \( I=a A\). Nous disons qu'il est \defe{principal}{principal!idéal} si il est principal à gauche et à droite.
\end{definition}
