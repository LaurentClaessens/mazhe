...
\begin{proof}
	...
	\begin{subproof}
		...
		\end{equation}
		Vu que \( \gamma\) et \( g\) sont continues, l'application \( g\circ\gamma\) est continue\footnote{Par \ref{}.} et vérifie \( (g\circ \gamma)(0)=g(a)>0\), nous avons aussi\footnote{Corolaire \ref{CORooQXHDooWjSiKm} au théorème des valeurs intermédiaires.} \( (g\circ\gamma)(1)>0\), c'est à dire \( g(x)>0\).
