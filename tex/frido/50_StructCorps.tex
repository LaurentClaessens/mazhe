...
\begin{theorem}     \label{THOooQFWWooMWXEhT}
    Tout corps \( \eK\) possède une clôture algébrique\footnote{Définition \ref{DEFooFXGUooQlnfwq}.} \( \Omega\). De plus si \( \eL\) est une extension de \( \eK\), alors \( \eL\) est \( \eK\)-isomorphe à un sous corps de \( \Omega\).
\end{theorem}
...
\begin{example}     \label{ExfUqQXQ}
    ...
    Soit \( \bar\eF_p\) une clôture algébrique\footnote{Définition \ref{DEFooFXGUooQlnfwq}. Pour l'existence c'est le théorème \ref{THOooQFWWooMWXEhT}.} de \( \eF_p\) et \( \alpha\in \bar \eF_p\) tel que \( R(\alpha)=0\). Pour tout \( a\in \eF_p\), nous avons
    \begin{subequations}
        \begin{align}
