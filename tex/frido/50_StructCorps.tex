...
\begin{definition}
    Une extension \( \eL\) du corps \( \eK\) est une \defe{extension algébrique}{extension!algébrique} de \( \eK\) si tous les éléments de \( \eL\) sont des racines de polynômes à coefficients dans \( \eK\).
\end{definition}
...
Dans cette section nous abandonnons pour quelques minutes l'espace $\eR^m$ et considérons plus attentivement l'espace des fonctions polynomiales $\mathcal{P}_{\eR}$ et de ses sous-espaces $\mathcal{P}_{\eR}^k$, pour $k$ dans $\eN_0$. 
