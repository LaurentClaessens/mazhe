...
\begin{lemma}[Règle de Leibnitz\cite{BIBooCWTCooFdXIjl}]        \label{LEMooEFQQooTzDanH}
...
\begin{proof}
	...
	Supposons que \( I\neq \eK[X_1,\ldots, X_n]\) et que \( K\) est un idéal maximum contenant \( I\). Nous savons déjà par le théorème~\ref{ThowgZYqx} que \( K\) est de la forme \( K=(X_1-a_1,\ldots, X_n-a_n)\). Un élément de \( I\) est dans \( K\), donc si \( P\in I\) nous avons
	\begin{equation}
		P(a_1,\ldots, a_n)=0,
	\end{equation}
