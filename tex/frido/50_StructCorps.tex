...
\begin{proposition}[\cite{BIBooCWTCooFdXIjl}]       \label{PROPooPRGQooOkEmag}
    Soient un corps \( \eK\), un polynôme non constant \( P\in \eK[X]\) ainsi qu'une extension algébriquement close \( \Omega\) et un corps de décomposition \( \eM\) pour \( P\). Alors les propriétés suivantes sont équivalentes\footnote{Pour lee polynôme dérivé \( P'\), définition \ref{DEFooICHTooAggARW}.} :
    \begin{enumerate}
        \item
            \( \pgcd(P,P')=1\).
        \item
...
\begin{definition}[\cite{BIBooCWTCooFdXIjl,BIBooBXBQooNZljtJ}]      \label{DEFooLXSBooCHIUFU}
    Soient un corps \( \eK\) et un polynôme irréductible \( P\in \eK\). Nous disons que \( P\) est \defe{séparable}{polynôme séparable} si il existe une clôture algébrique de \( \eK\) dans laquelle les racines de \( P\) sont distinctes.
...
\begin{proposition}[\cite{BIBooCWTCooFdXIjl,BIBooIHHAooXltruA}]         \label{PROPooMOZFooDGemBJ}
    Soit un corps \( \eK\) et un polynôme irréductible \( P\in \eK[X]\). Les conditions suivantes sont équivalentes :
    \begin{enumerate}
        \item
            \( P\) est séparable\footnote{Polynôme séparable, définition \ref{DEFooLXSBooCHIUFU}.}
        \item
            \( P'\neq 0\)
        \item
