...
\begin{proposition}[Théorème des restes chinois version congruence\cite{BIBooSALPooIrQwPd}]	\label{PROPooKWZLooCHhSjs}
	Soit un anneau \( A\). Soient \( a_1,\ldots,a_n\in A\). Nous considérons l'ensemble
	\begin{equation}
...
\begin{theorem}[Théorème chinois]\index{théorème!chinois!anneau principal}        \label{ThofPXwiM}
	Si \( A\) est un anneau principal\footnote{Anneau principal, définition \ref{DEFooGWOZooXzUlhK}.} et si \( p\) et \( q\) sont premiers entre eux dans \( A\), alors on a l'isomorphisme d'anneaux
	\begin{equation}
