...
\begin{proposition}     \label{PROPooWHZKooEXEIrV}
    Soient deux espace de Hilbert séparables\footnote{Donc à base dénombrable, voir \ref{}} \( \hH_1\) et \( \hH_2\). Soit une base orthonormée \( \{ e_i \}_{i\in I}\) où \( I\) est dénombrable. Si \( \Phi\colon \hH_1\to \hH_2\) est une bijection linéaire continue, alors
    \begin{equation}
