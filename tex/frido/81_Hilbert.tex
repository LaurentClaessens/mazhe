...
\begin{theorem}[Lax-Milgram\cite{ooRIEKooXIQYhE}]       \label{THOooLLUXooHyqmVL}
    ...
    \begin{enumerate}
        ...
        \item
            Le problème qui consiste à chercher \( u\in V\) tel que \( a(u,v)=L(v)\) pour tout \( v\in V\) admet une unique solution. De plus cette solution vérifie l'inégalité\quext{Dans \cite{ooRIEKooXIQYhE}, la borne donnée est \( M\| L \|/\alpha\), mais je crois que c'est une faute de frappe de sa part.}
