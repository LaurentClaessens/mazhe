...
\begin{proposition}     \label{PROPooWHZKooEXEIrV}
    Soient deux espace de Hilbert séparables \( \hH_1\) et \( \hH_2\). Soit une base orthonormée \( \{ e_i \}_{i\in I}\). Si \( \Phi\colon \hH_1\to \hH_2\) est une bijection linéaire continue, alors
    \begin{equation}
