...
\begin{definition}[Partie absorbante\cite{BIBooTDEOooFNoMUV}]		\label{DEFooMNZJooSIAVGZ}
	Soit un espace vectoriel \( X\). Une partie \( U\) est \defe{absorbante}{partie absorbante} si pour tout \( x\in X\), il existe \( \rho_x>0\) tel que \( \lambda x\in U\) pour tout \( | \lambda |\leq \rho\).
\end{definition}
