...
\begin{proof}
	...
	\begin{description}
		...
		\item[équilibré] Par le lemme \ref{ITEMooLZZEooAqoQVO} parce que c'est un ouvert contenant \( 0\).
...
\begin{proposition}[\cite{MonCerveau}]	\label{PROPooHUWQooPWYBUu}
	Soit un espace vectoriel topologique\footnote{Définition \ref{DefEVTopologique}.} \( E\), ainsi qu'une application linéaire \( f\) sur \( E\). Si \( f\) est bornée sur un voisinage de \( 0\), alors elle est continue.
	%TODOooFZAJooBKaMlq. Prouver ça.
\end{proposition}
