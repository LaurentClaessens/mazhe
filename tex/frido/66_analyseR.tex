...
Si vous n'êtes pas convaincus que \( \mtu_0\) devrait avoir une limite nulle en zéro, essayez de vous convaincre que la fonction
\begin{equation}
    \begin{aligned}
    ...
    \end{aligned}
\end{equation}
devrait vérifier \( \lim_{x\to \infty} f(x)=\infty\). Là, tant que \( x\) s'approche de \( \infty\) sans l'atteindre, il n'y a vraiment que de la croissance à perte de vue; jusqu'à l'horizon et au-delà.
