...
\begin{theorem}[\cite{MonCerveau,BIBooKWZDooWnWJWO}]     \label{THOooKBTYooWFtoSF}
    ...
    \begin{enumerate}
        \item
            \( f\) est de classe \( C^1\) sur un voisinage de \( g(a)\)\quext{Je ne suis pas totalement certain qu'il soit nécessaire d'être \( C^1\) sur un voisinage. En tout cas, cela va suffire. Dite-moi si vous savez.},
        \item
