...
\ref{}
% Vérifier un peu à la main si la référence suivante n'est pas référencée vers le futur.
...
\ref{}
% Vérifier à la main si le label suivant n'est pas référentié vers le futur.
