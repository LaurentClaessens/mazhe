...
\begin{lemma}[Règle de Cauchy\cite{BIBooOMHDooUVsnpw,BIBooEQQXooVcApSf}]
...
\begin{proof}
    ...
    \item[Pour \ref{ITEMooZZBIooUYrtYL}]
        Soit \( \epsilon>0\) tel que \( p+\epsilon<1\). Le lemme \ref{LEMooHGJVooCbgOEK}\ref{ITEMooPMHUooIWcqFE} nous dit que l'ensemble
        \begin{equation}
