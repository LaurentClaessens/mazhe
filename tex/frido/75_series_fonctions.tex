...
\begin{propositionDef}[\cite{MonCerveau}]       \label{DEFooSFDUooMNsgZY}
    Soit \( (A,\| . \|)\) une algèbre\footnote{Définition \ref{DefAEbnJqI}.} munie d'une norme d'algèbre. Pour \( x\in A\) nous définissons
    \begin{equation}
    ...
    \begin{enumerate}
        \item
            C'est bien défini pour tout \( x\in A\).
        \item
        ...
        \item
            ...
            \begin{equation}
                (d\exp)_x(y)=\exp(x)y,
            \end{equation}
            le dernier produit étant la structure d'algèbre sur \( E\).
    \end{enumerate}
\end{propositionDef}
