...
% Copyright (c) 2008, 2009, 2011-2024
%   Laurent Claessens
...
%-------------------------------------------------------
\subsection{Série entières et polynômes}
%----------------------------------------------------
...
\begin{proof}
	...
	\begin{subproof}
		...
		\spitem[\( \Leftarrow\)]
		%-----------------------------------------------------------
		Nous supposons maintenant que \( | a_n |\leq q^n\) pour un certain \( q>0\). Nous savons que  si \( | z |<1/q\) la série \( \sum_nq^n| z^n |\) converge. Donc le lemme \ref{LemgHWyfG} dit que \( \sum_n| a_n || z |^n\) converge.
	\end{subproof}
\end{proof}
