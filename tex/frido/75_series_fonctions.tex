...
\begin{proof}
    ...
    Soient \( a,x\in \Omega\). Nous considérerions bien le segment \( \mathopen[ a , x \mathclose]\), mais vu que \( \Omega\) n'est supposé que connexe par arc, nous ne pouvons pas faire mieux pour joindre \( a\) à \( x\) que choisir un chemin
    et \( \gamma\colon \mathopen[ 0 , 1 \mathclose]\to \Omega\) un chemin joignant \( a\) à \( x\).  
