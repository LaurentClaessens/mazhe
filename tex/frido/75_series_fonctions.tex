...
\begin{lemma}[\cite{MonCerveau}]
    ...
    \begin{equation}
        df_x(y)=g(x)y
    \end{equation}
    pour une certains fonction \( g\colon E\to E\) différentiable.

    Alors \( f\) est \( C^1\), et deux fois différentiable telle que
    \begin{equation}
        \begin{aligned}
            d^2f\colon E&\to \aL\big( E,\aL(E,V) \big) \\
            (d^2f)_x(u)\alpha&=(dg_x)(u)\alpha 
        \end{aligned}
    \end{equation}
    pour tout \( x,u\in E\) et \( \alpha\in\aL(E,V)\).
\end{lemma}
...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[\( f\) est deux fois différentiable]
            ...
            \begin{equation}
                T_x(u)\alpha=(df_x)(u)\alpha.
            \end{equation}
            Nous devons vérifier la limite suivante :
            \begin{equation}
                \lim_{h\stackrel{E}{\longrightarrow} 0} \frac{ df_{x+h}-df_x-T_x(h) }{ \| h \| }=0.
            \end{equation}
            En appliquant à \( y\in E\) nous avons :
            \begin{equation}
                df_{x+h}(y)-df_x(y)-dg_x(h)y=g(x+h)y-g(x)y-dg_x(h)y.
            \end{equation}
            Donc
            \begin{subequations}
                \begin{align}
                    \frac{ \| df_{x+h}-df_x-T_x(h) \| }{ \| h \| }&=\sup_{\| y \|=1}\frac{ \| g(x+h)y-g(x)y-dg_x(h)y \| }{ \| y \|\|h \| }\\
                    &\leq\frac{ \| g(x+h)-g(x)-dg_x(h) \|\| y \| }{ \| y \|\| h \| }\\
                    &=\frac{ \| g(x+h)-g(x)-dg_x(h) \| }{ \| h \| }.
                \end{align}
            \end{subequations}
            La limite \( h\to 0\) de la dernière expression est zéro par définition de la différentielle de \( g\).
    \end{subproof}
