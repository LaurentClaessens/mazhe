...
\begin{example}
        ...
        \begin{probleme}
            Cet exemple doit être lu attentivement. Il me semble prouver que le flot n'est pas dérivable en la condition initiale sans que \( f\) le soit.
        \end{probleme}

    Il n'y a pas de raisons de penser que \( y_a\) soit mieux que continue en \( a\) sans hypothèses supplémentaires sur \( f\). Pour illustrer cela nous considérons l'équation différentielle
    \begin{subequations}
        \begin{numcases}{}
    ...
    \end{equation}
    Les deux limites n'étant pas égales, la limite \eqref{EQooTQXQooAtRxNT} n'existe pas\footnote{Si vous comptez donner ça à manger à un jury d'un concours, soyez prudent et n'écrivez pas l'équation \ref{EQooTQXQooAtRxNT} au tableau. Réfléchissez comment rédiger cela correctement.}.
\end{example}
<++>
