...
\begin{proof}
	...
	\begin{subproof}
		...
		\spitem[Unicité]
		On prouve qu'à chaque solution de \eqref{SUBEQooXMYMooKfpqQW} correspond une solution de \eqref{SUBEQSooIBTNooHzYImh}, et l'unicité de la solution \( x\) donne l'unicité du côté de \( y\).
	\end{subproof}
\end{proof}
...
\begin{proposition}		\label{PROPooKPCQooQNMLQL}
	...
	%TODOooRKROooAlsUEu. Prouver ça.
	% et quand c'est fait, supprimer le problème ci-dessus.
\end{proposition}
