...
\begin{propositionDef}[\cite{BIBooFFDKooOsRapH}]	\label{PROPooZRQTooOtqjLn}
	...
	\begin{equation}
		\tau_X=\{ U\subset X\tq\forall i\in I, f_i^{-1}(U)\in\tau_i \}.
	\end{equation}
	Alors
	\begin{enumerate}
		\item
		      \( \tau_X\) est une topologie sur \( X\).
		\item
		      \( \tau_X\) est la plus fine topologie sur \( X\) pour lesquelles toutes les applications \( f_i\) sont continues.
	\end{enumerate}
