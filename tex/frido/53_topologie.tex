...
\begin{definition}[Isomorphisme d'espaces topologiques]      \label{DEFooYPGQooMAObTO}
	Un \defe{isomorphisme}{isomorphisme d'espace topologique} d'espaces topoloqiues est une application bijective continue\footnote{Application continue, définition \ref{DefOLNtrxB}.} entre deux espaces topologiques dont la réciproque est continue.
