...
\begin{propositionDef}[\cite{BIBooTAMKooWwOwAL}]\label{DefTopologieEngendree}
    ...
    \begin{enumerate}
        ...
        \item 
            ...
            \end{equation}
    \end{enumerate}
    Alors \( \tau(\mT_0) \) est une topologie sur \(X\), qu'on appelle \defe{topologie engendrée}{topologie!engendrée par une famille} par \( \mT_0 \).
\end{propositionDef}
