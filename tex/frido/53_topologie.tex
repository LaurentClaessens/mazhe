...
\begin{definition}      \label{DEFooBODRooEFhzeT}
	Une partie d'un espace topologique est \defe{relativement compact}{relativement compact} si son adhérence\footnote{Pour rappel, «adhérence» et «fermeture» sont synonymes.} est compacte.
\end{definition}
