...
\begin{proposition}     \label{PROPooZXTXooEMLgMn}
	À propos de base de topologie.
	\begin{enumerate}
		\item		\label{ITEMooQSWJooKvXnoV}
...
\begin{proof}
	En deux parties.
	\begin{subproof}
		\spitem[Pour \ref{ITEMooQSWJooKvXnoV}]
		%-----------------------------------------------------------
		%TODOooEGFJooPRlYlE. Prouver ça. C'est à dire cette partie, parce que l'autre est déjà prouvée je crois.

		\spitem[Pour \ref{ITEMooYTZDooMrvEIe}]
		%-----------------------------------------------------------
		Nous venons de prouver que les boules ouvertes forment une base de topologie. La proposition \ref{PROPooUQLUooDQfYLT} dit que ces boules sont convexes.
	\end{subproof}
\end{proof}
