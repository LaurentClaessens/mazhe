...
Nous avons vu que si une fonction est continue, elle fait passer la limite aux suites. Dans le cas des espaces métriques, la proposition \ref{PropXIAQSXr} montrera la réciproque : si pour toute suite \(x_n\to a\), nous avons \( \lim_{n\to \infty} f(x_n)=y\), alors \( f\) a une limite e \( a\) qui vaut \( y\).
