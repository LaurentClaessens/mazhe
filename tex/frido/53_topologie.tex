...
\begin{example}  \label{ExKYZwYxn}
    Quid de la boule ouverte \( B(1,\epsilon)\) dans le compact\footnote{Lemme \ref{LEMooNNHYooITNbyz}.} \( \mathopen[ 0 , 1 \mathclose]\) ? Par définition c'est
    \begin{equation}
...
\begin{lemma}       \label{LEMooNNHYooITNbyz}
    Si \( a,b\in \eR\), alors la partie \( \mathopen[ a , b \mathclose]\) est compacte dans \( \eR\).
\end{lemma}
...
\end{equation}
            ...
            \end{equation}
            qui est compact en tant qu'union finie de compacts\footnote{Proposition \ref{}.}.
            ...
            \end{equation}
            Vu que \( X\setminus C_i\) est compact, il est fermé\footnote{Par \ref{}.}. La partie \( X\setminus E\) est donc fermée comme union de fermés\footnote{Par \ref{}.}. Et donc \( E\) est ouvert. Et finalement
            \begin{equation}
...
\begin{definition}[Isomorphisme d'espaces topologiques]      \label{DEFooYPGQooMAObTO}
    Un \defe{isomorphisme}{isomorphisme d'espace topologique} d'espaces topoloqiues est une application bijective continue entre deux espaces topologiques dont la réciproque est continue. 
