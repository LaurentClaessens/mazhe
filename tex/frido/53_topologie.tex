...
\begin{proof}
	...
	\begin{subproof}
		...
		\end{equation}
		Soit un ouvert \( \mO\) de \( X\) autour de \( (x_1,\ldots, x_n)\). Nous considérons des ouverts \( U_i\) de \( X_i\) tels que \( x_i\in U_i\) et \( U_1\times\cdots\times U_n\subset\mO\).
		...
		\begin{equation}
			\big( (x_1)_k,\ldots,(x_n)_k \big)\in U_1\times\cdots\times U_n\subset \mO.
		\end{equation}
	\end{subproof}
\end{proof}
