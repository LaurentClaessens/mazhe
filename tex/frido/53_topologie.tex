...
%--------------------------------------------------------------------------------------------------------------------------- 
\subsection{Espace topologique normal et complètement normal}
%---------------------------------------------------------------------------------------------------------------------------
...
\begin{lemma}[\cite{MonCerveau}]		\label{LEMooKXHQooAyVQsT}
	...
	%TODOooPMQGooJIDjar. Prouver ça, mais en fait non parce que :
	%TODOooSRAFooVCjJiR. Ce lemme ne devrait plus exister parce que c'est la définition.
\end{lemma}
