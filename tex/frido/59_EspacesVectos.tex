...
\begin{proposition}[Caractérisation de la limite]\label{PropHOCWooSzrMjl}
    ...
    La fonction \( f\) admet une limite en $a\in E$ si et seulement si il existe un élément $\ell\in F$ tel que pour tout $\varepsilon>0$, il existe un $\delta>0$ tel que pour tout $x\in \Domaine(f)$,
