...
\begin{proof}
	...
	\begin{subproof}
		...
		\begin{equation}
			...
			\end{aligned}
		\end{equation}
		C'est une topologie séparée\quext{Je n'utilise pas le fait que ce soit séparé dans la suite alors que \cite{BIBooOGSYooGDuyMJ} insiste dessus. À mon avis c'est parce que le corollaire \ref{CORooSSFFooNkNmlS} est souvent énoncé pour des espaces séparés. Peut-être parce que les Français disent que les compacts doivent être séparés. Dans le Frido, un compact doit seulement vérifier la propriété de sous-recouvrement fini. On peut être compact sans être séparé. Si vous avez une idée sur l'endroit où la séparation de \( \Fun(E,\eK)\) joue dans le preuve, écrivez-moi.} par la proposition \ref{PROPooSEQRooZoQPbZ}. Nous la nommons \( \tau_F\)
