...
\begin{proposition}[\cite{BIBooFDGQooYferue}]     \label{PROPooFJBBooKkRwIp}
...
\begin{proof}
    ...
    \begin{subproof}
        ...
        Vu que \( \varphi(x_n)\stackrel{\eF}{\longrightarrow}\varphi(x)\), l'ensemble \( \{ \varphi(x_n) \}\) est borné dans \( \eF\).
