...
\begin{proposition}[Analytique et Lipschitz\cite{MonCerveau,BIBooMistral}]	\label{PROPooSLVEooFeDlcO}
	Soit un ouvert \( U\) de \( \eR^n\) et une fonction \(f \colon \eR^n\to \eR^n  \) analytique sur \( \bar U\). Alors pour tout compact \( K\) de \( U\), il existe un réel \( L_K>0\) tel que
	\begin{equation}
		\| f(a)-f(b) \|\leq L_K\| a-b \|
	\end{equation}
	pour tout \( a,b\in K\).
...
\begin{theorem}[Cauchy-Lipschitz réel analytique\cite{BIBChatGPTDifficile}]	\label{THOooHDHCooLMkfaB}
	Nous posons \( \Lambda=\eR^m\) et nous considérons un ouvert \( U\) de \( \eR^n\), un ouvert \( \Gamma\) de \( \Lambda\) ainsi qu'une fonction \(f \colon \eR\times \eR^n \times \Gamma\to \eR^n \)  analytique sur \( \overline{\eR\times U\times \Gamma}\).
