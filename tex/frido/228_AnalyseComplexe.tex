...
\begin{definition}[BIBooXNQTooNgvlKd]
...
\begin{theorem}[\cite{BIBooKWIMooEYRhWj}]     \label{THOooXWCSooLSPzhO}
	Une fonction analytique admet un inverse local analytique.
	%TODOooWEFEooBoChnA quand la démonstration est faite, donner un lien sur https://math.stackexchange.com/questions/4345396/local-inverse-of-analytic-function
\end{theorem}
