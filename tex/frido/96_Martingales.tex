...
\begin{definition}[\cite{BIBooYWQKooSdwvTG}]	\label{DEFooIUOXooPfASWz}
...
\begin{theorem}[Premier théorème d'arrêt de Doob\cite{FUFFxBX,BIBooREGHooJpXSyS}] \label{ThoZTrdjtZ}
