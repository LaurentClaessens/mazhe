...
\begin{proof}
	...
	\begin{subproof}
		...
		% -------------------------------------------------------------------------------------------- 
		Nous allons prouver l'énoncé suivant. Soit \( k=0,\ldots, l\), soit une application continue \( h\colon K\to \eC^*\) admettant un prolongement continu \( F\colon A\cup(Q_1\cup\cdots\cup Q_k)\to \eC^*\). Alors il existe \( m\in \eN\) tel que l'application \( h/f_{q_{k+1}}^m\) admette un prolongement continu \( \tilde F\colon A\cup(Q_1\cup\cdots\cup Q_{k+1})\to \eC^*\).
		...
		% -------------------------------------------------------------------------------------------- 
		Soit \( h\colon K\to \eC^*\) continue et admettant un prolongement continu \( F\colon A\cup(Q_1\cup\cdots\cup Q_k)\to \eC^*\). Notons \( B_k=A\cup(Q_1\cup\cdots\cup Q_k)\) et posons
		\begin{equation}
			\begin{aligned}
		...
		\begin{equation}        \label{EQooSPSQooVErzCI}
			Q_{k+1}\cap B_k=(Q_{k+1}\cap A)\cup(Q_{k+1}\cap Q_1)\cup\cdots\cup(Q_{k+1}\cap Q_k).
		\end{equation}
