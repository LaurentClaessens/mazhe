...
\begin{proof}
	...
	\begin{subproof}
		...
		\end{equation}
		\spitem[Une propriété à prouver]
		% -------------------------------------------------------------------------------------------- 
		...
		L'application \( \xi\in\mE(\partial Q_{k+1}) \) admet un logarithme continu et admet donc une extension continue \( \eC\to \eC^*\) (théorème de Borsuk \ref{THOooTCUMooEByCKg}). Nous considérons cette extension seulement sur \( Q_{k+1}\) et nous l'appelons \(G_{k+1} \colon Q_{k+1}\to \eC^*  \). Nous posons
		\begin{equation}
			\begin{aligned}
				F_{k+1}\colon A\cup(Q_1\cup\ldots \cup Q_{k+1}) & \to \eC^*                                                                                                          \\
				z                                               & \mapsto\begin{cases}
					                                                         G_{k+1}(z)                           & \text{si } z\in Q_{k+1}                       \\
					                                                         \frac{F_k(z)}{(z-q_{k+1})^{m_{k+1}}} & \text{si } z\in A\cup(Q_1\cup\ldots\cup Q_k).
				                                                         \end{cases}
			\end{aligned}
		\end{equation}
		kmlklm
