...
\begin{proof}
	...
	\begin{subproof}
		...
		\end{equation}
		Cela prouve que \( | X |^r\in L^1(\Omega)\), c'est à dire que \( X\in L^r(\Omega)\). Voila une bonne chose de faite. Nous devons encore prouver que \( X_n\stackrel{ L^r(\Omega)}{\longrightarrow} X\).

		C'est probablement le moment d'utiliser la proposition \ref{PROPooPZRAooSiqgKT}.
