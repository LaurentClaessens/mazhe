...
\begin{proposition}[\cite{MonCerveau}]      \label{PROPooTFOAooJBwmCV}
...
\begin{proposition}[Produit d'une mesure par une fonction]      \label{PROPooFEVQooUNYvIh}
...
\begin{definition}
    ...
    Si la mesure \( \mu\) admet une densité, nous disons que c'est une mesure à densité par rapport à la mesure de Lebesgue.
\end{definition}
