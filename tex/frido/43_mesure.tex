...
\begin{lemma}[\cite{BIBooQMABooVJScYf}]
...
\begin{theorem}[Radon-Nikodym\cite{BIBooQMABooVJScYf}]
	...
	\begin{enumerate}
		\item
		      ...
		      \end{subequations}
		\item
		      Il existe une unique fonction mesurable et intégrable \(f \colon \Omega\to \eR\cup\{ +\infty \}  \) telle que
		      \begin{equation}
			      \nu(A)=\int_Afd\mu
		      \end{equation}
		      pour tout \( A\in\tribA\).
