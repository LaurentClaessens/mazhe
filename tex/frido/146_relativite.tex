...
% Copyright (c) 2006-2013,2015, 2018, 2023
...
La distance parcourue \( x(t)\) en un temps \( t\) est la primitive de la vitesse. Nous savons, par ailleurs, que la primitive est liée à la surface\foonote{L'intégrale d'une fonction entre deux valeurs de \( t\) donne l'aire sous la courbe.} sous la courbe. Pour reprendre les mêmes notations, nous notons \( S_v(t)\) la surface contenue en dessous de la fonction \( v\) entre \( 0\) et \( x\). Nous ne serions donc pas étonné que
