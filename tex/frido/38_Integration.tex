...
\begin{proof}
	...
	\begin{subproof}
		...
		\spitem[Encore un peu de division]
		...
		\spitem[Une histoire de résultant]
...
En physique, la circulation de la force le long d'un chemin est le travail de la force.
