...
Quand les choses sont faciles, ça se passe bien. La proposition suivante dit qu'une fonction continue sur un compact y est intégrable; sauf que pour dire cela de façon précise, il faut un peu bosser parce qu'il y a de écueils tels que l'exemple \ref{EXooKQDRooVMWaEC} à éviter.
