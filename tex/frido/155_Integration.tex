...
% Copyright (c) 2011-2018, 2021-2023
%   Laurent Claessens
...
\begin{theorem}[Formule de la divergence]
	...
	\begin{equation}
		\partial D = A_1 \cup \cdots \cup A_p \cup N
	\end{equation}
	où
	\begin{enumerate}
	...
	\end{enumerate}
	Supposons également qu'en chaque point de \( A_1 \cup \cdots \cup A_p\) il existe un vecteur normal extérieur \( \nu\).
