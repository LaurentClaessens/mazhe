...
\item
    Le chemin \( \gamma\colon \mathopen[ a , b \mathclose]\to X\) est de \defe{Jordan}{chemin de Jordan} si elle est injective et \( \gamma(a)=\gamma(b)\).
    \end{enumerate}
\end{definition}
%TODOooPDETooEUkJYW : fusioner avec DEFooCJCWooLNrHFd et DEFooBYRDooTBgsui.
