...
\begin{proposition}[Décomposition de Hahn\cite{BIBooQMABooVJScYf}]		\label{PROPooIBLHooTMfEJW}
...
\begin{proposition}[Décomposition de Jordan\cite{BIBooQMABooVJScYf}]
	Si
\end{proposition}
\index{décomposition de Jordon}
