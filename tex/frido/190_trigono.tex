...
\begin{proof}
	...
	\begin{subproof}
		...
		Nous considérons une base \( f\)-orthogonale de \( x^{\perp}\) (proposition \ref{PROPooRERSooFHwWtB}). Les vecteurs de cette base ne sont pas isotropes. Soient \( y\) et \( z\) les vecteurs de cette base. Il nous reste à prouver que les plans \( P=\Spab\{ x,y \}\) et \( Q=\Span\{ x,z \}\) font l'affaire.
