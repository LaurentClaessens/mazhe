...
Soit une fonction \( f\) sur \( \eR^n\), dont nous ne précisons pas la régularité. Sa \defe{transformée de fourier}{transformée!de Fourier} est la fonction \( \hat f\) définie par
\begin{equation}
        \hat f(\xi)=\int_{\eR^n} e^{-i\xi\cdot x}f(x)dx  
\end{equation}
si elle existe.
