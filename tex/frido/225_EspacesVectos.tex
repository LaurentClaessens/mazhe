...
\begin{proposition}[\cite{MonCerveau}] \label{PROPooPMYCooAAtHsB}
	Si \( A\in \eM(n,\eK)\) est telle que \( \det(A)=0\), alors il existe des matrices de manipulation de lignes et de colonnes\footnote{Les opérations élémentaires sur les lignes sont résumées en \ref{NORMooDXYZooEdnztA}.} \( G_1,\ldots, G_p\) et \( H_1,\ldots,H_q\) telles que \( G_1\ldots G_N\,A\, H_1\ldots H_q\) ait une colonne de zéros.
\end{proposition}
