...
\begin{definition}      \label{DEFooJUUIooNMdCtN}
    ...
    \begin{equation}
        c_n(t)=\frac{1}{ T }\int_0^Tf(t) e^{-2 i \pi n t/T}dt.
    \end{equation}
\end{definition}
...
\begin{normaltext}      \label{NORMooGKKWooFmOBeE}
    La proposition \ref{PropREkHdol} ne contredit pas Fejèr \ref{ThoJFqczow}\ref{ItemUNQSPmyiv}. Alors là c'est subtil, alors soyez bien \randomGender{attentif}{attentive}.
