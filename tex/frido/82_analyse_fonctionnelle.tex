...
\begin{theorem}[Théorème d'Ascoli\cite{LBLADXV}]        \label{ThoKRbtpah}
	Soient un espace topologique compact \( K\) et un espace métrique \( (E,d)\). Nous considérons la topologie de la distance uniforme\footnote{Définition \ref{}.} sur \( C^0(K,E)\). Une partie \( A\) de \( C^0(K,E)\) est relativement compacte\footnote{Sa fermeture est compacte, définition \ref{DEFooBODRooEFhzeT}.} si et seulement si les deux conditions suivantes sont remplies :
	\begin{enumerate}
		\item
