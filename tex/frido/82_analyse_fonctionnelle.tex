...
\begin{normaltext}
    ...
    \begin{itemize}
        ...
        \item Dans le cas des espaces de Lebesgue \( L^p(\Omega,\tribA,\mu)\), il s'agit d'un quotient de \( \mL^p\) qui ne contient que des fonctions mesurables. Donc dans l'étude de \( L^p\), tous les représentants sont mesurables. Et ce, même si \( (\Omega,\tribA,\mu)\) n'est pas complet.
    \end{itemize}
\end{normaltext}
