...
\begin{proof}
	...
	\begin{subproof}
		...
		\begin{subproof}
            ...
            Soient \( (B_n)\) une suite d'éléments de \( \tribF\) et \( \epsilon>0\). Pour chaque \( n\), \ref{} nous permet de choisir un ouvert \( \Omega_n\) et un fermé \( F_n\) tels que \( F_n\subset  B_n\subset \Omega_n\) et
			\begin{equation}
