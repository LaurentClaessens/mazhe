...
\begin{proposition}[Dérivée et croissance]      \label{PROPooKZPZooWjIsWg}
    ...
    \begin{enumerate}
        \item
            strictement croissante sur \( I\) si et seulement si \( f'>0\) sur \( I\),
        \item
            croissante sur \( I\) si et seulement si \( f'\geq 0\) sur \( I\).
        \item
            strictement décroissante sur \( I\) si et seulement si \( f'<0\) sur \( I\),
        \item
            décroissante sur \( I\) si et seulement si \( f'\leq 0\) sur \( I\).
    \end{enumerate}
\end{proposition}
...
\begin{proposition}[\cite{BIBooWTHJooTyNuub}]      \label{PROPooSGTBooFxUuXK}
	...
	\begin{enumerate}
        \item       \label{ITEMooFXHYooRNHYPI}
		      la fonction \( f\) est une injective de \( I\) vers \( J\),
          \item     \label{ITEMooZFHZooInUixo}
              la fonction \( f'\) ne s'annule pas sur \( I\),
...
\begin{proof}
    La clef du tout est la proposition \ref{PROPooKZPZooWjIsWg}. Nous supposons que \( f\) est strictement croissante sur \( I\). Les adaptations à faire en cas de fonction strictement décroissante sont laissées \randomGender{au lecteur}{à la lectrice}. En plusieurs points.
    \begin{subproof}
        \spitem[Pour \ref{ITEMooFXHYooRNHYPI}]
        % -------------------------------------------------------------------------------------------- 
        Une fonction strictement croissante est injective.
        \spitem[Pour \ref{ITEMooZFHZooInUixo}]
        % -------------------------------------------------------------------------------------------- 
        Proposition \ref{PROPooKZPZooWjIsWg}.
