...
\begin{proposition}[\cite{ooRCDWooONrayj,ooVNAOooAuQSse,ooOGGJooCGQgDO}]        \label{PROPooOUZOooEcYKxn}
	...
	\begin{enumerate}
		...
		\item       \label{ITEMooMQERooBCqnvS}
		      ...
		      \end{equation}
		      Cette formule est appelée \defe{règle de Leibnitz}{Leibnitz}\footnote{Pour des formes plus générales, voir la proposition \ref{PROPooTEACooKXUXKl} et le lemme \ref{LEMooOLQTooEHJuBc}.}.
