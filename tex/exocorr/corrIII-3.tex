...
\end{equation}
Cela ressemble à une fonction à deux variables ($R$ et $h$), mais ce n'en est pas une. En effet, dès que $R$ est choisi, $h$ est automatiquement choisi à cause de la contrainte $V=\pi R^2h$. Nous pouvons donc remplacer $h$ par $V/\pi R^2$ dans la fonction $S(R,h)$, et nous trouvons la surface en fonction de $R$ tout seul :
\begin{equation}
