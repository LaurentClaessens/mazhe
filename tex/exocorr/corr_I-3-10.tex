...
\end{equation}
et nous utilisons le critère des fonctions tests, corolaire \ref{CorCritFonsTest}. Dès que $\alpha\leq 1-x$, nous avons $L=\infty$. Donc si $x\leq0$, nous prenons $\alpha=1$ et nous concluons à ce que $I_n(x)$ n'existe pas. Si, par contre, $\alpha+x-1>0$, alors $L=0$. Donc dès que $x>0$, nous pouvons trouver un $\alpha<1$ tel que $\alpha+x-1>0$, et donc $I_n(x)$ existe quand $x>0$.
