...
\input{pictures_tex/Fig_CbCartTui.pstricks}
...
\input{pictures_tex/Fig_CbCartTuii.pstricks}
  ...
  \item\label{Itemzzdexoiii}
    ...
    \input{pictures_tex/Fig_ExoParamCD.pstricks}
...
\input{pictures_tex/Fig_CbCartTuiii.pstricks}
...
%\input{pictures_tex/Fig_SubfiguresCDUTraceCDun.pstricks}
...
%\input{pictures_tex/Fig_SubfiguresCDUTraceCDdeux.pstricks}
