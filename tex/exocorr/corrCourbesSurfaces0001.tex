\begin{corrige}{CourbesSurfaces0001}
	...
	\begin{enumerate}
		...
		\item
			Les deux graphes sont évidemment les mêmes parce que les valeurs de $t$ entre $2\pi$ et $6\pi$ ne créent aucun nouveau points (périodicité de sinus et cosinus). En ce qui concerne l'équivalence des deux courbes, nous devons avoir une application $\theta\colon [0,6\pi]\to [0,2\pi]$ telle que
			\begin{equation}
