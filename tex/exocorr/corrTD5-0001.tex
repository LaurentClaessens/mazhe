...
% Copyright (c) 2010,2015,2017, 2019
...
\begin{corrige}{TD5-0001}
	...
	\begin{enumerate}
		...
		\item
			...
			\end{equation}
            À moins que vous sachiez comment définir le logarithme d'un nombre négatif, ce calcul n'a pas de sens.
		...
		\item
			Lorsque le numérateur et le dénominateur sont des polynômes du même degré, il faut faire apparaitre le dénominateur au numérateur en ajoutant et en enlevant ce qu'il faut. Dans notre cas, nous avons 
			\begin{equation}
