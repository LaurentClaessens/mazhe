...
x |--> 3/4
		...
		\item
			...
			\end{equation}
            dont nous devons prendre la limite lorsque $t\to \infty$. Cela est une des limites remarquables, qui vaut zéro\footnote{Le logarithme tend plus vite vers \( \infty\) que les puissances.}.
