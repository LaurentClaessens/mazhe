...
%\input{auto/pictures_tex/Fig_exouuiv.pstricks}
...
%\newcommand{\CaptionFigexouuivbis}{La limite de la suite de fonctions de l'exercice \ref{corr114}.}
%\input{auto/pictures_tex/Fig_exouuivbis.pstricks}
