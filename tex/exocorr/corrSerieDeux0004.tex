...
\begin{corrige}{SerieDeux0004}
	...
	\begin{enumerate}
		...
		\item\label{ItemCDeuxquatre}
			...
			Que se passe-t-il lorsque l'on met maintenant l'application $\alpha$ ? Il n'est évidemment plus du tout garanti que $\alpha(x)$ sera parallèle à $w$ lorsque $x$ est parallèle à $w$. Nous pouvons par contre écrire ceci :
			\begin{equation}
