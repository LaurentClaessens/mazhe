\begin{corrige}{GeomAnal-0044}
    ...
    \begin{enumerate}
        ...
        \item
            Si \( \lambda\) est une valeur propre de \( A\), alors la matrice \( A-\lambda\mtu\) n'est pas inversible. Évidemment si \( \lambda=0\) nous avons \( \lambda<\| A \|\). Nous supposons que \( \lambda\neq 0\). La matrice
            \begin{equation}
                \mtu-\frac{ A }{ \lambda }
            \end{equation}
