...
%\input{auto/pictures_tex/Fig_CercleRacine.pstricks}
...
L'intégrale $S_1$ est plus problématique. Il faut faire apparaitre quelque chose de la forme $u^2+B$. Cherchons donc $A$ et $B$ tels que
\begin{equation}
	4x-x^2=-(x+A)^2+B.
\end{equation}
