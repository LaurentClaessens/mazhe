...
Remarquons que cette série est en réalité la série géométrique de raison $z$, dont on connaît la somme explicitement depuis la proposition \ref{PROPooWOWQooWbzukS}.
...
\end{equation}
ne nous ragoute pas trop. Nous utilisons donc plutôt la formule alternative \eqref{EqAlphaSerPuissAtern} :
\begin{equation}
