...
Représentez dans le plan les sous-ensembles de $\eR^2$ suivants et déterminez leur intérieur, leur adhérence et leur frontière (précisez si l'ensemble est ouvert, fermé, borné, compact ou\footnote{ce « ou » n'est évidemment pas exclusif.} connexe par arcs).
\begin{enumerate}
