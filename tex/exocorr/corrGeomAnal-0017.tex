\begin{corrige}{GeomAnal-0017}
    ...
    \begin{enumerate}
        \item
            ...
            \end{equation}
            où \( a(y)\) est une fonction seulement de \( y\). Aucune fonction de ce type n'a \( 4\sin(x,y)\) comme dérivée par rapport à \( y\). En effet, la dérivée de \eqref{EqGAzzusui} par rapport à \( y\) est
