...
\begin{equation}
	...
	\end{aligned}
\end{equation}
La première classe contient toutes les permutations qui envoient $1$ sur $2$, le second toutes les permutations qui envoient $1$ sur $2$, etc. Nous avons «évidemment» l'union disjointe
\begin{equation}
