\begin{corrige}{DS2011-0004}
    ...
    \begin{enumerate}
        ...
        \item
            Lorsque vous utilisez la fonction inverse d'une fonction non injective (par exemple cosinus), vous \emph{devez} préciser les domaines ! Dans le cas présent, vous devez considérer la fonction
            \begin{equation}
