...
\begin{corrige}{SerieCinq0005}
	...
	Étant donné que le méthode de Gauss ne change pas le rang d'une matrice (mais elle change ses valeurs propres !), la nouvelle matrice ne peut pas avoir de valeurs propres nulles, et donc rentre dans les hypothèses qui font en sorte que tous ses éléments diagonaux sont non nuls.
