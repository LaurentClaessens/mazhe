...
\begin{corrige}{OutilsMath-0012}
	...
	\input{auto/pictures_tex/Fig_ExoPolaire.pstricks}
	...
	\begin{equation}
		\sin(\theta)=\frac{ 1 }{ 2 }.
	\end{equation}
	Cela nous permet de savoir que $\frac{ \pi }{ 6 }$ ou bien $\frac{ \pi }{ 6 }+\pi$. Nous choisissons $\frac{ \pi }{ 6 }$ parce que l'angle $\frac{ \pi }{ 6 }+\pi$ donnerait des coordonnées négatives.
