...
\begin{corrige}{TD4-0001}
	...
	\begin{enumerate}
		\item
			...
			La fonction $f(x)=\frac{1}{ 1-x }$ est représentée sur la figure \ref{LabelFigGrapheunsurunmoinsx}. Elle a deux intervalles de monotonie (dé)croissance : $\mathopen] -\infty , 1 \mathclose[$ et $\mathopen] 1 , \infty \mathclose[$. Elle va donc être bijective sur ces deux intervalles.
