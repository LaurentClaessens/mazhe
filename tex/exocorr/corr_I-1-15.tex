...
\begin{equation}
	...
	\end{aligned}
\end{equation}
où les points $n_i^*$ sont des points donnés par le théorème des accroissements finis. La norme $| x_1-x_{2} |$ est évidemment majorée par $| b-a |$, tandis que les nombres $| f'(x^*_j) |$ sont tous majorés par $\lambda<1$. Au final, nous avons
\begin{equation}
