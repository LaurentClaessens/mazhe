...
\begin{corrige}{SerieQuatre0007}
	...
	\end{equation}
	Hélas ce n'est pas terminé parce que nous ne savons pas la valeur de $x$. Afin de terminer nos majorations de l'équation \eqref{EqQSrholeqa}, nous devons majorer $K_{\text{rel}}(x)$ en fonction de $x$. Encore une fois, cela se fait en utilisant la dérivée. Le résultat est que $K_{\text{rel}}(x)$ est maximum pour $x=0.938$.
