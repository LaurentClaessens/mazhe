...
% Copyright (c) 2008,2009,2012,2013, 2024
%   Laurent Claessens
	...
	\begin{enumerate}
		...
		\item
		      ...
		      \begin{equation}
			      z_H'=-\frac{ z_H }{ \cos(t) }.
		      \end{equation}
		      Nous résolvons cette équation en utilisant la méthode des équations à variables séparées de la section \ref{Secvarsep}. Nous posons donc
