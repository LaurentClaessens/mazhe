...
% Copyright (c) 2011,2014,2017, 2019
%   Laurent Claessens
	...
	\begin{enumerate}
		...
		\item
			...
			\begin{equation}
				...
				\end{pmatrix}
			\end{equation}
			avec $u\in\mathopen] 0 , 1 \mathclose[$ et $v\in\mathopen] 0 , 1-u \mathclose[$. Le dessin de la figure \ref{LabelFigTriangleUV} montre que le paramétrage choisie a la bonne orientation vis-à-vis de la convention prise par le théorème de Green.
			...
			Le vecteur normal à la surface, de ce paramétrage, vaut
			\begin{equation*}
		...
		\item
			...
			\begin{equation}
				...
				\end{pmatrix}.
			\end{equation}
			Le paramétrage du cercle, en coordonnées cylindriques, est
			\begin{equation}
