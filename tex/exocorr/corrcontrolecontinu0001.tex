...
\begin{enumerate}
    ...
    \item
        Ceci est un exercice très similaire à l'exemple \ref{ItemexoEspVectoNorme0003iv}. Pour chaque \( x\in\eN\) nous avons toute la droite verticale correspondante, voir la figure \ref{LabelFigexamsseptii}.
