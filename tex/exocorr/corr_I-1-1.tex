...
%\input{auto/pictures_tex/Fig_exouuu.pstricks}

\begin{enumerate}
\item 

La suite de fonctions proposée converge (ponctuellement) vers la fonction
\begin{equation}
	f(x)=
\begin{cases}
	0	&	\text{si }x\neq 0\\
...
\end{equation}
ce qui prouve que la suite de fonctions est uniformément convergente sur tout compact de $]0,1]$.
