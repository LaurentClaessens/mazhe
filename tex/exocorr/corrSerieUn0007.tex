...
\begin{corrige}{SerieUn0007}
	...
	\begin{enumerate}
		...
		\item
			...
			\end{equation}
			Si $a>1$, l'expression dans le supremum est croissante en \( d\)\quext{Je ne vois pas pourquoi, mais en la traçant, ça a l'air d'être le cas.} et donc le supremum est atteint lorsque $d=d_0+\eta$ et le conditionnement absolu vaut
			\begin{equation}
