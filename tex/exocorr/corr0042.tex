...
\end{equation}
La valeur de $f(1+tu_1,tu_2)$ dépend de si $u_2$ est nul ou non. Ce que nous trouvons (il faut utiliser la règle de L'Hôpital une fois) est
