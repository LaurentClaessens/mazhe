...
\begin{corrige}{FoncDeuxVar0015}
	...
	Lorsqu'on a un sinus de quelque chose qui tend vers zéro et qu'on ne sait pas très bien quoi faire, une bonne idée est toujours de multiplier et diviser par ce qui est dans le sinus. De cette façon, le sinus disparaît. Ici, nous avons
	\begin{equation}
	...
	\begin{equation}
		...
		\end{aligned}
	\end{equation}
	Évidemment, la limite de $r$ lorsque on tend vers $(0,0)$ est zéro. Voyons la limite de $g(t)$ lorsque $t\to 0$. Cela se règle en utilisant la règle de L'Hôpital :
	\begin{equation}
