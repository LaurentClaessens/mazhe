...
\begin{enumerate}
	\item
	      Le théorème de Cauchy-Lipschitz \( y'(t,\lambda)=f\big( y(t,\lambda),\lambda \big)\) existe en plusieurs versions :
	      \begin{enumerate}
		      \item Avec \( f\) continue et lipschitzienne, théorème \ref{ThokUUlgU}. Il est utilisé dans
		            \begin{enumerate}
			            \item
			                  Pour calculer la transformée de Fourier de \(  e^{-x^2/2}\) dans le lemme~\ref{LEMooPAAJooCsoyAJ}.
		            \end{enumerate}
		      \item
		            Cauchy-Lipschitz holomorphe : théorème \ref{PROPooYYYDooXeEcVw}.
		      \item
		            Cauchy-Lipschitz analytique : théorème \ref{THOooHDHCooLMkfaB}.
	      \end{enumerate}
	\item
