...
\InternalLinks{compacts}        \label{THEMEooQQBHooLcqoKB}
    ...
    \item
        Dans un espace Hausdorff, les compacts sont fermés, \ref{LemnAeACf}\ref{ITEMooAZWVooLyPDeY}.
    \item
...
\InternalLinks{espaces de Hilbert, base hilbertienne}
...
\InternalLinks{analyse complexe, fonctions holomorphes}     
\begin{enumerate}
    \item
...
\InternalLinks{Immersions and Embeddings}
