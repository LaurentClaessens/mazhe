...
\begin{normaltext}      \label{NORMooRRZCooMOKAzY}
    ...
    Si \( \alpha\) est une liste d'indices de longueur \( p\), une \defe{queue de}{queue de liste d'indices} \( \alpha\) est une liste d'indices de la forme \( (\alpha_{p-k}, \alpha_{p-k+1},\ldots, a_{p-k})\).
\end{normaltext}
