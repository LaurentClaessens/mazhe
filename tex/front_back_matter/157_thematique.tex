...
\begin{itemize}
    ...
    \item Le dénombrement des solutions de l'équation \( \alpha_1 n_1+\ldots \alpha_pn_p=n\) utilise des séries entières et des décompositions de fractions en éléments simples\footnote{Éléments simples, lemme \ref{LEMooABJMooJTUpgV}.}, théorème~\ref{ThoDIDNooUrFFei}.
\end{itemize}
...
\InternalLinks{équations diophantiennes}
    \begin{enumerate}
        ...
        \item Le dénombrement des solutions de l'équation \( \alpha_1 n_1+\ldots \alpha_pn_p=n\) utilise des séries entières et des décompositions de fractions en éléments simples, théorèmes \ref{ThoDIDNooUrFFei}, \ref{PropWUFpuBR}, et surtout \ref{THOooQDYWooCOiUMb}.
