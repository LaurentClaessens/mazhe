...
\InternalLinks{caractérisations séquentielles}  
    \begin{enumerate}
        ...
        \item
            Pour des espaces métriques, la continuité séquentielle d'une fonction est équivalente à la continuité, proposition \ref{PropXIAQSXr}.
    \end{enumerate}
...
\end{itemize}
Le théorème de Stone-Weierstrass est utilisé pour prouver la densité des polynômes trigonométriques dans les fonctions continues sur \( S^1\), voir la proposition \ref{PROPooTGBHooXGhdPR}.
