...
\begin{enumerate}
    ...
    \item
        Le groupe alterné \( A_5\) est l'unique groupe simple d'ordre\footnote{Ordre d'un groupe, définition \ref{}.} \( 60\), proposition~\ref{PROPooUBIWooTrfCat}.
    \item
...
\begin{enumerate}
    \item Ordre d'un grupe, définition \ref{}.
