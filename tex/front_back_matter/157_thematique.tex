...
\begin{enumerate}
    \item
        Un morphisme est un concept algébrique. Il s'agit d'une application (pas spécialement inversible) qui préserve la structure.
    \item
...
\begin{description}
    \item[Définitions]
        ...
        \begin{enumerate}
            ...
            \item
                En ce qui concerne la notation \( A[X]\), elle ne devrait pas être utilisée, vor \ref{SUBSECooLEKVooFBPSJz}. L'ensemble des polynômes sera noté \( \polyP(A)\) et ceux de degré \( n\) (définition \ref{DefDegrePoly}), \( \polyP_n(A)\).
            \item
