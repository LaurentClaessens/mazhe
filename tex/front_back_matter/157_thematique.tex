...
\item
    Le théorème de Cantor \ref{THOooJPNFooWSxUhd} dit qu'il n'existe pas de surjection d'un ensemble vers son ensemble des parties. On en déduit qu'il n'existe pas d'ensemble contenant tous les ensembles (corollaire \ref{CORooZMAOooPfJosM}).
\item 
...
\begin{enumerate}
    ...
    \item
        Densité des polynômes dans \( \big( C^0(I),\| . \|_{\infty} \big)\) lorsque \( I=\mathopen[ a , b \mathclose]\), corollaire \ref{CORooCWLMooWwCOAP}.
    \item
...
\begin{enumerate}
    ...
    \item
        Lien entre différentielle seconde (hessienne) et convexité en la proposition~\ref{PROPooBMIRooFkQSAb} et le 
	~\ref{CORooMBQMooWBAIIH}.
    \item
...
\InternalLinks{rang}
    \begin{enumerate}
        ...
        \item Pour prouver que des matrices sont équivalentes et pour les mettre sous des formes canoniques, nous avons le lemme \ref{LemZMxxnfM} et son corollaire \ref{CorGOUYooErfOIe}.
...
\begin{enumerate}
    ...
    \item
        En particulier, les éléments de \( \SO(3)\) sont des compositions de deux réflexions par le corollaire \ref{CORooJCURooSRzSFb}.
    \item
