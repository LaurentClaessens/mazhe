...
\begin{normaltext}      \label{NORMooRRZCooMOKAzY}
    Je crois qu'il y a quelque incohérences de notations/dénominations dans le texte. En principe quand on parle de \( \eR^n\), un \defe{multiindice}{multiindice} \cite{BIBooYDMJooGDtdbo} est une vecteur d'entiers positifs à \( n\) composantes. Si \( \alpha=(2,1)\) alors nous avons la notation
    \begin{equation}
