...
\begin{description}
	...
	\item[Isométries et réflexions]
	      ...
	      \begin{enumerate}
		      \item
		            Définition d'une rotation dans \( \eR^2\) \ref{LEMooIJELooLWqBfE}.
		      \item
		            Définition d'une réflexion par rapport à un hyperplan : \ref{LEMooPXIOooSlMIIY}.
		      \item
		            Définition d'une réflexion par rapport à un point : \ref{DEFooAROHooTrRfgQ}.
		      \item
		      ...
		      \item
		            Une isométrie de \( (\eR^2,d)\) laissant un point fixe est soit une rotation soit une réflexion, lemme \ref{LEMooAIVCooXTzWZi}.
	      \end{enumerate}
