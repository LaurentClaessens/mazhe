...
\begin{description}
	\item[Généralités]
	      ...
	      \end{enumerate}
	\item[Différentielle et dérivée usuelle]
	      Souvent la différentielle est l'opérateur de multiplication par la dérivée : \( df_a=f'(a)\).
	      \begin{enumerate}
		      \item
		            Pour \(f \colon \eR\to V  \) c'est le lemme \ref{LEMooXZGQooYxDRRU}.
		      \item
		            Pour les fonctions holomorphes, c'est la proposition \ref{PropKJUDooJfqgYS}.
		      \item
		            Pour \(f \colon \eR\to \eC  \) c'est le lemme \ref{LEMooKJOEooLRUzSA}.
		      \item
		            Dans le même ordre d'idée la dérivée complexe est liée à la dérivée complexe par la formule de la proposition \ref{PROPooBLGMooYeZZYJ} : \( (f\circ\gamma)'(t)=(f'\circ\gamma)(t)\gamma'(t)\).
	      \end{enumerate}<++>
