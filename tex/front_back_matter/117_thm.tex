...
\begin{description}
	...
	\item[Différentielle et dérivée usuelle]
	      ...
	      \begin{enumerate}
		      ...
		      \item
		            Dans le même ordre d'idée la dérivée complexe est liée à la dérivée usuelle par la formule de la proposition \ref{PROPooBLGMooYeZZYJ} : \( (f\circ\gamma)'(t)=(f'\circ\gamma)(t)\gamma'(t)\).
	      \end{enumerate}
