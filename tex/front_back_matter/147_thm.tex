...
\begin{enumerate}
	...
	\item
	      Corps de rupture Vs corps de décomposition. Un corps de rupture est un corps dans lequel le polynôme est cassé en deux; le corps de décomposition est celui où il se casse en tous ses morceaux. Donc si un polynôme a plein de racines, un corps de rupture doit en contenir une alors que le corps de décomposition doit toutes les contenir.
	\item
