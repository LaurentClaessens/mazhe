...
\begin{enumerate}
    ...
    \item
        Toute suite convergente dans un espace métrique est de Cauchy, propostion \ref{PROPooZZNWooHghltd}.
\end{enumerate}

Quelques espaces qui sont complets sont listés ci-dessous. Attention : la complétude est bien une propriété de la métrique; le même ensemble peut être complet pout une distance et pas pour une autre. Souvent, cependant la distance à considérer est donnée par  le contexte.
\begin{multicols}{2}
    \begin{enumerate}
        \item
