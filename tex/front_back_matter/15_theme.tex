...
\InternalLinks{compacts}        \label{THEMEooQQBHooLcqoKB}
    ...
    \item
        ...
        \begin{enumerate}
            \item
                Dans \( \eR\), toute suite dans un compact admet une suis-suite convergente, théorème \ref{THOooRDYOooJHLfGq}.
            \item
                Dans \( \eR^n\), toute suite dans un compact admet une suis-suite convergente, théorème \ref{ThoBolzanoWeierstrassRn}. La démonstration de ce théorème utilise le cas dans \( \eR\).
            \item
