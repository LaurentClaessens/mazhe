...
\begin{enumerate}
    ...
    \item
        Demande probablement des connaissances avancées en mathématique; au moins être tout à fait à l'aise avec le niveau d'agrégation.
\end{enumerate}
...
\begin{enumerate}
    \item
        ...
        Soit \( V\) un espace vectoriel topologique métrisable, alors il admet une métrique \( d\) compatible avec la topologie telle que une suite dans \( V\) est \( d\)-Cauchy si et seulement si elle est \( \tau\)-Cauchy.
