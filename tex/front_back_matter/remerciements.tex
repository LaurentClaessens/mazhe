...
Si vous comptez utiliser régulièrement ce logiciel, je vous recommande \emph{chaudement} de l'installer sur votre ordinateur.
...
\begin{enumerate}
	...
	\item
	      En termes de féminisation, on n'écrit pas «la.e lectrice.teur» mais on utilise
	      \begin{center}
...
%-------------------------------------------------------
\subsection{Contributions IA}
%----------------------------------------------------

Je n'ai à priori rien contre le fait d'utiliser une IA pour faire de math. MAIS MAIS MAIS MAIS !

Ne me faites pas une contribution qui consiste à balancer un énoncé dans ChatGPT pour juste me donner la sortie. Ça, je peux le faire moi-même.

\begin{enumerate}
	\item
	      Relisez la preuve pour vous assurer qu'elle est correcte.
	\item
	      Assurez-vous que les résultats utilisés dans la preuve soient déjà dans le Frido. Sinon, donnez un énoncé précis. Pas besoin de preuve pour le résultat intermédiaire. Sauf si c'est l'IA qui vous l'a donné. En effet il arrive encore (2026) que l'IA fasse une faute et, quand on lui demande comment il justifie telle ligne, qu'il balance «c'est un résultat connu que <et bam, un énoncé faux>».
\end{enumerate}

Plus généralement, ne me faites pas de contributions que vous ne comprenez pas vous-même. Si vous les faites, vous utiliseriez mieux votre temps à contribuer à un autre projet.
