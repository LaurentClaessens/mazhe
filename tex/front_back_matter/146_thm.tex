...
\begin{enumerate}
	...
	\item Tout hyperplan\footnote{Définition \ref{DEFooEWDTooQbUQws}.} de \( \eM(n,\eK)\) coupe \( \GL(n,\eK)\), corolaire~\ref{CorGOUYooErfOIe}. Cela utilise la forme canonique sus-mentionnée.
