...
\begin{enumerate}
	...
	\item
	      \( \eZ\) est une anneau intègre\footnote{Définition \ref{DEFooTAOPooWDPYmd}.}, lemme \ref{LEMooFUSTooDCcBDb}, principal et euclidien (proposition~\ref{PROPooPJGLooQSrJTU}).
	\item
