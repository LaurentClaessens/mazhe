...
\begin{description}
    \item[Définitions]
        ...
        \begin{enumerate}
            ...
            \item
                \( A[X]\), définition~\ref{DefRGOooGIVzkx}; l'anneau \( \eK[X]\) a même définition parce que c'est un cas particulier. L'évaluation d'un polynôme en un élément de l'anneau, \( P(\alpha)\) est définie en~\ref{DEFooNXKUooLrGeuh}.
            \item
