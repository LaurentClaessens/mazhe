...
\begin{enumerate}
	\item
	      Mesure positive, définition~\ref{DefBTsgznn}.		% 	ooWXNRooXCBIUX pour rendre cette ligne unique.
	\item
	      Tribu, définition~\ref{DefjRsGSy}.							%   ooRMDGooUCAfKk pour rendre cette ligne unique.
	\item
	...
	\item
	      Un \( \pi\)-système : définition \ref{DEFooGYADooTudZmJ}.
	\item
