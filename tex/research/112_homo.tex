...
\]
but using Leibniz formula, we find
\begin{equation}
...
\begin{proposition}[\cite{kobayashi}]
...
\end{proposition}
In particular the group $\mA(M)$ of the affine transformations of $M$ is transitive on $M$.
