...
\begin{definition}[Partition of unity subordinated]      \label{DEFooEDFIooHKnGdE}
...
\begin{theorem}[partition of unity\cite{ooQCDSooCpqDvB}]      \label{THOooPCHDooITWKpC}
	Let \( \Omega\) be open in \( \eR^n\). Let \( \{ U_i \}_{i\in I}\) be an open covering of \( \Omega\). There exists
	\begin{enumerate}
		\item	 \label{ITEMooINBLooIbUpxq}
		      A \( C^{\infty}\)-partition of unity \(   \{ \psi_j \}_{j\in J} \) such that \( \supp(\psi_j)\) is compact in of the \( U_i\).
		\item       \label{ITEMooFGMJooQPLqGY}
		      A \( C^{\infty}\)-partition of unity \( \{ \alpha_i \}_{i\in I}\) subordinated to the \( U_i\) such that for every compact \( K\), \( \{ i\in I\tq \alpha_i|_{K}\neq \emptyset \}\) is finite.
	\end{enumerate}
...
\begin{proof}
	...
	\begin{subproof}
		\spitem[Relatively compact en localy finite]
		%-----------------------------------------------------------
		...
		\spitem[\( \gamma_i>0\) on \( \bar W_i\)]
		%-----------------------------------------------------------
		Let \( x\in\bar W_i\subset U_i\). We have
		\begin{equation}
			\gamma_i(x)=(\beta_i*\rho_{\epsilon_i})(x)=\int_{\eR^d}\beta_i(y)\rho_{\epsilon_i}(x-y).
		\end{equation}
		...
		We define
		\begin{equation}
			s(x)=\sum_{i\in I}\gamma_i(x).
		\end{equation}
		Since \( \{ U_i \}_{i\in I}\) is locally finite, for each \( x\) the sum is finite.
		...
		% ATTENTION : j'ai \gamma_i>0 sur W et non sur V. Sois attentif.
	\end{subproof}
