...
\end{equation}
and the representation\footnote{We know the list of irreducible representations of \( U(1)\) by the proposition \ref{PROPooLWWEooUmqbRA}.} $\dpt{\rho_n}{U(1)}{GL(\eC)}$,
\[
