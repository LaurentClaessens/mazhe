...
\begin{lemma}		\label{LemTroisVN}
	If $T\in M''$, $v_1, \ldots, v_n\in\hH$, and $\epsilon>0$, there exists a $T\in M$ such that $\| Sv_i-Tv_i \|\leq\epsilon$ for all $i$. Moreover in the finite dimensional case, there exists a $T$ such that $Sv_i=Tv_i$.
\end{lemma}
