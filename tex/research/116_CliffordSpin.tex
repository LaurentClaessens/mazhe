...
% Copyright (c) 2013-2014,2016,2020, 2024, 2025
%   Laurent Claessens
...
\section[Dirac operator]{Dirac operator}		\label{applgamma}
%---------------------------------------------------------------------
...
\begin{normaltext}		\label{NORMooUCULooJVYkzO}
	...
	\begin{equation}
		...
		\end{aligned}
	\end{equation}
	does not depend on the choices\quext{If you are able to prove that, please send me the proof. I am happy with a picture of a hand written proof.}. Better : the map \( \tilde \rho_0\) only depends on the signature of \( g\).
	%TODOooJDKWooQXXjRw Prouver ça.
