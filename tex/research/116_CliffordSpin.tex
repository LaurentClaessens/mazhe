...
\begin{normaltext}		\label{NORMooUCULooJVYkzO}
	...
	\begin{equation}
		...
		\end{aligned}
	\end{equation}
	does not depend on the choices\quext{If you are able to prove that, please send me the proof. I am happy with a picture of a hand written proof.}. Better : the map \( s\) only depends on the signature of \( g\).
