...
\begin{theorem}[Kakutani\cite{BIBooNYIOooTIiwbz,BIBooAWWDooUzosWY}]     \label{THOooWXQFooQrWcLY}
    Let \( X\) be a locally convex topological vector space. Let \( K\) be compact in \( X\) and \( \mS\) be a group of linear endomorphisms of \( X\) such that
    \begin{enumerate}
        \item
            \( \mS\) is equicontinuous on \( K\),
        \item
            \( \mS(K)\subset K\).
    \end{enumerate}
...
%TODOooGPUAooSiCkrm Quand ceci est prouvé, poster un lien vers ici sur la question
% https://math.stackexchange.com/questions/4402056/use-of-zorn-lemma-in-a-proof-of-kakutani-theorem
