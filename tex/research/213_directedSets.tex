...
\begin{definition}      \label{DEFooYOMHooZJvsSt}
    ...
    The distribution \( \mD\) is said to be \defe{smooth}{smooth distribution} if for each \( p\in M\), there exists a neighbourhood \( U\) of \( p\) and smooth vector fields \( \{ X_i \}_{i=1,\ldots, k}\) in \( U\) such that
    \begin{equation}
        \mD_p=\Span\{ X_i(p) \}.
    \end{equation}
