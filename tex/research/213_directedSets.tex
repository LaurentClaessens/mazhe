...
\item[Unicity]
    ...
    \begin{subproof}
    \item[\( \mu^o\) is increasing]     \label{ITEMooOMDSooQiYmaP}
    ...
    \item[If \( V\) is open, \( \mu^o(V)=\mu^+(V)\)]        \label{ITEMooBRBTooAJBxGO}
    ...
    \item[If \( K\) is compact, \( \mu^+(K)<\infty\)]       \label{ITEMooQVOGooQvTTzw}
    ...
    \item[\( \mu^+(K)=\inf\{ m(f):\, K\prec f \}\)]
        ...
        \end{equation}
    \item[\( K\in \tribA_F\)]       \label{ITEMooSMHRooIxgdeO}
    ...
    \item[ \(\mu^+(V)= \mu^o(V)=\mu^-(V)\)]     \label{ITEMooEDOSooPwvyAO}
    ...
    \item[If \( \mu^o(X)<\infty\), then \( V\in \tribA_F\)]
        ...
        \end{equation}
        so \( V\in\mA_F\).
    \item[\( \mu^+(V_1\cup V_2)\leq \mu^+(V_1)+\mu^+(V_2)\)]        \label{ITEMooLPYWooONCYTi}
    ...
    \item[\( \mu^+(\bigcup_i E_i)\leq \sum_i\mu^+(E_i)\)]       \label{ITEMooQZTEooJhWFna}
        ...
        \end{equation}
    \item[\( \mu^+(A)+\mu^+(B)=\mu^+(A\cup B)\) when \( A,B\) are disjoint compacts] \label{ITEMooCVWSooCmPoPL}
     ...
     \item[\( \mu^+(V\cup K)=\mu^+(V)+\mu^+(K)\) if \( V\cap K=\emptyset\)]         \label{ITEMooZSUIooPrPhtD}
     ...
     \item[\( \mu^+(A\cap V)+\mu^+(A\setminus V)\leq \mu^+(A)\), \( A\) open]
     ...
     \item[\( \mu^+(E\cap V)+\mu^+(E\setminus V)\leq \mu^+(E)\), \( E\) arbitrary]
    \end{subproof}
\end{proof}
