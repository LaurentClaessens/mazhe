...
\end{equation}
This satisfies some properties which looks like the true Fourier transform; \emph{inter alia}, this poses an associated ``convolution''\ product:
...
\begin{proof}
	...
	An induction argument using uniform convergence of the integral and Leibniz shows that $f\stWh g$ is smooth. The limit $\lim_{u\to\infty}(f\stWh g)(u)$ is zero because\quext{J'espère que c'est vrai !}
	\[
