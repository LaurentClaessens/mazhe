...
\begin{proof}
	...
	\begin{subproof}
		\spitem[For \ref{DEFooJOMAooZscKwn}\ref{ITEMooJOPDooPiOadZ}: the \( \sigma_{\alpha}\) are a covering]
		%-----------------------------------------------------------
		...
		\spitem[For \ref{DEFooJOMAooZscKwn}\ref{ITEMooJOPDooPiOadZ}: the \( \sigma_{\alpha}\) are homeomorphic]
		%-----------------------------------------------------------

		We have to prove that:
		\begin{enumerate}
			\item
			      \( \sigma_{\alpha}\) is bijective.
			\item
			      If \( A\) is open in \( \sigma_{\alpha}\), then \( \sigma_{\alpha}(A)\) is open in \( T\).
			\item
			      If \( \mO\) is open in \( T\), then \( \sigma_{\alpha}^{-1}(\mO)\) is open in \( U_{\alpha}\times \eR^{k_1k_2}\).
		\end{enumerate}
		For the bijection, a map is always surjective to its image and we already proved that \( \sigma_{\alpha}\) is injective. If \( A\) is open in \( U_{\alpha}\times \eR^{k_1k_2}\), then \( \sigma_{\alpha}(A)\) belongs to \( \tau_0\) and is then open. The difficult part is the third point.

		If \( \mO\in\tau_0\), then \( \sigma_{\alpha}^{-1}(\mO)\) is open by definition. Now we prove that, if \( \mO_1\) and \( \mO_2\) belong to \( \tau_0\), then \( \sigma_{\alpha}^{-1}(\mO_1\cap\mO_2)\) is open.

		Let \( \alpha,\beta,\gamma\in \Lambda\). We consider open parts \( S_{\alpha}\subset U_{\alpha}\), \( S_{\beta}\subset U_{\beta}\), \( X_{\alpha},X_{\beta}\subset \eR^{k_1k2}\) and we prove that
		\begin{equation}
			\sigma_{\gamma}^{-1}\big( \sigma_{\alpha}(S_{\alpha}\times X_{\alpha})\cap  \sigma_{\beta}(S_{\beta}\times X_{\beta}) \big)
		\end{equation}
		is open in \( U_{\gamma}\times \eR^{k_1k_2}\).

		For \( x\in M\), introduce the parts
		\begin{equation}
			\begin{aligned}[]
				W_x^{(1)}=\sigma^{(1)}_{\alpha}\big( \varphi_{\alpha}^{-1}(x),X_{\alpha} \big)\subset V^{(1)}_x \\
				W_x^{(2)}=\sigma^{(2)}_{\beta}\big( \varphi_{\beta}^{-1}(x),X_{\beta} \big)\subset V^{(2)}_x.
			\end{aligned}
		\end{equation}

		First we prove that
		\begin{equation}		\label{EQooNWFCooWcxQxa}
			\sigma_{\alpha}(S_{\alpha}\times X_{\alpha})\cap \sigma_{\beta}(S_{\beta}\times X_{\beta})=\bigcup_{x\in \varphi_{\alpha}(S_{\alpha})\cap \varphi_{\beta}(S_{\beta})}W_x^{(1)}\otimes W_x^{(2)}.
		\end{equation}
		\begin{subproof}
		...
		\begin{subequations}
			\begin{align}
				 & \sigma_{\alpha}^{-1}\big( \sigma_{\alpha}(U_{\alpha}\times \eR^{k_1k_2})
				\cap \sigma_{\beta}(U_{\beta}\times \eR^{k_1k_2})  \big)
		...
		\spitem[For \ref{DEFooJOMAooZscKwn}\ref{ITEMooZZXHooPICcjz}: Hausdorff]
		%-----------------------------------------------------------
		...
		\spitem[For \ref{DEFooJOMAooZscKwn}\ref{ITEMooKOSMooSawqbB}: second countable]
		%-----------------------------------------------------------
