...
\begin{proof}
    ...
    \end{equation}
    From corollary \ref{CorOpOdquijInverti}, the operator $\id-q\pi(u_{jj})$ is invertible. Thus equation \ref{EQooCPTHooZsrqeq} implies $\pi(u_{ij})f=0$ and $f\in\bigcap_{i<j}\ker\pi(u_{ij})$. Thus we have
