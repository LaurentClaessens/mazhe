...
\begin{proof}
    ...
    \item[\( \mA\subset \SO(3,1)\)]
        Let \( \omega\in \mA\). We consider the path \( \Lambda(t)= e^{\omega t}\). Here the exponential is a «normal» exponential of matrix\footnote{Definition \ref{DEFooSFDUooMNsgZY}.}. The proposition \ref{PROPooSDNNooQtHkhA} says that \( \Lambda'(0)=\omega\). This is what we needed.
    \end{subproof}
\end{proof}
