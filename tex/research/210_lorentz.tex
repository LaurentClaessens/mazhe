...
The set \( \gO(3,1)^{\uparrow}\) defined in the lemma \ref{LEMooEKXWooLEMBIj} is often called \( L^{\uparrow}\).
\begin{lemma}       \label{LEMooEKXWooLEMBIj}
    ...
    Elements of \( \gO(3,1)^{\uparrow}\) are said \defe{orthochronous}{orthochronous}.
\end{lemma}
