...
Now we are paying our set of definitions. The set \( \SL(2,\eC)\) is a set of matrices while \( \gO(3,1)\) is a set of linear maps. This is not a big deal since the identification between matrices an linear maps is continuous by \ref{}.
\begin{lemma}
