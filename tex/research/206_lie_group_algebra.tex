...
\begin{proof}
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    We prove the \( \Phi\) is the flow\footnote{Definition \ref{PROPooJACTooXBSxfE}.} of \( Y\). Since \( \exp(0)=e\) (lemma \ref{LEMooEQFHooRjUAin}), we have \( \Phi(0,g,X)=(g,X)\). For the second condition, we use the lemma \ref{LEMooTONEooFiysTA}:
    \begin{subequations}
        \begin{align}
        ...
        \end{align}
    \end{subequations}
    Since the vector field \( Y\) is smooth, the proposition \ref{PROPooSGJGooOXElFg} says that \( \Phi\) is smooth.
    <++>
\end{proof}
...
et
    ...
    %TODOooNGGTooPbNTiw cette preuve ne semble pas faite.
