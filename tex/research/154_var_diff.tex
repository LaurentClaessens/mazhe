...
\begin{proof}
    ...
    The intervals \( I_a\) are covering \( K\) which is compact; we extract a finite subcovering \( \{ I_i \}_{i=1,\ldots, n}\). Lemma \ref{LEMooNMGWooTfQDeO} allows us to sort these intervals in such a way that \( 0\in I_1\) and
    \begin{equation}
