...
\begin{proof}
	...
	\begin{subproof}
		...
		Let \( U\) be a neighbourhood of \( 0\) in \( \mG\) and \( v\) a neighbourhood of \( e\) in \( G\) such that \( \phi\colon U\to V\) is a bijection.
		...
		Let \( U_i=B(0,r_i)\) in \( \lG\) with \( r_i\to 0\) be as small as \( U_i\subset U\) for every \( i\). Let \( V_i=\phi(U_i)\). The part \( B(0,r_i)\cap \lH\) is a neighbourhood of \( 0\) in \( \lH\) and \( V_i\cap H\) is a neighbourhood of \( e\) in \( H\). This \( \phi\) is not a bijection between \( B(0,r_i)\cap\lH\) and \( V_i\cap H\).
		...
		Then \( \phi\) is a local bijection between \( \lH\) and \( H\): there exists a neighbourhood \( U\) of \( 0\) in \( \lH\) and a neighbourhood \( V\) of \( e\) in \( H\) such that \( \phi\colon U\to V\) is a bijection.
