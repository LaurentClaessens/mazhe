...
\begin{lemma}[\cite{BIBooJOSEooGOmqoQ}]       \label{LEMooOBIMooVvIDnb}
	...
	% À mon avis ce lemme ne sert à rien et peut être remplacé par PROPooZIKNooEdCqRB
\end{lemma}
...
\begin{proposition}[Manifold and Lie group structure on \( H\)\cite{BIBooFLEXooPgvAlz,MonCerveau}]	\label{PROPooZIKNooEdCqRB}
