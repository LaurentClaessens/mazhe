...
\begin{proposition}[\cite{MonCerveau}]		\label{PROPooXURIooYPytwa}
	...
	\end{equation}
	where the vectors \( \partial_{\alpha}\) are defined in \ref{DEFooUWWWooXhHVXP}.
\end{proposition}
...
\begin{lemma}[\cite{MonCerveau}]        \label{LEMooZWFAooDlYaJm}
	...
	% À mon avis il faut utiliser PROPooXURIooYPytwa
\end{lemma}
