...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[We have all of them]
            Let \( (\rho, V)\) be a continuous irreducible representation of \( U(1)\). Since \( U(1)\) is abelian, \( \dim(V)=1\) (theorem \ref{THOooFFJGooCekFQc}). So there exist a function \( \lambda\colon U(1)\to \eC\) such that 
            \begin{equation}
                \rho(g)=\lambda(g)\id.
            \end{equation}
