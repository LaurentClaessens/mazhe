...
\begin{theorem}     \label{THOooSRQYooXQDZpT}
    Let \( j\in \eN/2\). Let \( V_j\) be a vector space of dimension \( 2j+1\); we label a basis of \( V\) in the following way: \( \{ v_m \}_{m=j,j-1,\ldots, -j}\).
    ...
    \begin{enumerate}
        ...
        \item
            Every finite dimensional irreducible representation is isomorphic to \( \rho_j\) for some \( j\in \eN/2\).
    \end{enumerate}
\end{theorem}
