...
\begin{proposition}
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    is an isometric continuous representation.
\end{proposition}
...
\begin{proof}
    ...
    The last point to check is the continuity of \( \rho\colon \SU(2)\to \End(V)\). We see that, with the notations of \eqref{} and \eqref{}<++> \( \rho(U)=L(U)\circ R(U)\)
\end{proof}
