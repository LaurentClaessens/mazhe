...
\begin{definition}[Product of Lie algebras\cite{MonCerveau}]	\label{DEFooNBHXooMZdXGt}
...
\begin{definition}[Representation of a Lie algebra\cite{BIBooEDAIooCFjZIz}]     \label{DEFooHINCooYoxPFj}
	If \( \lG\) is a Lie algebra, a \defe{representation}{representation of a Lie algebra} is a map a vector space \( V\) with a linear map \( \rho\colon \lG\to \End(V)\) such that
	\begin{equation}
...
\begin{proof}
	...
	\begin{subproof}
		\spitem[This is a representation]
