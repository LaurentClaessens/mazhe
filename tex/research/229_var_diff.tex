...
\begin{proposition}[\cite{BIBooDPYDooWgxxQH}]       \label{PROPooJACTooXBSxfE}
    ...
    \end{equation}
    We say that \( \Phi_p\) is the \defe{integral curve}{integral curve} of \( X\) at \( p\). We will often write \( \Phi(p,t)\) instead of \( \Phi_p(t)\).
\end{proposition}
