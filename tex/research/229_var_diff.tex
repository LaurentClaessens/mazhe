...
\begin{proof}
	Three parts.
	\begin{subproof}
		\spitem[\ref{SUBEQooTGJJooEyvEDJ} \( \Rightarrow\) \ref{SUBEQSooKJHYooWyRaBO}]
		%-----------------------------------------------------------
		First check:
		\begin{equation}
		...
		\begin{subequations}
			...
			\end{align}
		\end{subequations}
		\spitem[\ref{SUBEQSooKJHYooWyRaBO} \( \Rightarrow\) \ref{SUBEQooTGJJooEyvEDJ}]
		%-----------------------------------------------------------
		First check:
		\begin{equation}
...
\begin{propositionDef}[Integral curve, flow of a vector field\cite{MonCerveau,BIBooDPYDooWgxxQH}]			\label{DEFooRXUOooTGACym}
...
\begin{proof}
	...
	\begin{subproof}
		...
		So, in order to be an integral curve, \( \gamma\) is required to satisfy
		...
		\spitem[Local existence]		\label{ITEMooZXADooIskevE}
		% -------------------------------------------------------------------------------------------- 
		...
		\spitem[\( \Phi_{t+u}=\Phi_t\circ \Phi_u.\)]
		%-----------------------------------------------------------
