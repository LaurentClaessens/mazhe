...
En analogie avec la définition \ref{DefMesureInt}, nous nous attendons que la longueur d'une courbe soit égale à la valeur de l'intégrale de la fonction $1$ sur le long de la courbe.
\end{remark}
...
Pour répondre à cette question, le mieux serait de prouver que la longueur de $\gamma$ est bien l'intégrale sur le graphe de $\gamma$ de la fonction $1$ parce que nous avons vu dans la définition \ref{DefMesureInt} que cette intégrale est la mesure de la courbe. 
% TODO : mettre ici la référence vers le bon endroit.
