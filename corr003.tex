...
%	\pstGeonode(0,0){O}
%	\pstGeonode[PointSymbol=*](0.5,1){zu}
%\pstCircleOA{O}{zu}
%	\pstInterLC[PointSymbol=*]{O}{zu}{O}{zu}{zd}{zup}
%\rput(zu){\rput(0.5;45) {$z_1$}}
%\rput(zd){\rput(0.5;225) {$z_2$}}
%	\pstRotation[RotAngle=90]{zu}{O}[iu]
%\pstLineAB[nodesepA=-2,nodesepB=-1]{zu}{iu}
%	\pstTranslation{zu}{O}{iu}[im]
%	\pstTranslation{zu}{O}{im}[id]
%\pstLineAB[nodesepA=-2,nodesepB=-1]{zd}{id}
%\pstLineAB[nodesepA=-2,nodesepB=-1,linestyle=dotted]{O}{im}
%\end{pspicture}
%\end{center}
%\caption{A possible mistake is to confuse $T_{z_1}S^1$ and $T_{z_2}S^1$.}\label{fig:TSun}
%\end{figure}
