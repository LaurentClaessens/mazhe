...
\begin{remark}
    ...
    \end{equation}
    qui n'est autre que la longueur de la courbe\footnote{Comme expliqué par le théorème \ref{ThoLongueurIntegrale}.}. Encore une fois, l'intégrale de la fonction $1$ donne la «mesure» de l'ensemble.
\end{remark}
