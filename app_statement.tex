...
This appendix is devoted to the statement of some results which are used in the text, but whose demonstration should be out of our purpose.
...
\end{proposition}
For a proof see \cite{SerreMatrices}.
