...
\begin{proof}
    ...
    \end{equation}
    Nous voulons permuter les intégrales en utilisant le théorème de Fubini \ref{ThoFubinioYLtPI} avec la fonction
    \begin{equation}
        (x,y)\mapsto f(x)\varphi(y) e^{-ixy}
    \end{equation}
    qui est parfaitement dans \( L^1(\eR^d\times \eR^d)\).
\end{proof}
