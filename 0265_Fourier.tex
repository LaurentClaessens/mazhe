...
\begin{proposition}
    Soit \( u\colon \eR\to \swS'(\eR^d)\). Alors
    \begin{enumerate}
        \item
    ...
    \end{enumerate}
\end{proposition}
En ce qui concerne la définition de l'espace \( C^{\infty}(\eR,\swS'(\eR^d))\)\nomenclature[Y]{\(  C^{\infty}(\eR,\swS'(\eR^d))\)}{fonctions à valeurs dans les distributions}, c'est la définition \ref{DefDZsypWu}.
