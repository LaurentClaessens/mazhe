...
\begin{proof}
    Nous agissons sur une fonction test \( \varphi\in\swS(\eR^d)\) en notant \( t_x(\varphi)(y)=\varphi(x-y)\) :
    \begin{equation}
        T_{T*\psi}(\varphi)=\int_{\eR^d}(T*\psi)(x)\varphi(x)dx=\int_{\eR^d}T(t_x\psi)\varphi(x)dx.
    \end{equation}
    Est-ce que la fonction \( x\mapsto T(t_x\psi)\) est dans \( \swS(\eR^d)\) ?
\end{proof}
<++>
