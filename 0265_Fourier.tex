...
\begin{proof}
    ...
    c'est à dire que 
    \begin{equation}
        \| \partial_i(\partial^{\mu}\varphi_k)-\partial_i(\partial^{\mu}\varphi_l) \|_{\infty}.
    \end{equation}
    ...
    \end{equation}
    Dans ce cas le théorème \ref{ThoSerUnifDer} nous indique que \( \psi\) est de classe \( C^1\), c'est à dire que \( \varphi\in C^{n+1}(K)\).
\end{proof}
