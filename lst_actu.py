...
myRequest.ok_filenames_list.extend(["65_analyseR"])
myRequest.ok_filenames_list.extend(["67_analyseR"])
myRequest.ok_filenames_list.extend(["64_analyseR"])
myRequest.ok_filenames_list.extend(["66_analyseR"])
myRequest.ok_filenames_list.extend(["173_analyseR"])
myRequest.ok_filenames_list.extend(["68_analyseR"])
myRequest.ok_filenames_list.extend(["69_analyseR"])
