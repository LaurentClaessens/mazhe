...
\begin{enumerate}
    \item
        ...
        \item
            Le lemme \ref{LemYFoWqmS} dit que toute fonction mesurable est limite croissantes de fonctions étagées mesurables.
        \item
...
\end{equation}
            ...
            \begin{proposition}
    L'application \( \pr\) définie en \eqref{EQooOYVNooQwzhRv} est indépendante du choix des bases.
            \end{proposition}
