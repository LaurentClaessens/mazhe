...
\begin{enumerate}
    ...
    \item
        Pour le théorème de Cayley-Hamilton, une preuve est donnée dans le théorème \ref{ThoHZTooWDjTYI} dans le cas de \( \eM(n,\eC)\) en passant par la densité des matrices diagonalisables. Est-ce qu'on peut adapter la démonstration à \( \eM(n,\eK)\) pour tout corps \( \eK\) en passant par une clôture algébrique de \( \eK\), existante par le théorème de Steinitz ?
\end{enumerate}
