...
\begin{itemize}
    \item Calcul d'intégrale par suite équirépartie \ref{ytMOpe}.
    \item Théorème taubérien de Hardy-Littlewood \ref{ytMOpe}.
\end{itemize}
...
\begin{itemize}
    \item Théorème taubérien de Hardy-Littlewood \ref{ytMOpe} parce que l'énoncé revient à dire que \( \lim_{x\to 1^-} \sum_{n\in \eN}a_nx^n=\sum_{n\in \eN}a_n\).
\end{itemize}
