...
\begin{description}
    ...
    \item[Préliminaire de ce qui sera commercialisé]
        ...
        Le Frido sera prochainement commercialisé en trois volumes sur \href{http://www.thebookedition.com/fr/}{thebookedition.com}. En attendant vous pouvez déjà télécharger les fichiers.
        \begin{center}
     ...
     \url{http://laurent.claessens-donadello.eu/pdf/lefrido-vol3.pdf}
        \end{center}
        Ces fichiers là ne seront évidemment pas mis à jour. Ils vous servent à préparer l'agrégation : ils contiennent exactement ce dont vous disposerez (si vous achetez ou si vous convainquez quelque d'acheter pour vous).
