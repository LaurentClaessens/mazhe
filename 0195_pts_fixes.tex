...
\begin{theorem}[Théorème de la fonction implicite en dimension finie] 
...
Nous l'énonçons et le démontrons dans le cas d'espaces de Banach.
\begin{theorem}[Théorème de la fonction implicite dans Banach\cite{SNPdukn}] \label{ThoAcaWho}
    ...
    Alors nous avons des voisinages \( U_0\) de \( x_0\) et \( W_0\) de \( f(x_0,y_0)\) et une unique fonction de classe \( C^r\) 
    \begin{equation}
        g\colon U_0\times W_0\to U
    \end{equation}
    telle que 
    \begin{equation}
        f\big( x,g(x,w) \big)=w
...
\begin{proof}
    ...
    \end{equation}
    nous pouvons par \ref{PropDXR_KbaLC} le choisir un peu plus petit de telle sorte à avoir \( \mP=U_0\times W_0\) où \( U_0\) est un voisinage de \( x_0\) et \( W_0\) un voisinage de \( f(x_0,y_0)\). L'application \( \Phi^{-1}\) a obligatoirement la forme
    \begin{equation}    \label{EqMHT_QrHRn}
        \begin{aligned}
            \Phi^{-1}\colon U_0\times W_0&\to U\times V \\
