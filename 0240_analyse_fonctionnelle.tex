...
%--------------------------------------------------------------------------------------------------------------------------- 
\subsection{Espace \texorpdfstring{$ L^{\infty}$}{Linfinity}}
%---------------------------------------------------------------------------------------------------------------------------
...
\begin{theorem}[\cite{MathAgreg,TLRRooOjxpTp}]  \label{ThoLPQPooPWBXuv}
    Soit \( 1\leq p<\infty\) et un espace mesuré finie \( (\Omega,\tribA,\mu)\). Soit \( q\) tel que \( \frac{1}{ p }+\frac{1}{ q }=1\). Alors l'application
    \begin{equation}
        \begin{aligned}
            \Phi\colon L^q&\to (L^p)' \\
...
\begin{proof}
    ...
    Soit \( \phi\in L^p(\Omega)'\). Si \( \phi=0\), c'est bien dans l'image de \( \Phi\); nous supposons donc que non. Nous allons commencer par prouver qu'il existe une (classe de ) fonction \( g\in L^1(\Omega)\) telle que \( \Phi_g(f)=\phi(f)\) pour tout \(f\in L^{\infty}(\Omega,\mu)\); nous montrerons ensuite que \( g\in L^q\).
    ...
    \begin{subproof}
        ...
        \item[La suite \ldots]
            ...
            \begin{itemize}
                \item L'application \( \Phi_g\colon L^{\infty}\to \eC\) est une isométrie.
                \item Le théorème d'extension d'isométrie \ref{ThoPHllyoB} et la densité de \( L^p\) dans \( L^{\infty}\) nous donne alors une isométrie \( \tilde \Phi_g\colon L^p\to \eC\).
                \item Démontrer que ce \( \tilde \Phi_g\) est également donné par la formule intégrale.
                \item \( g\in L^q\)
                \item \( \| \Phi_g \|_{(L^p)'}=\| g \|_q=\| \phi \|_{(L^p)'}\)
            \end{itemize}
        ...
        \item[\( 1<p<\infty\)]
            ...
            \begin{equation}
                |\int_{E_n}| g |^qd\mu|=|\int_{\Omega}f_n\bar gd\mu|=|\phi(f_n)|\leq \| \phi \|\| f_n \|_p=\| \phi \|\left( \int_{E_n}| f_n |^p \right)^{1/p}=\| \phi \|\left( \int_{E_n}| g |^q \right)^{1/p}.
            \end{equation}
            
            \begin{probleme}
                Cette preuve n'est pas terminée, mais je crois qu'il manque très peu.
            \end{probleme}
