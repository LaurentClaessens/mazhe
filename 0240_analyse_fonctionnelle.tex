...
\begin{theorem}[\cite{MathAgreg,TLRRooOjxpTp}]
...
\begin{proof}
    ...
    \begin{subproof}
        \item[Injection]
            ...
            Soient \( g,g'\in L^q\) tels que \( \Phi_g=\Phi_{g'}\). Alors pour tout \( f\in L^p\) nous avons
            \begin{equation}
        ...
        \item[Surjectif]
            ...
            Soit \( \phi\in L^p(\Omega)'\). Si \( \phi=0\), c'est bien dans l'image de \( \Phi\); nous supposons donc que non. Nous allons commencer par prouver qu'il existe une (classe de ) fonction \( g\) telle que \( \Phi_g(f)=\phi(f)\) pour tout \(f\in L^{\infty(\Omega,\mu)}\); nous montrerons ensuite que \( g\in L^q\).
