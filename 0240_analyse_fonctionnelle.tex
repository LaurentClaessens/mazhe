...
Aucun espace \( L^p\) n'est inclus dans aucun autre ni aucune norme n'est plus grande qu'une autre (sur les intersections). Nous allons donner des exemples de tout ça en supposant \( p<q\).
