...
\begin{definition}
    ...
    \begin{equation}
        H^1(I)=\Big\{   u\in L^2(I)\tq\exists g\in L^2(I)\tq\forall \varphi\in C C^{\infty}_c(I),\int_Iu\varphi'=-\int_Ig\varphi   \Big\}.
    \end{equation}
\end{definition}

\begin{lemma}
    L'élément \( g\in L^2\) dont on parle dans la définition est unique.
\end{lemma}
