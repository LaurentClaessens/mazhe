...
\begin{example}
    ...
    %TODO : il faudrait montrer qu'il existe des fonctions C infini à support compact qui ne sont pas nulles partout.
    ...
    \begin{subequations}
        \begin{align}
            ...
            &=\int_{| \epsilon |>0}\chi(x)\int_0^1\varphi'(\theta x)
        \end{align}
    \end{subequations}
    <++>
