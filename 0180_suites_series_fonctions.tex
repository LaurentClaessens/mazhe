...
\begin{proposition}[\cite{MesureLebesgueLi}]
    ...
    \begin{equation}
        \begin{aligned}
            ...
            X&\mapsto \info\{ \mu(A)\tq A\in\tribF,X\subset A \}. 
        \end{aligned}
    \end{equation}
...
\begin{proof}
    ...
    \item[Intégalité par union dénombrable]
        ...
        Soit \( (X_n)_{n\in \eN}\) une suite de parties de \( S\). Si il existe \( n_0\) tel que \( \mu^*(X_{n_0})=\infty\) alors nous avons automatiquement \( \sum_n\mu^*(X_n)=\infty\) et l'inégalité demandée est évidente parce que n'importe quoi est plus petit ou égal à \( \infty\).
