...
Pour \( x\in \eZ_n\) nous considérons l'application
\begin{equation}
    \begin{aligned}
    ...
    \end{aligned}
\end{equation}
Ce \( \sigma_x\) est un automorphisme du groupe additif (abélien) \( \eZ_n\).

\begin{theorem}[\href{https://fr.wikiversity.org/wiki/Groupe\_(mathématiques)/Automorphismes\_d'un\_groupe\_cyclique}{wikiversité}]
    L'application
    \begin{equation}
        \begin{aligned}
            \sigma\colon \big( \eZ_n^*,\cdot \big)&\to \Aut\big( (\eZ_n,+) \big) \\
            x&\mapsto \sigma_x 
        \end{aligned}
    \end{equation}
    est un isomorphisme.
