...
\begin{proposition}
    Le groupe alterné \( A_5\) est le seul groupe simple d'ordre \( 60\).
\end{proposition}
Une preuve de ce résultat peut être trouvée sur la \wikiversity{fr}{Groupe_(mathématiques)/Exercice/Premiers_résultats_sur_les_groupes_simples}. Nous suivons celle de \cite{Exo7Sylow}.
