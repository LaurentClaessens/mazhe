...
\begin{proposition}
    Soit \( X\) un espace topologique compact et \( (Y,d)\) un espace espace métrique complet. Alors l'espace des fonctions continues \( X\to Y\) muni de la norme uniforme \( \big( C(X,Y),\| . \|_{\infty} \big)\) est complet.
\end{proposition}
