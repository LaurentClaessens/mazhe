...
\end{proposition}
Cette distribution \( \partial^{\alpha}T\) sera la \defe{dérivée distributionnelle}{dérivée!distributionnelle} de \( T\). 

La proposition \ref{PropVLEWffA} (dont la démonstration est mot pour mot la même qu'ici) dira que ce résultat fonctionne aussi bien pour les distributions tempérées.
