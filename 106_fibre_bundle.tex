...
When we have a connection (definition \ref{DEFooIESVooGNQHzl}) we define the divergence of a vector field.
...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
This operation being linear, we can take the trace.
...
Moreover on a Riemannian manifold, we have the Levi-Civita connection (see \ref{subsec_levi}), and then it is possible to particularize the definition \ref{DEFooTTSFooDdgiKg} to a well defined connection.
