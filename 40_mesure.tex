...
\begin{definition}      \label{DefCWATooXqdjlg}
    Une mesure \defe{de Borel}{mesure!de Borel} est une mesure définie sur la tribu borélienne prenant une valeur finie sur tout compact.
\end{definition}
La mesure de Lebesgue qui sera définie plus tard est un exemple de mesure de Borel.
