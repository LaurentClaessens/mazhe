...
\notbool{isBook}{\usepackage[inline]{showlabels}}{}
...
% from https://tex.stackexchange.com/a/640423/109167

% LIMITATION. 
%
% This subproof allows to make two nested subproofs. One should generalize.
%\newcounter{subproofcountMem}
%\newcounter{subproofcount}
%\renewcommand{\thesubproofcount}{\roman{subproofcount}}
%\newcommand{\subprooflabel}[1]{\hspace{-0.5cm}(\thesubproofcount)\hspace\labelsep\underline{\bf #1}}
%\makeatletter
%
%\newcommand{\spitem}[1][]{\@hyper@itemtrue\refstepcounter{subproofcount}\csname @item\endcsname[#1]}
%\makeatother
%\newenvironment{subproof}{
%	\setcounter{subproofcountMem}{\value{subproofcount}}
%	\list{subproofcount}{\usecounter{subproofcount}\let\makelabel=\subprooflabel}}%
%{\endlist
%	\setcounter{subproofcount}{\value{subproofcountMem}}
%}
%%
