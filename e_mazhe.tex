...
\newcommand{\thenumtho}{\thechapter.\arabic{equation}}
%\renewcommand{\thenumtho}{\thechapter.\arabic{equation}}

% The ifthenelse line here serves to write something in parenthesis if the optional argument is given.
\newenvironment{example}[1][]%
{\vspace{\EnvSpace}\refstepcounter{equation}\noindent{\bf Exemple \thenumtho}%
...
\theoremstyle{MyRemarks}    \newtheorem{remark}[equation]{Remarque}
                ...
                \newtheorem{amusement}[equation]{Amusement}
                \newtheorem{erreur}[equation]{Error}
