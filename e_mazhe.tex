...
%\newcommand{\EpsOrPdfincludegraphics}[2][]{ \ifpdf \includegraphics[#1]{#2.png} \else \includegraphics[#1]{#2.eps} \fi }
...
%\newcommand{\RR}{\eR}        % TODO : à traquer et enlever.
...
% LES NEWCOMMAND POUR DES CARACTÈRES «SPÉCIAUX» 
...
Copyright (c) 2011-2015  Laurent Claessens, Carlotta Donadello
...
\LaTeX\ source files are available at\\ \url{https://github.com/LaurentClaessens/mazhe} 
