...
\begin{center}
        ...
        \emph{Le Frido} de \href{http://laurent.claessens-donadello.eu/}{Laurent Claessens} est mis à disposition selon les termes de la licence \href{http://creativecommons.org/licenses/by-nc-nd/3.0/fr/}{licence Creative Commons Attribution - Pas d’Utilisation Commerciale - Pas de Modification 3.0 France.}.

        Une version plus à jour de ce texte, publiée sous la \href{http://fr.wikipedia.org/wiki/FDL}{licence GNU-FDL} est disponible sur \href{http://laurent.claessens-donadello.eu/pdf/lefrido.pdf}{le site de l'auteur}.
    }
\end{center}
