...
% We do not ask for a separate repertory because we want phystricks to be able to remove the pdf files when changed.
...
%\usepackage{undertilde}        % Supprimé le 18 juillet 2014
...
% Supprimé le 23 décembre 2013 parce que frenchb a mieux en la personne de \ieme
...
% J'ai décidé de mettre les théorèmes et les équations dans le même compteur le 12 mars 2014.
...
%\newcommand{\thenumtho}{\thechapter.\arabic{numtho}}
...
%\newenvironment{normaltext}[1][] {\refstepcounter{numtho}\noindent{\bf \thenumtho}\ifthenelse{\equal{#1}{}}{}{(#1)}\newline}{}
%\renewcommand{\ref}[1]{[[{\bf \Oldref{#1}}]}
...
%\DeclareMathOperator{\Jac}{Jac} % jacobienne    Supprimé le 5 mars 2014
...
\LaTeX\ source files are available at\\ \url{https://www.gitorious.org/mes-notes-de-math-matique} 
