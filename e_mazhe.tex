...
\newcommand{\randomGender}[2]{%
                ...
                \ifthenelse{\isodd{\value{tmpcounter}}}{#1}{#2}%
}
...
\theoremstyle{MyProblems}
            \newtheorem{probleme}[numtho] {
                \setcounter{tmpcounter}{%
                    \numexpr\value{page}+\value{numtho}\relax%
}
                \ifthenelse{\isodd{\value{tmpcounter}}}{¡¡ Avertissement/question au lecteur !!}{¡¡ Avertissement/question à la lectrice !!}
            }
