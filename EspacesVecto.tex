...
\end{equation}
Cette notion d'orthogonal dans le dual est un peu plus générale que la notion d'orthogonal usuelle qui serait
\begin{equation}
    F^{\perp}=\{ y\in E\tq \forall x\in F,y\cdot x=0 \}.
\end{equation}
En effet cette dernière définition demande la donnée d'un produit scalaire. Évidemment dans le cas de \( \eR^n\) munie du produit scalaire usuel et de l'identification usuelle entre \( \eR^n\) et \( (\eR^n)^*\) via une base, les deux notions d'orthogonal coïncident.
...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
\section{Matrice compagnon, endomorphismes cycliques et décomposition de Frobenius}
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
\begin{proof}
    ...
    Nous avons donc trouvé \( F\), stable par \( f\) et tel que \( E=E_y\oplus F\). Nous devons maintenant nous assurer que cette décomposition tombe bien pour les polynômes minimaux.
...
<++>
    ...
    \begin{equation}
        ...
        \end{pmatrix}
    \end{equation}
Le coup du ppcm vient de \cite{MoncetIVS}.
