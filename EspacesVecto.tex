...
\begin{definition}
    Un endomorphisme \( u\) d'un espace vectoriel est \defe{semi-simple}{semi-simple!endomorphisme} si tout sous espace stable par \( u\) possède un supplémentaire stable.
\end{definition}
...
\begin{theorem}[Décomposition de Dunford]\index{décomposition!Dunford}\index{Dunford!décomposition}
    ...
    \begin{equation}
        u=s+n
    \end{equation}
    où \( s\) est semi-simple, \( n\) est nilpotent et \( [s,n]=0\).
