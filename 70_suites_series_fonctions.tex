...
Nous avons déjà vu la mesure de Lebesgue (définition \ref{DefooYZSQooSOcyYN}) ainsi que la façon dont une intégrale lui est associée (définition \ref{DefTVOooleEst}
...
\begin{normaltex}   \label{NORMooDSNXooFhyHkx}
