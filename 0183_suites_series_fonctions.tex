...
\begin{remark}
    La proposition \ref{PropWBavIf} dit qu'une fonction positive, mesurable et bornée peut être écrite comme limite de fonctions simples. Ce fait permet de démontrer des théorèmes en commençant par prouver sur les fonctions simples et en utilisant Beppo-Levi pour généraliser.
\end{remark}
