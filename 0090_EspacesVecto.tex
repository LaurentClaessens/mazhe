...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[La cas général]
            ...
            Étant donné que le cas complexe (et a fortiori entier) est déjà prouvé nous savons que pour tout \( u\in \eM(n,\eZ)\) nous avons \( P(u_{11},\ldots, u_{nn})=0\). La proposition \ref{PropRLJooNUZuif} nous donne effectivement \( P=0\).
