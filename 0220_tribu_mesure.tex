...
\begin{theorem}[Prolongement de Hahn\cite{MesureLebesgueLi}]
    Soit \( \tribA\) une algèbre de parties d'un ensemble \( S\) et \( \mu\) une mesure sur \( (S,\tribA)\). Soit \( \tribF=\sigma(\tribA)\) l'algèbre engendrée par \( \tribA\). Alors
    \begin{enumerate}
        \item
