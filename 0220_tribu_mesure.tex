...
\begin{theorem}[Complétion d'espace mesuré\cite{MesureLebesgueLi}]   \label{thoCRMootPojn}
    Soit un espace mesuré \( (X,\tribF,\mu)\) et \( \tribN\) l'ensemble des parties \( \mu\)-négligeables de \( X\). Nous posons
    \begin{enumerate}
        \item
            \begin{equation}
            ...
            \end{equation}
        \item 
            \begin{equation}\label{EqFJIoorxZNU}
...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[Tribu complète]
            Tout ensemble négligeable est dans l'ensemble \( \tribB\) défini en \eqref{EqFJIoorxZNU}.
