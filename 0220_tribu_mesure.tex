...
\begin{definition}[Algèbre de parties\cite{MesureLebesgueLi}]
    ...
    \begin{enumerate}
        ...
        \item
            \( A\in\tribD\) implique \( A^c\in\tribD\)
        \item
            \( A,B\in\tribD\) implique \( A\cup B\in\tribD\).
    \end{enumerate}
\end{definition}
...
\begin{lemma}[\cite{MesureLebesgueLi}]
...
\begin{proof}
    ...
    \item[Intégalité par union dénombrable]
        ...
        Soit \( \epsilon>\) et par définition pour chaque \( n\), il existe un \( A_n\in \tribD\) tel que \( X_n\subset A_N\) et \( \mu(A_n)\leq \mu^*(X_n)+\frac{ \epsilon }{ 2^n }\). Bien entendu nous avons
        \begin{equation}
            \bigcup_nX_n\subset \bigcup_nA_n\in\tribD.
        \end{equation}
        Nous en déduisons que
        \begin{equation}
            \mu^*\big( \bigcup_nX_n \big)\leq\mu\big( \bigcup_nA_n \big).
        \end{equation}
        Mais \( (S,\tribD,\mu)\) étant un espace mesuré,
        \begin{equation}
            \mu\big( \bigcup_nA_n \big)\leq \sum_n\mu(A_n).
        \end{equation}
    ...
    Supposons que \( X\in\tribD\). Alors si \( X\subset A\) nous avons \( \mu(X)\leq \mu(A)\); mais en même temps, \( \mu(X)\) est dans l'infimum qui définit \( \mu^*(X)\) donc
    \begin{equation}
        \mu^*(X)\leq\mu(X)\leq \inf \{ \mu(A)\tq A\in\tribD,X\subset A \}\leq \mu(X)\leq\mu^*(X).
    \end{equation}
...
%---------------------------------------------------------------------------------------------------------------------------
\subsection{Tribus et ensembles mesurables}
%---------------------------------------------------------------------------------------------------------------------------
...
\begin{definition}[\cite{PVWUyDH}]
    Soit \( E\) un ensemble. Un ensemble \( \tribD\) de parties de \( E\) est un \defe{\( \lambda\)-système}{$\lambda$-système} si
    \begin{enumerate}
        \item
...
Cela est un cas particulier de \ref{PropIUOoobjfIB} en utilisant \ref{LemULSooBgZLI}.
