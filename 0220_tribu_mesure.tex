...
\begin{definition}[Mesure positive]  \label{DefBTsgznn}
    ...
    \begin{enumerate}
        ...
        \item   \label{ItemQFjtOjXiii}
            \( \mu\left( \bigcup_{i=0}^{\infty}A_i\right)=\sum_{i=0}^{\infty}\mu(A_i)\) si les \( A_i\) sont des éléments de \( \tribA\) deux à deux disjoints. Le triple \( (\Omega,\tribA,\mu)\) est alors un \defe{espace mesuré}{espace!mesuré}.
    \end{enumerate}
