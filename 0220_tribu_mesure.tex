...
\begin{remark}
    ...
    \begin{enumerate}
        \item
            Il existe des ensembles mesurables non-boréliens. Je crois qu'un exemple est construit dans \cite{SFYoobgQUp}. Cela n'utilise pas l'axiome du choix et est relativement explicite.
        \item
