...
\begin{proposition}
    Soit un espace mesuré \( (S,\tribF,\mu)\) et \( \mu^*\) la mesure extérieure qui va avec. Alors pour tout \( A\in\tribF\) et \( X\subset S\) nous avons
    \begin{equation}
...
\begin{definition}
    L'espace mesuré \( (X,\tribA,\mu)\) est \defe{complet}{complet!espace mesuré} si tout ensemble négligeable est dans \( \tribA\).
\end{definition}

%AFAIRE : retrouver la page de les-mathematiques.net qui fait l'égalité A=B=C et la citer ici.
%AFAIRE : citer Wikipédia pour l'énoncé du théorème suivant.
\begin{theorem}[Complétion d'espace mesuré\cite{MesureLebesgueLi}]   \label{thoCRMootPojn}
    Soit un espace mesuré \( (X,\tribF,\mu)\) et \( \tribN\) la tribu des ensembles \( \mu\)-négligeables. Nous posons
    \begin{enumerate}
        \item
            \begin{equation}
        ...
        \item 
            \begin{equation}
        \tribB=\{ B\cup N\tq  B\in\tribF,N\in\tribN \}
            \end{equation}
        \item
            \begin{equation}
    ...
    \begin{enumerate}
        \item
            \( \tribA=\tribB=\tribC\),
        \item
            \( \tribA\) est une tribu complète.
        \item
            Poser \( \mu'(A\cup N)=\mu(A)\) pour tout \( A\in\tribF\) et \( N\in\tribN\) est une définition cohérente de \( \mu'\) et l'application \( \mu'\) ainsi définie est une mesure sur \( (X,\tribA)\).
        \item
            La mesure \( \mu'\) est complète et prolonge \( \mu\).
        \item
...
\begin{definition}
    La tribu définie par le théorème \ref{ThoCRMootPojn} est la \defe{tribu complétée}{tribu!complétée} de \( \tribA\) pour la mesure \( \mu\).
\end{definition}
...
\begin{theorem}[Carathéodory\cite{MesureLebesgueLi}]
    ...
    \begin{enumerate}
        ...
        \item
            l'espace mesuré \( (S,\tribM,m^*)\) est complet.
%TODO : référentier ici à la définition d'espace mesuré complet.
    \end{enumerate}
\end{theorem}
