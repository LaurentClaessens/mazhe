...
\begin{definition}
    Nous notons \( E_{ij}\) la matrice qui possède uniquement \( 1\) en position \( (i,j)\).

    Une matrice de \defe{transvection}{transvection} est une matrice de la forme 
    \begin{equation}
        T_{ij}(\lambda)=\mtu+\lambda E_{ij}
    \end{equation}
    avec \( i\neq j\) et \( \lambda\in \eK\).

    Une matrice de \defe{dilatation}{dilatation} est une matrice diagonale de la forme 
    \begin{equation}
