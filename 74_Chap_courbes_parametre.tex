...
\begin{definition}  \label{DEFooCTEVooLtAjDY}
    Une courbe \( \gamma\colon \mathopen[ a , b \mathclose]\to \eR^n\) est \defe{régulière}{courbe!régulière} si elle est de classe \(  C^{\infty}\) et si \( \| \gamma'(t) \|\neq 0\) pour tout \( t\).
\end{definition}
Note : dans le lemme \ref{LEMooUECMooNBDGiR} et ses dépendances, nous utilisons effectivement que l'arc \( \gamma\) est de classe \( C^1\).
