...
\begin{definition}  \label{DEFooCTEVooLtAjDY}
    Une courbe \( \gamma\colon \mathopen[ a , b \mathclose]\to \eR^n\) est \defe{régulière}{courbe!régulière} si elle est différentiable et si \( \| \gamma'(t) \|\neq 0\) pour tout \( t\).
\end{definition}
