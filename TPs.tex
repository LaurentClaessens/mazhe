...
\[\ba{l}\dfdx(x,y) = \frac{1}{y}\ln(\frac{x}{y})e^{\frac{x}{y}}+\frac{1}{x}e^{\frac{x}{y}}\\
            \dfdx(1,1)=e\\
            \dfdy(x,y)=-\frac{x}{y^2}\ln(\frac{x}{y})e^{\frac{x}{y}}-xe^{\frac{x}{y}}\\
            \dfdx(1,1)=e\ea\]
...
\[\ba{lclllllcl}\dgudr(r,\theta) &=&\cos(\theta)& & & & \dgudth(r,\theta)   & =&-r\sin(\theta)\\
            \dgudr(\sqrt2, \frac{\pi}{4})&=&\frac{\sqrt2}{2}& & &&\dgudth(\sqrt2, \frac{\pi}{4})& =&-1 \\
            \dgddr(r,\theta) &=&\sin(\theta)&  && &\dgddth(r,\theta)  &=&r\cos(\theta) \\
            \dgddr(\sqrt2, \frac{\pi}{4})&=&-\frac{\sqrt2}{2}&& & &\dgddth(\sqrt2, \frac{\pi}{4})& = &1\ea\]
...
\noindent 32.
\begin{enumerate}
\item $\dgdu = e^v\dfdx(\star,\star)+2uv\dfdy(\star,\star)$
\item $\dgdv = ue^v\dfdx(\star,\star)+(1+u^2)\dfdy(\star,\star)$
\end{enumerate}
...
\begin{enumerate}
\item $h'(t)=\dfdx(\star,\star)+\dfdy(\star,\star)2tg'(t^2)$
\item $ \ba{rl} h''(t)=     &   \ddfdx(\star,\star)+4tg'(t^2)\ddfdxy(\star,\star)+4t^2(g'(t^2))^2\ddfdy(\star,\star) \\           
                    & +[2g'(t^2)+4t^2g''(t^2)]\dfdy(\star,\star)\ea$
...
\begin{enumerate}
\item $\dldu(u,v) = \dfdx(\star,\star)g'(ue^v)e^v + \dfdy(\star,\star)g(v)2u$
\item $\dldv(u,v) = \dfdx(\star,\star)g'(ue^v)ue^v+\dfdy(\star,\star)g'(v)(1+u^2)$
\end{enumerate}
...
\begin{enumerate}
\item $\dhdu = [g'(u+v)\ln(l(u,v))+\frac{g(u+v)}{l(u,v)}\dldu(u,v)] l(u,v)^{g(u+v)}$
\item $\dhdv = [g'(u+v)\ln(l(u,v))+\frac{g(u+v)}{l(u,v)}\dldv(u,v)] l(u,v)^{g(u+v)}$
\end{enumerate}
...
\item  $\rightarrow \left\{\ba{c}e \; {\rm si}\;xy\neq0\\
...
\begin{enumerate}
\item si $u\neq(\pm1,0)$.\\
$\dfdu(1,0) \;=\;\lim_{t\rightarrow 0}\frac{e-e}{t}\;=\;0$.
\item si $u=(\pm1,0)$, i.e. si $u=(1,0) = e_1$\\
$\dfdu(1,0) = \dfdx(1,0)=\lim_{t\rightarrow 0}\frac{f(1+t,0)-e}{t}=\lim_{t\rightarrow 0}\frac{e^{1+t}-e}{t} =^H0$.
\end{enumerate}
\end{enumerate}
...
\item         $\rightarrow \left\{\ba{c}\frac{x}{y} \; {\rm si}\;y\neq0\\
                               0\;{\rm sinon} \ea\right.}$\\
                   
Continue et différentiable sur $\eR-\{y=0\}$. Sur l'axe $y=0$ elle n'est pas continue.         
                   
\item         $\rightarrow \left\{\ba{l}x+ay \; {\rm si}\;x>0\\
                                               x\;{\rm sinon} \ea\right.}$\\
...
\item     $\rightarrow \left\{\ba{c}\frac{xy^5}{x^6+y^6} \; {\rm si}\;x\neq y\\
                               0\;{\rm sinon} \ea\right.}$\\
...
\begin{enumerate}
\item $\dfdu = 3u^2+24uv$
\item $\dfdv = 12u^2-15v^2$
\end{enumerate}
\item $(u,v)\rightarrow  f(u^2)\ln(v)$\\
\begin{enumerate}
\item $\dfdu = 2uf'(u^2)\ln(v)$
\item $\dfdv = \frac{f(u^2)}{v}$
\end{enumerate}
\item $(x,y)\rightarrow \tan(x+y^2)$\\
\begin{enumerate}
\item $\dfdx =\frac{1}{cos^2(x+y^2)}$
\item $\dfdv = \frac{2y}{cos^2(x+y^2)}$
\end{enumerate} 
\item $(r,\theta)\rightarrow  r^\theta$
\begin{enumerate}
\item $\dfdr =\theta r^{\theta-1}$
\item $\dfdth =\ln(r)r^\theta$
\end{enumerate}
...
\begin{enumerate}
\item $\dfdu = \frac{vf'(uv)}{f(uv)}$
\item $\dfdv = \frac{uf'(uv)}{f(uv)}$
...
\item $\dgdv = ue^v\dfdx(\star,\star)+(1+u^2)\dfdy(\star,\star)$
\end{enumerate}
o\`{u} $\dfdx(\star,\star) = \dfdx(ue^v,v(1+u^2))$ et $\dfdy(\star,\star) = \dfdy(ue^v,v(1+u^2))$.
