...
myRequest.add_plugin(PytexTools.keep_script_marks(
    plugins_agreg.mazhe_mark_list), "before_pytex")
myRequest.add_plugin(plugins_agreg.set_boolean(
    "isGiulietta", "true"), "before_pytex")
