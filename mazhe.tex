...
\ifthenelse{\value{useexternal}=1}{ \usetikzlibrary{external} \tikzexternalize[prefix=pictures_tikz/] }{ \newcommand{\tikzsetnextfilename}[1]{} } 
...
\emptyInputPath
\addInputPath{src_front_back_matter}
...
% Il faut remettre ici le 98_liste_developpements avant de publier.
