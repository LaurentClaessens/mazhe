...
\chapter{Les naturels et les entiers}
\input{42_nombres}
\input{239_nombres}
\input{216_nombres}

\chapter{Théorie des groupes (début)}
\input{46_groupes}
\input{47_groupes}
...
\chapter{Les rationnels, les réels et les complexes}
\input{240_nombres}
\input{217_nombres}

\chapter{Théorie des groupes (suite)}
\input{254_groupes}
