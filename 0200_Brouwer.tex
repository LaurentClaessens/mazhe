...
\begin{enumerate}
    ...
    \item
        Dans \( \eR^2\) via l'homotopie, théorème \ref{ThoLVViheK}. Oui, c'est très loin. Et c'est normal parce que ça va utiliser la formule de l'indice qui est de l'analyse complexe\footnote{On aime bien parce que ça ne demande pas Stockes, mais quand même hein, c'est pas gratos non plus.}.
\end{enumerate}

\begin{proposition}[Brouwer dans \( \eR^n\) version \(  C^{\infty}\) via Stockes]     \label{PropDRpYwv}
...
\begin{proof}
   ...
   Le point \( g(x) \) est la solution du système
    ...
    \begin{enumerate}
        \item
            elle est \(  C^{\infty}\) parce que \( f\) l'est; cela est le contenu du début de la preuve du théorème \ref{}<++>
        \item
