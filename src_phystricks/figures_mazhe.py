...
figures_list.append(YQVHooYsGLHQ)
figures_list.append(ZGUDooEsqCWQ)
figures_list.append(HGQPooKrRtAN)
figures_list.append(KKLooMbjxdI)
...
figures_list.append(NOCGooYRHLCn)
figures_list.append(BEHTooWsdrys)
...
figures_list.append(SYNKooZBuEWsWw)
...
figures_list.append(ERPMooZibfNOiU)
...
figures_list.append(AMDUooZZUOqa)
...
figures_list.append(LMHMooCscXNNdU)
figures_list.append(SJAWooRDGzIkrj)
figures_list.append(UCDQooMCxpDszQ)
figures_list.append(EELKooMwkockxB)
