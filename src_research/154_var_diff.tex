...
\begin{definition}[\cite{ooBTXRooUEBLMV}]       \label{DEFooITDTooWwrPPr}
    If \( \omega\) is a \( n\)-form on \( M\) and if \( \{ f_{\alpha} \} \) is a partition of unity\footnote{Definition \ref{DEFooWDRGooHijhtn}.} subordinate to the finite atlas \( \{ U_{\alpha} \}\) then
    \begin{equation}
