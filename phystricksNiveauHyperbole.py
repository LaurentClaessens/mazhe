...
R=Point(0,1)
S=Point(0,-1)
P.put_mark(0.1,135,"$P$",automatic_place=pspict)
Q.put_mark(0.1,45,"$Q$",automatic_place=pspict)
R.put_mark(0.1,-45,"$R$",automatic_place=pspict2)
S.put_mark(0.1,45,"$S$",automatic_place=pspict2)
