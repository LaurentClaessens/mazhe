...
\begin{theorem}[Dérivation sous le signe intégral\cite{MesIntProbb}]
    ...
    \begin{enumerate}
        ...
        \item
            ...
            \end{equation}
            pour tout \( x\in B(a,\omega)\) et \( \omega\in\complement A\).
    \end{enumerate}
    Alors la fonction
    \begin{equation}
        F(x)=\int_{\Omega}f(x,\omega)d\mu(\omega)
...
Le théorème suivant est plus restrictif sur l'ensemble d'intégration (qui doit être compact), mais accepte des fonctions de plusieurs variables.
