...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
\section{Corrigez vous vous même}
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

%---------------------------------------------------------------------------------------------------------------------------
\subsection{Propagande : utilisez votre ordinateur !}
%---------------------------------------------------------------------------------------------------------------------------

De nos jours, les ordinateurs sont capables de faire à peu près tous les calculs dont vous avez besoin. Pourquoi s'en priver pour se corriger soi-même lorsqu'on fait des exercices ? 

% Pour la commande \st, c'est le paquet soul
De nombreuses universités ou collègues vous suggèrent \st{de pirater} d'utiliser Matlab. Je vous propose plutôt d'utiliser \href{http://sagemath.org}{Sage} dont les possibilités de programmation sont nettement plus nombreuses.

Pour l'utiliser, il n'est même pas nécessaire de l'installer sur votre ordinateur~: il tourne en ligne, directement dans votre navigateur.

\begin{enumerate}

	\item
		Allez sur \href{http://www.sagenb.org}{http://www.sagenb.org}
	\item
		Créez un compte
	\item
		Créez des feuilles de calcul et amusez vous !
...
Si vous comptez utiliser régulièrement ce logiciel, je vous recommande \emph{chaudement} de \href{http://mirror.switch.ch/mirror/sagemath/index.html}{l'installer} sur votre ordinateur\footnote{Le paquet sagemath fourni par Ubuntu dans Karmic est très bogué, ne l'utilisez pas. Si vous avez une version plus récente d'Ubuntu, renseignez vous.}. Ce logiciel étant distribué sous licence GPL, vous ne devez ni payer ni vous procurer de codes.

%---------------------------------------------------------------------------------------------------------------------------
\subsection{Ce que Sage peut faire pour vous}
%---------------------------------------------------------------------------------------------------------------------------

Pour certaines choses complexes, j'ai tapé un module nommé \verb+outilsMAT1151+. Pour l'obtenir, allez sur \href{http://www.gitorious.org/math1151}{gitorious}. et téléchargez le fichier \verb+outilsINGE.py+ ainsi que tous les fichiers dont le nom termine par \verb+.sage+. Ces derniers contiennent le code qui fournit les réponses pour un certain nombre d'exercices.

Voici une liste absolument pas exhaustive de ce que Sage peut faire pour vous, avec des exemples. 
\begin{enumerate}

	\item
		Calculer le conditionnement d'un problème, voir exercice \ref{exoSerieQuatre0008}.
	\item
		Tracer des fonctions, voir exercice \ref{exoSerieQuatre0007}.
	\item
		Calculer des limites, des dérivées, intégrer, calculer des valeurs propres de matrices et diagonaliser, voir la note sur Sage dans \href{http://student.ulb.ac.be/~lclaesse/geog.pdf}{le cours de math générale}.
