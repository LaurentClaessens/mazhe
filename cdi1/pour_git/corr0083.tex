...
Affin de prouver que la boule est ouverte, nous allons utiliser le théorème \ref{ThoPartieOUvpartouv} : nous prenons un point $p\in B(x,r)$, et nous allons montrer qu'il existe une boule autour de $p$ qui est contenue dans $B(x,r)$.
