...
\begin{equation*}
  \limite x 0 f(x) =
  \begin{arrowcases}
    \limite[x > 0] x 0 \frac{2x + a}{1 + \exp{\frac1x}} = 0\\
    \limite[x < 0] x 0 \frac{2x + a}{1 + \exp{\frac1x}} = a
  \end{arrowcases}
\end{equation*}
...
\begin{equation*}
  ...
  \begin{arrowcases}
    \limite[x > 0] x 0 \frac{2}{1 + \exp{\frac1x}} = 0\\
    \limite[x < 0] x 0 \frac{2}{1 + \exp{\frac1x}} = 2\\
  \end{arrowcases}
\end{equation*}
...
\begin{equation*}
  \limite[x\neq 0] x 0 \frac{f(x)}x =
  \begin{arrowcases}
    \limite[x> 0] x 0 \frac{\exp{\frac{-1}x}}x = \limite[x> 0] x 0
    \frac{\frac 1x}{\exp{\frac{1}x}} = \limite[x> 0] x 0
    \frac{1}{\exp{\frac{1}x}} = 0\\
    \limite[x < 0] x 0 0 = 0
  \end{arrowcases}
\end{equation*}
...
\begin{equation*}
  f^\prime(x) =
  \begin{cases}
    \frac{1}{x^2}\exp{\frac{-1}x} & \text{si $x >0$}\\
    0 & \text{si $x \leq 0$}
  \end{cases}
\end{equation*}
