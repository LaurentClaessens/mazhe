...
\end{definition}
Ce qui est bien avec de jeu de définition, c'est qu'un ensemble fini n'est ni dénombrable ni non dénombrable.
...
\begin{lemma}   \label{LemFUIZooBZTCiy}
    Si \( A\) est une partie du groupe \( G\), alors le sous-groupe engendré par \( A\) est l'ensemble de tous les produits finis d'éléments de \( A\) et de \( A^{-1}\) (l'identité est le produit à zéro éléments).
\end{lemma}
...
Les équations diophantiennes sont nombreuses et utilisent diverses techniques. Voici une liste des autres équations diophantiennes présentes ailleurs.
\begin{itemize}
    ...
    \item Le dénombrement des solutions de l'équation \( \alpha_1 n_1+\ldots \alpha_pn_p=n\) utilise des séries entières et des décomposition de fractions en éléments simples.
\end{itemize}
