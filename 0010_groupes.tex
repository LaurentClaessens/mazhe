...
\begin{proposition}
    Le groupe dérivé de \( G\) est l'ensemble des produits finis de commutateurs.
\end{proposition}

\begin{proof}
    Nous nommons \( S_m\) l'ensemble des produits de \( m\) commutateurs de \( G\); nous devons prouver que 
    \begin{equation}
