...
\begin{proposition}[\cite{HQRooKGAfpu}]
...
\begin{proof}
    ...
    Il faut donc encore montrer le sens direct. Nous supposons que \( G\) est un groupe résoluble et nous étudions sa suite dérivée.
\end{proof}
<++>
