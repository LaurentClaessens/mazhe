...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
où la troisième ligne est la définition de \( r_{k+2}\) et de \( q_{k+1}\) en fonction de \( r_k\) et \( r_{k+1}\). La suite \( (r_k)\) ainsi construite est strictement décroissante et à chaque étape le lemme \ref{LemiVqita} et le principe de l'algorithme d'Euclide nous donne
\begin{subequations}
    \begin{numcases}{}
