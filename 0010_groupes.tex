...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
où la troisième ligne est la définition de \( r_{k+2}\) et de \( q_{k+1}\) en fonction de \( r_k\) et \( r_{k+1}\). La suite \( (r_k)\) ainsi construite est strictement décroissante et à chaque étape nous avons
\begin{equation}
...
La difficulté est de construire la suite qui donne Bézout. Elle va être construite à l'envers. Nous voulons trouver les couples \( (u_k,v_k)\) de telle façon à avoir à chaque étape
\begin{equation}
