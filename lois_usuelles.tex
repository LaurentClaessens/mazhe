...
Il se passe donc en moyenne \( \lambda\) événements par seconde. Le nombre d'événements se produisant en une seconde suit une loi de Poisson de paramètre \( \lambda\) par la proposition \ref{}<++>
