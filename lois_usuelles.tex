...
Il se passe donc en moyenne \( \lambda\) événements par seconde. Le nombre d'événements se produisant en une seconde suit une loi de Poisson de paramètre \( \lambda\) par la proposition \ref{PropGMntiy}.
...
(x, y) |--> a*b/(a^2 + a*b)
    ...
    \begin{subequations}
        \begin{align}
            ...
            &=\big( 1-F_X(t) \big)\big( 1-T_Y(t) \big)\\
