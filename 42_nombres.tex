...
\begin{probleme}
    Une inconsistance dans les notations et le vocabulaire en ce qui concerne \( \eR^+\), \( \eR^-\) et le fait que zéro soit dedans ou non  m'a été signalée. Nous avons tranché pour les conventions données dans la remarque \ref{REMooOCXLooKQrDoq} qui sont aussi celles de \href{https://fr.wikipedia.org/wiki/Nombre_positif}{  kipédia}, mais il n'est pas exclu qu'il y ait des incohérences par-ci par-là dans le texte. Merci de me les signaler. 
\end{probleme}
