...
\begin{theorem}
    Soit un espace de probabilité \( (\Omega,\tribA,P)\) et une variable aléatoire intégrable \( X\colon \Omega\to \eR\). Pour chaque sous tribu \( \tribF\) de \( \tribA\), il existe une (presque partout) unique fonction \( Y\colon \Omega\to \eR\) telle que
    \begin{enumerate}
        \item
...
\begin{proof}
    ...
    \begin{description}
        ...
        \item[Existence dans le cas de carré intégrable]
            ...
            \begin{equation}
                \int_{\Omega}X\mtu_A=\int_{\Omega}X\mtu_A,
            \end{equation}
            ou encore
            \begin{equation}
                \int_AY=\int_AX.
        ...
        \item[Existence en général] 
            ...
            Pour chaque \( n\) nous avons donc une variable aléatoire \( Y_n=\pr_KX_n\) étant \( \tribF\)-mesurable et telle que
            \begin{equation}
                \int_A X_n=\int_AY_n
            \end{equation}
