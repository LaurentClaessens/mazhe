...
\begin{InternalLinks}
    Quelque liens internes d'utilisation du théorème de Bézout.
    \begin{enumerate}
        \item
...
\begin{proof}
    ...
    \begin{subproof}
        ...
        \item[Existence]
            ...
            \end{equation}
            qui est encore un quotient d'entiers parce que \( \pgcd(a,b)\) divise aussi bien \( a\) que \( b\).
    \end{subproof}
\end{proof}

% À mon avis le lemme suivant ne sert à rien.
\begin{lemma}
    Les nombres \( p\) (\( p\in \eN\)) et \( p^2\) ont les mêmes facteurs premiers.
\end{lemma}
...
\begin{InternalLinks}
    Les équations diophantiennes sont nombreuses et utilisent diverses techniques. Voici une liste de liens internes vers d'autres équations diophantiennes présentes ailleurs.
    \begin{itemize}
