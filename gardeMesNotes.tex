...
\begin{center}
    ...
    \ifthenelse{\value{isAgreg}=0}{\today}{2014}\\
    \url{http://student.ulb.ac.be/~lclaesse/mes_notes.pdf}
    \ifthenelse{\value{isAgreg}=0}{}{\url{http://student.ulb.ac.be/~lclaesse/mes_notes-2014.pdf}}
    ...
    \ifthenelse{\value{isAgreg}=0}{}{Ceci est une version préliminaire de celle qui sera (peut-être) dans la bibliothèque d'agrégation en 2015.}
