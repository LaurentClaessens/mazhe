...
\begin{description}
    ...
    \item[Les mises à jour] Ce document est régulièrement mis à jour. Des fautes d'orthographe sont corrigées (presque) chaque jour. Si vous me signaliez une faute de mathématique, elle sera corrigée.
    \item[Transparence] Je ne fais pas semblant que ces notes soient parfaites. Les points sur lesquels je ne suis pas sûr, les preuves que j'ai inventées moi-meême sont clairement indiqués pour inciter le lecteur à doubler de prudence. Une liste de questions à résoudre est inclue en \ref{SecooCKWWooBFgnea}.
