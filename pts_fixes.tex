...
\begin{proof}
    ...
    \end{equation}
    La relation cherchée s'obtient alors par récurrence. Soient \( q>p\). En utilisant une somme téléscopique,
    \begin{subequations}
        \begin{align}
    ...
    En ce qui concerne les inégalités \eqref{EqKErdim}, nous refaisons une somme téléscopique :
    \begin{subequations}
        \begin{align}
