...
% \psset{PointName=+}
% \pstGeonode[PosAngle={90,90,90,90,-90},PointSymbol={none,default,default,default,default,none}, CurveType=curve]
%        (-1.5,-0.5){Ou}(0.5,-0.3){Au}(2,1){Bu}(3.5,1.5){Cu}(5,2.7){Du}(5.8,2.7){Fu}
%\end{pspicture}
%\end{figure}
