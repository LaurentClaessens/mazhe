...
\begin{theorem}[\cite{fJhCTE}] \label{ThoDIDNooUrFFei}
...
\begin{proof}
    ...
    La technique pour déterminer la valeur de \( S_n\) est alors de développer \( F(z)\) en série et d'identifier le coefficient de \( z^n\) parce que nous venons de voir que ce coefficient est \( S_n\).
\end{proof}
<++>
