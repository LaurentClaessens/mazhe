...
Pour la suite nous notons \( y\) une solution de l'équation \( y'=y\), \( y(0)=1\), et nous allons en donner des propriétés indépendamment de l'existence, donnée par le théorème \ref{ThoKRYAooAcnTut}. qui et qui peut être obtenue via les logarithmes en l'équation \eqref{EqNQDDooYBbARn}.
...
\begin{proposition}[Unicité de l'exponentielle]
