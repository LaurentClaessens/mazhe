...
Nous cherchons maintenant les représentations \( \rho\colon D_n\to \End(\eC^2)\). Soit \( \omega= e^{2i\pi/n}\) et \( h\in \eZ\); nous considérons la représentation \( \rho^{(h)}\) de \( D_n\) définie par
\begin{subequations}
    \begin{align}
