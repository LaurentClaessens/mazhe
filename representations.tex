...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
\section{Représentation régulière}
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
\begin{lemma}
    Un groupe n'a (à équivalence près) qu'un nombre fini de représentations irréductibles.
\end{lemma}
...
\begin{corollary}
    Deux représentations ayant même caractères sont équivalentes.
\end{corollary}

\begin{proof}
    Si \( (\rho,V)\) et \( (\rho',V')\) deux représentations irréductibles de décompositions
    \begin{subequations}
        \begin{align}
            V&=\bigoplus_ik_iW_i\\
            V'&=\bigoplus_ik_i'W_i,
...
\begin{theorem}
    Si \( \chi\) est un caractère, alors \( \langle \chi, \chi\rangle \in \eN\) et \( \langle \chi, \chi\rangle =1\) si et seulement si c'est un caractère irréductible.   
\end{theorem}
...
Soit \( G=S_3\), un des premiers groupes finis non abéliens. On en a une représentation de dimension deux en tant que permutation des sommets d'un triangle équilatéral. Comme dans l'exemple \ref{ExKUAyUD}
