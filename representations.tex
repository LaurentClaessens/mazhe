...
\begin{proof}
    ...
    \begin{equation}
        \id=P_G+(\id-P_G).
    \end{equation}
    Étant donné que l'opérateur \( P_G\) commute avec tous les \( \rho(g)\), l'ensemble \( \ker(P_G)\) est un sous-espace stable : si \( z\in \ker(P_G)\), alors \( P_G\rho(g)z=\rho(g)P_Gz=0\).
