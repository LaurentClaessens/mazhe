...
\begin{proof}
    ...
    En ce qui concerne l'autre assertion, le calcul est le même et nous obtenons
    \begin{equation}
...
\begin{theorem}[Décomposition de Bruhat]\index{Bruhat (décomposition)}\index{décomposition!Bruhat}    \label{ThoizlYJO}
    Un élément \( M\in\GL(n,\eR)\) où s'écrit sous la forme
    \begin{equation}
        M=T_1P_{\sigma}T_2
    \end{equation}
...
\begin{proof}
    ...
    \end{equation}
        ...
        \item[Unicité]
            ...
            Soient \( \sigma,\sigma\in S_n'\) tels que \( T_1P_{\sigma}T_2=S_1P_{\sigma'}S_2\) avec \( T_i\) et \( S_i\) triangulaires supérieures et inversibles. En posant \( T=T_2S_2^{-1}\) et \( S=T_1^{-1}S_1\), nous avons
            \begin{equation}
                P_{\sigma}T=SP_{\sigma'}
            \end{equation}
            <++>
