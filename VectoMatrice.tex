...
\begin{proof}
    ...
    \end{equation}
    avec \( c_{il}\in \eK\). Nous voyons \( c_{i,\ldot}\) comme un élément de \( \eK^m\) et donc nous écrivons\footnote{Il me semble qu'il manque la somme sur \( i\) dans \cite{fJhCTE}.}
    \begin{equation}
...
\begin{theorem}[Théorème spectral pour les matrices normales]\index{théorème!spectral!matrices normales}  \index{diagonalisation!cas complexe}  \label{ThogammwA}
...
\begin{theorem} \label{ThoeTMXla}   \index{diagonalisation!cas réel}
