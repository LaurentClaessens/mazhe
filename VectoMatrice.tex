...
\begin{proof}
    ...
    \end{equation}
    avec \( c_{il}\in \eK\). Nous voyons \( c_{i,\dot}\) comme un élément de \( \eK^m\) et donc nous écrivons\footnote{Il me semble qu'il manque la somme sur \( i\) dans \cite{fJhCTE}.}
    \begin{equation}
