...
\begin{InternalLinks}
    La proposition \ref{PropLJEJooMOWPNi} sur l'équivalence des normes dans \( \eR^n\) est utilisée pour montrer que le problème \( a-b\) est stable dans l'exemple \ref{ExooXJONooTAYZVc}.
\end{InternalLinks}
...
\begin{proposition}[\cite{ooCUHNooNYIeGt}]
