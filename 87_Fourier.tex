...
\begin{proposition}[\cite{CXCQJIt}]     \label{PROPooUNFYooYdbSbJ}
...
La théorie des transformées de Fourier est intéressante sur \( L^2(\eR^d)\) parce qu'elle y donne une isométrie.
...
\begin{proof}
    ...
    \begin{equation}
        \clubsuit=\int_{\eR^d}| \TF(f)(\xi) |^2 e^{-\epsilon\xi^2}d\xi
    \end{equation}
    existe et est finie.
\end{proof}
<++>
