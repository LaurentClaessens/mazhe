...
Sources : \cite{SuquetFourierProba}, le \wikipedia{fr}{théorème_de_Riesz-Fischer}{théorème de Riesz-Fischer} sur wikipedia.
...
Nous avons 
\begin{equation}
    \| \sum_{n=0}^{\infty} f_{N_n+1}-f_{N_n} \|\leq\sum_{n=0}^{\infty}\| f_{N_n+1}-f_{N_n} \|<\infty
\end{equation}
