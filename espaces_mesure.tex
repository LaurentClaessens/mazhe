...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
\section{Maximisation avec contraintes}
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

Dans la proposition suivante, les fonctions \( g_i\) donnent la contrainte.
...
\begin{proof}
    Nous notons \( s=n-r\) et nous identifions \( \eR^n=\eR^s\times \eR^r\). Les éléments de \( \eR^n\) seront notés \( (x_1,\ldots, x_s,y_1,\ldots, y_r)\). Soit \( a=(\alpha,\beta)\). Si \( r=n\) alors les formes linéairement indépendantes \( (dg_i)_a\) forment une base de \( (\eR^n)'\) et donc évidemment les \( \lambda_i\) existent. Nous supposons donc maintenant que \( r<n\).

    La matrice
    \begin{equation}
        \begin{pmatrix}
            \frac{ \partial g_1 }{ \partial x_1 }    &   \ldots    &   \frac{ \partial g_1 }{ \partial x_s }    &    \frac{ \partial g_1 }{ \partial y_1 }    &   \ldots    &   \frac{ \partial g_1 }{ \partial y_r }\\  
            \vdots    &       &   \ddots    &       &       &   \vdots\\
            \frac{ \partial g_r }{ \partial x_1 }    &       &   \ldots    &       &       &   \frac{ \partial g_r }{ \partial y_r }
        \end{pmatrix}
    \end{equation}
    est de rang \( r\) parce que les lignes sont par hypothèses linéairement indépendantes. Quitte à renommer les indices, nous supposons que
    \begin{equation}
        \det\begin{pmatrix}
        ...
        \end{pmatrix}\neq 0.
    \end{equation}
    Si nous notons \( g=(g_1,\ldots, g_r)\), le théorème de la fonction implicite (\ref{ThoAcaWho}) nous dit qu'il existe un voisinage \( U'\) de \( \alpha\in \eR^s\), un voisinage \( V'\) de \( \beta\in \eR^r\) et une fonction \( \varphi\colon U'\to V'\) de classe \( C^1\) telle que si \( (x,y)\in U'\times V'\), alors
    \begin{equation}
        g(x,y)=0
    \end{equation}
    ...
    \begin{subequations}
        ...
        \end{align}
    \end{subequations}
    Nous avons \( \psi(\alpha)=a\) et \( \psi(x)\in\Gamma\) pour tout \( x\in U'\). La fonction \( h\) a donc un extréma local en \( \alpha\) et donc les dérivées partielles de \( h\) y sont nulles. Cela signifie que
    \begin{equation}
        0=\frac{ \partial h }{ \partial x_i }(\alpha)=\sum_{j=1}^s\frac{ \partial f }{ \partial x_j }\frac{ \partial x_j }{ \partial x_i }+\sum_{k=1}^r\frac{ \partial f }{ \partial y_k }\frac{ \partial \varphi_k }{ \partial x_i }.
    \end{equation}
    <++>
\end{proof}
<++>
