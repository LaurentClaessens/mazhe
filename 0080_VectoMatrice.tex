...
\begin{proof}
    Vu que \( \eC\) est algébriquement clos (théorème \ref{}) nous pouvons considérer les racines \( \alpha_1,\ldots, \alpha_n\) de \( P\) dans \( \eC\). Nous les considérons avec leurs multiplicités.
%TODO : lorsqu'on aura démontré que \eC est algébriquement clos, il faudra le référentier ici.
    ...
    \begin{equation}
        R_k=\begin{pmatrix}
            1&a_{n-1}&\cdots&a_0&0&\cdots&0&0\\  
            0&1&a_{n-1}&\cdots&a_0&0&\cdots&0\\  
            \vdots&\ddots&\ddots&\ddots&&\ddots&\\  
            0&\cdots&0&1&a_{n-1}&\cdots&\cdots&a_0\\  
            \hline
            1&0&\cdots&-Y&0&\cdots&\cdots&0\\  
        0&1&0&\cdots&-Y&0&\cdots&0\\  
    0&0&\ddots&<++>&<++>&<++>&<++>&<++> \\
        0&0&0&1&0&\cdots&\cdots&-Y
        \end{pmatrix}<++>
    \end{equation}
    <++>
\end{proof}
