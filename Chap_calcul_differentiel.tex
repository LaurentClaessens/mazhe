...
Nous avons déjà démontré (lemme \ref{LemdfaSurLesPartielles}) que si $f$ est différentiable au point $x$ alors  $df(x).u=\partial_uf(x)$. Une importante conséquence est le théorème des accroissements finis
...
\begin{proposition}[Formule de Taylor avec reste intégral\cite{VBYOJrU}]
