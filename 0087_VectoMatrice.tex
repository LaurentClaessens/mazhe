...
La proposition suivante est très semblable au théorème de diagonalisation \ref{ThoDigLEQEXR}.
\begin{proposition}\label{PropDSEHooVgipib}
    Soit \( u\) un endomorphisme sur un espace vectoriel \( E\) de dimension finie. Il y a équivalence entre les choses suivantes.
    \begin{enumerate}
        \item
            L'endomorphisme \( u\) est trigonalisable, avec les valeurs propres sur la diagonale.
        \item
