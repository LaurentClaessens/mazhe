...
\begin{lemma}   \label{LemYVWoohcjIX}
    ...
    \begin{subequations}\label{subEqHIQooyhiWM}
        \begin{align}
            S&=\frac{ M+M^t }{ 2 }
            A&=\frac{ M-M^t }{ 2 }
        \end{align}
...
\end{definition}
Une autre façon d'écrire la relation \eqref{EqSNWooXfbTH} est d'écrire \( (x-v),M(x,v)\) en utilisant le produit scalaire.
...
%AFAIRE : définir les matrices définies positives dans le cas symétrique et montrer que c'est équivalent à x^tMx>0.
