...
\begin{corrige}{FoncDeuxVar0016}
	...
	\newcommand{\CaptionFigExoHuitSept}{Quelque courbes de niveau pour l'exercice \ref{exoFoncDeuxVar0016}.}
	\input{Fig_ExoHuitSept.pstricks}
	Quelque courbes de niveau sont tracées sur la figure \ref{LabelFigExoHuitSept}. Notez qu'elles passent toutes par $(0,0)$. En effet, le centre $(C/2,C/2)$ est à une distance
	\begin{equation}
