...
Les exercices sont tapés dans les fichiers déjà pré-remplis \info{exercises/exo*.tex}. Les corrections sont dans le fichier \info{exercises/corr*.tex} correspondant. Ces fichiers ne sont pas inclus directement, mais via la macro \info{\textbackslash Exo}.
...
\begin{itemize}
    ...
    \item Tapez votre exercice dans \info{exercises/exomazhe-0018.tex} et votre correction dans \info{exercises/corrmazhe-0018.tex}. Ces fichiers sont déjà créés et pré-remplis. Ne changez pas le code qui y est.
\end{itemize}
