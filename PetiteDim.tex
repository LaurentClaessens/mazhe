...
As is subsection \ref{SubsecTwoDimAdSAdGH}, we see $AdS_2$ as $\Ad(G)H$.  From definition \ref{Singular}, the singularity is composed of closed orbits of $AN$ and $A\bar{N}$ for the adjoint action on $AdS_2$, and the notion of fundamental field is
\begin{equation}
