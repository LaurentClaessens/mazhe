...
%Rappelons qu'une fonction $f \colon \mathbb{C} \supset D \to \CC$ est {\bf uniformément continue} si pour tout $\eps >0$ il existe un $\gd >0$ tel que 
%$$
%|x-y| < \gd \,\Longrightarrow\, |f(x)-f(y)| < \eps 
%\quad \text{ pour tout }\, x,y \in D.
%$$
%Prouver que la fonction $f \colon \RR \to \RR$, $x \mapsto x^2$ est continue, mais n'est pas uniformément continue.
