...
\input{pictures_tex/Fig_ParamTangente.pstricks}
...
\input{pictures_tex/Fig_QuelCote.pstricks}
...
\input{pictures_tex/Fig_Osculateur.pstricks}
...
\begin{definition}      \label{DEFooTSJXooTIyRXf}
    ...
    \end{equation}
\end{definition}
\ifbool{isMazhe}{Cette définition est un cas très particulier des structures complexes sur les variétés, voir la définition \ref{DefSymHermMGKalg}.}{}
...
\input{pictures_tex/Fig_ERPMooZibfNOiU.pstricks}
...
\begin{proof}
    ...
    \item[Unicité]
        ...
        \begin{center}
            \input{pictures_tex/Fig_QMWKooRRulrgcH.pstricks}
        \end{center}
