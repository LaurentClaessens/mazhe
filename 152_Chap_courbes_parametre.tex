...
\begin{lemmaDef}        \label{DEFooTKBUooNVcheO}
    Soit une application continue \( \phi\colon S^1\to S^2\) et \( \varphi\colon \eR\to \eR\) une application continue telle que
    \begin{equation}
...
\begin{proposition}[\cite{ooIEJXooIYpBbd}]
    Deux courbes homotopes ont même indice de rotation.
\end{proposition}
...
\begin{proof}
    ...
    \item[Indice de rotation pour des courbes]
