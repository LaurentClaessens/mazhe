...
\begin{proof}
    Vu que \( D\) est borné, toute droite passant par l'intérieur de \( D\) coupe \( \partial D\) en au moins deux points (un dans chaque sens, et en utilisant le lemme de passage de douane \ref{LEMooLKWEooItGnkP}).
