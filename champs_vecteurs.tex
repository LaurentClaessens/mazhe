...
\begin{example}
    Considérons l'arc de cercle de rayon $R$ interceptée par l'angle $\theta$ présenté sur la figure \ref{LabelFigArcCercleAngleOM}.
    \newcommand{\CaptionFigArcCercleAngleOM}{Quelle est la longueur de la partie bleue de ce cercle de rayon $R$ ?}
    \input{Fig_ArcCercleAngleOM.pstricks}
