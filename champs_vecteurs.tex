...
\begin{example}
    ...
    \input{pictures_tex/Fig_ChampGraviation.pstricks}
...
\begin{example}
    ...
    \input{pictures_tex/Fig_ooIHLPooKLIxcH.pstricks}
...
\begin{definition}
    Un champ de vecteurs $F\colon \eR^3\to \eR^3$ est un champ
    \defe{conservatif}{champ!conservatif} s'il existe une fonction $V\colon \eR^3\to \eR$ telle que
    \begin{equation}
        F(x)=\nabla V(x).
    \end{equation}
...
\input{pictures_tex/Fig_TKXZooLwXzjS.pstricks}
...
\begin{example}     \label{ExamDivFrotOM}
    ...
    \input{pictures_tex/Fig_DivergenceDeux.pstricks}
...
\begin{example}
    ...
    \input{pictures_tex/Fig_DivergenceTrois.pstricks}
