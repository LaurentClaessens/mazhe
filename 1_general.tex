...
\begin{definition}[injection, surjection, bijection]
    ...
    \begin{enumerate}
        \item
            La fonction \( f\) est \defe{injective}{injection} si \( f(x_1)=f(x_2)\), $x_1,\, x_2\in I$,  implique \( x_1=x_2\).

        \item

            La fonction \( f\) est \defe{surjective}{surjection} si tous les éléments de \( J\) sont atteins, c'est à dire si pour tout \( y\in J\) il existe \( x\in I\) tel que \( f(x)=y\).

        \item
            La fonction \( f\) est une \defe{bijection}{bijection} entre \( I\) et \( J\) si elle est injective et surjective, c'est à dire si pour tout \( y\in J\) il existe un unique \( x\in I\) tel que \( f(x)=y\).
    \end{enumerate}
\end{definition}
...
\begin{definition}
    Soit une bijection \( f\colon I\to J\). L'\defe{application réciproque}{application réciproque} de \( f\) est la fonction
    \begin{equation}
        \begin{aligned}
            f^{-1}\colon J&\to I \\
