...
\InternalLinks{Inégalité de Jensen}
    \begin{enumerate}
    \item
...
Il y a plusieurs résultats qui servent à diagonaliser.
    \begin{enumerate}
        \item
...
\InternalLinks{Théorème spectral}
    \begin{enumerate}
        \item
...
\InternalLinks{Convergence dominée de Lebesgue}
    \begin{enumerate}
        \item
