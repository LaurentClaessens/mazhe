...
\begin{definition}      \label{DefooMMKZooVcskCc}
    ...
    L'ensemble des vecteurs propres de \( A\) pour la valeur propre \( \lambda\) est l'\defe{espace propre}{espace!propre} de \( A\) pour la valeur \( \lambda\)\footnote{Nous laissons au lecteur le soin de vérifier que c'est bien un sous-espace vectoriel de \( E\).}.
\end{definition}
