...
\begin{definition}
 Lorsque $E$ est un espace topologique, nous disons qu'un sous-ensemble $A$ est \defe{non connexe}{connexe} quand on peut trouver des ouverts $O_1$ et $O_2$ disjoints tels que
