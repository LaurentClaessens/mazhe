...
\begin{center}
    Les compositions sont à remettre pour la séance du mercredi 9 mai 2012. Pour la correction, une attention particulière sera donnée à la rédaction. Vous devez exposer le plus clairement possible les étapes du raisonnement qui mènent à la solution. Vous pouvez travailler en groupe, mais vous devez remettre une copie par personne, et les corrections seront individuelles.
\end{center}
