...
\title{Devoir maison de outils math 2012}
\maketitle

\begin{center}
    Les compositions sont à remettre pour la séance du mercredi 9 mai 2012. Lors de la correction, une attention particulière sera donnée à la rédaction : vous devez exposer le plus clairement possible les étapes du raisonnement qui mènent à la solution. Vous pouvez travailler en groupe, mais vous devez remettre une copie par personne, et les corrections seront individuelles.
\end{center}

\Exo[0]{OutilsMath-0131}
\Exo[0]{OutilsMath-0132}
\Exo[0]{OutilsMath-0133}
\Exo[0]{OutilsMath-0134}
\Exo[0]{OutilsMath-0135}
\Exo[0]{OutilsMath-0136}
