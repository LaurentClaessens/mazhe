...
\begin{equation}
    e_n(t)= e^{int}.
\end{equation}
Une bonne partie de la douleur du mot «densité» consiste à montrer que ce système est total dans \( L^2(S^1)=L^2(\mathopen[ 0 , 2\pi \mathclose])\), et donc en est une base hilbertienne.
