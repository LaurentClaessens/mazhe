...
\begin{proof}
    ...
    \end{equation}
    Par conséquent \( (c_n)\in \ell^2(\eZ)\) et a fortiori \( (c_n)_{n\in \eN}\in \ell^2(\eN)\). L'inégalité de Cauchy-Schwartz nous indique alors
    \begin{equation}
...
\begin{theorem}[Inégalité isopérimétrique\cite{KXjFWKA}]
...
\begin{proof}
    ...
    \begin{equation}
        2\pi=\int_0^{2\pi}| f'(s) |^2ds=2\pi\langle f', f'\rangle=2\pi\sum_{n=-\infty}^{\infty}| c_n(f') |^2=2\pi\sum_nn^2| c_n(f) |^2.
    \end{equation}
    <++>
