...
\begin{proposition}
    Soit \( P\) n'importe quel polynôme unitaire irréductible dans \( \eF_p[X]\). Nous posons \( \eK=\eF_p[X]/(P)\). Alors
    \begin{enumerate}
        \item
        ...
        \item
            \( \eK=\eF_p[\alpha]\).
        \item
            Les racines de \( P\) sont \( \{ \alpha,\alpha^p,\ldots, \alpha^{p^{n-1}} \}\).
        \item
            \( P\) est scindé dans \( \eK\).
        \item
            \( P\) divise \( X^q-X\) dans \( \eF_p[X]\).
        \item
            La famille \( \{ \alpha,\alpha^p,\ldots, \alpha^{p^{n-1}} \}\) est une base de \( \eK\) en tant qu'espace vectoriel sur \( \eF_p\).
    \end{enumerate}
\end{proposition}
...
\begin{proof}
    \begin{enumerate}
        ...
        \item
            Si \( \beta\) est une racine de \( P\), alors \( \beta^p\) est une racine parce que si \( P=\sum_ka_kX^k\),
            \begin{subequations}
                \begin{align}
                    P(\alpha^p)&=\sum_ka_k(\alpha^k)^p\\
                    &=\sum_k(a_k\alpha^k)^p\\
                    &=(\sum_ka_k\alpha^k)^p\\
                    &=0
                \end{align}
            \end{subequations}
            parce que dans \( \eF_p\) nous avons \( x^p=x\) et \( (x+y)^p=x^p+y^p\).
