...
\begin{theorem}
    Soit \( I\) un idéal dans \( \eK[X]\). Alors il existe un polynôme \( P\) tel que \( I=(P)\).
...
\end{proof}
Nous voyons que n'importe quel polynôme de degré minimum dans un idéal génère l'idéal.
