...
Nous avons déjà dit un mot sur les idéaux principaux à définition \ref{DefIdPrinpuMrbOq} et nous avons parlé de l'idéal des polynôme annulateurs dans le théorème \ref{ThoCCHkoU}.
...
\begin{proof}
    Nous prenons \( \eL=\eK[X]/(P)\) où \( (P)\) est l'idéal dans \( \eK[X]\) généré par \( P\).
\end{proof}
<++>
