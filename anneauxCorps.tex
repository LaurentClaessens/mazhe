...
\begin{example}     \label{ExmuQisZU}
    ...
    Vu que les nombres \( x\pm i\sqrt{2}\) sont premiers entre eux et que leur produit doit être un cube, ils doivent être séparément des cubes. Nous devons donc résoudre séparément \( x\pm i\sqrt{2}=y^3\).
