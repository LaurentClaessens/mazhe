...
Alice veut envoyer un message à Bob. Pour ce faire, Bob choisit deux nombres premiers \( p,q\), calcule \( n=pq\) et choisit un nombre \( e\in \eF_n\), c'est à dire \( e\) premier avec \( n\). Bob publie le couple \( (n,e)\).
...
\begin{lemma}[Lemme de Gauss]       \label{LemEfdkZw}   \index{lemme!Gauss}\index{Gauss!lemme}
