...
\begin{proof}
    ...
    \begin{equation}
        F_{k,q}(X_1,\ldots, X_n)=(-1)^k\sum_{i_1\leq\ldots\leq i_k}(X_{i_1}\ldots X_{i_k})^q
    \end{equation}
    qui sont des polynômes symétriques. En particulier les polynômes \( F_{r,1}\) sont les polynômes symétriques élémentaires à un coefficients près. Le théorème \ref{TholReBiw} nous donne alors des polynômes \( G_{k,q}\in \eZ[X_1,\ldots, X_n]\) tels que
    \begin{equation}
