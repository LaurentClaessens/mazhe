...
\begin{center}
   \input{pictures_tex/Fig_YYECooQlnKtD.pstricks}
\end{center}
...
\begin{center}
   \input{pictures_tex/Fig_UIEHooSlbzIJ.pstricks}
\end{center}
...
\begin{center}
   \input{pictures_tex/Fig_UGCFooQoCihh.pstricks}
\end{center}
...
\begin{center}
   \input{pictures_tex/Fig_UMEBooVTMyfD.pstricks}
\end{center}
...
\input{pictures_tex/Fig_ChiSquared.pstricks}
...
\lstinputlisting{src_frido/code_sage1.py}
...
\lstinputlisting{src_frido/code_sage2.py}
