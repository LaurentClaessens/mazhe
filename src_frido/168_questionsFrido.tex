...
\begin{enumerate}
    \item
        Est-ce que toute tribu est la tribu borélienne d'une topologie ?
    \item
        Il n'y a pas de liens très forts entre topologie et mesure sur un ensemble donné, voir par exemple l'exemple \ref{EXooKQDRooVMWaEC} qui donne un compact de \( \eR\) qui a une mesure infinie pour la mesure de densité \( 1/| x |\) par rapport à la mesure de Lebesgue.
