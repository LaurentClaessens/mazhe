...
Certains exemples utilisent ce module qui sert à automatiser certaines tâches : \info{outilsINGE.sage}
\lstinputlisting{src_sage/outilsINGE.sage}
...
\lstinputlisting{src_sage/exoDV002.sage}

La sortie est :

\VerbatimInput[tabsize=3]{src_sage/exoDV002.txt}
...
\lstinputlisting{src_sage/exo11.sage}

Le résultat est le suivant :

\VerbatimInput[tabsize=3]{src_sage/exo11.txt}
...
\lstinputlisting{src_sage/exo13.sage}

La sortie est ici :

\VerbatimInput[tabsize=3]{src_sage/exo13.txt}
...
\begin{example}     \label{exBNGVooIvKfTT}
	...
	\lstinputlisting{src_sage/exo65.sage}
...
\begin{example}     \label{exHWIHooOAvaDQ}
	...
	\lstinputlisting{src_sage/exo103.sage}
...
\begin{example}     \label{exEEHPooKDxLTJ}
	...
	\lstinputlisting{src_sage/exo104.sage}

	La sortie est

	\VerbatimInput[tabsize=3]{src_sage/exo104.txt}
...
\lstinputlisting{src_sage/corrDerive_0002.sage}

Le résultat est :
\VerbatimInput[tabsize=3]{src_sage/corrDerive_0002.txt}
