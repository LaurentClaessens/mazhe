...
\begin{lemma}
    Soit \( f\in L^2(\Omega)\) où \( \Omega\) est un ouvert de \( \eR^d\). La norme de \( f\) peut être exprimée par la formule suivante :
    \begin{equation}
        \| f \|_{L^2(\Omega)}=\sup\{ | \langle f, \phi\rangle_{L^2(\Omega)} |\text{ avec }\phi\in\swD(\Omega), \| \phi \|_{L^2(\Omega)}\leq 1 \}.
    \end{equation}
\end{lemma} 
