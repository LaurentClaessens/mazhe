...
Nous allons à présent discuter de quelque chose qui s'appelle le «birapport» et qui n'est a priori pas du tout lié au birapport définit en \ref{DEFooBFSKooDwzwmO}.

\begin{definition}[Birapport dans \( \hat\eC\)\cite{ooZYLAooXwWjLa}]
        ...
        \item[Tous les points sont distincts et dans \( \eC\)]
            ...
            \begin{subequations}
                \begin{align}
                    ...
                    [\vect{ ca },\vect{ cb }]-[\vect{ xa },\vect{ xb }]\in[0]_{\pi},\\
                    [\vect{ ca },\vect{ cb }]-[\vect{ xa },\vect{ xb }]\subset[0]_{\pi}.
                \end{align}
            \end{subequations}
            <++>
...
\begin{definition}
    ...
    \end{equation}
    pour tout \( a\in \eR^2\) et \( u,v\in \eR^2\). Ici il est mieux de penser à \( u,v\in T_a\eR^2\) qui qui sait les espaces tangents en géométrie différentielle.
\end{definition}
...
\begin{proof}
    ...
    \lstinputlisting{src_sage/sageSnip009.sage}
