...
Un espace vectoriel topologique métrisable possède évidemment une base dénombrable de topologie (celle des boules de la distance). Le contraire est également vrai.
\begin{theorem}[\cite{ooOFEPooVFgTXm}]
    Si $V$ est un espace vectoriel topologique possédant une base de topologie dénombrable, alors il existe une distance \( d\) sur \( V\) telle que
    \begin{enumerate}
        \item
