...
\begin{example}[La complétude n'est pas une propriété topologique\cite{ooSCDYooWutzzr}]     \label{EXooNMNVooXyJSDm}
    ...
    \begin{equation}
        d(x_n,k)=| \frac{1}{ n }-\frac{1}{ k } |\to \frac{1}{ k }\neq 0.
    \end{equation}
    L'espace \( (\eN,d)\) n'est pas complet.
...
\begin{definition}[Suite de Cauchy, espace vectoriel topologique\cite{TQSWRiz}]   \label{DefZSnlbPc}
