...
\lstinputlisting{src_frido/courbeNiveau.py}
...
\begin{definition}      \label{DefJSFFooEOCogV}
    ...
    \begin{equation}
        ...
        \end{aligned}
    \end{equation}
    est \defe{localement Lipschitz}{Lipschitz!localement} en \( y\) au point \(
    (t_0,y_0)\) s'il existe des voisinages \( V\) de \( t_0\) et \( W\) de \( y_0\) et un nombre \( k>0\) tels que pour tout \( (t,y)\in V\times W\) on ait
    \begin{equation}
