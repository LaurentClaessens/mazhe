...
\begin{proof}
    ...
    \begin{center}
   \input{pictures_tex/Fig_EHDooGDwfjC.pstricks}
    \end{center}
...
\begin{example}[Multiplication à la règle et au compas\cite{POUoocLUrO}]    \label{ExGROooIosiBt}
    ...
    \begin{center}
   \input{pictures_tex/Fig_UYJooCWjLgK.pstricks}
    \end{center}
...
\begin{example}[Racine carré à la règle et au compas\cite{POUoocLUrO}]  \label{ExTYMooSMCvSr}
    ...
    \begin{center}
   \input{pictures_tex/Fig_QIZooQNQSJj.pstricks}
    \end{center}
...
\begin{example}[Duplication d'un angle] \label{ExAHCooELGGPa}
    ...
    \begin{center}
        \input{pictures_tex/Fig_WHCooNZAmYB.pstricks}
    \end{center}
