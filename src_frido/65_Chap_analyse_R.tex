...
\input{pictures_tex/Fig_TangenteQuestion.pstricks}
...
\input{pictures_tex/Fig_TangenteDetail.pstricks}
...
\input{pictures_tex/Fig_LesSubFigures.pstricks}
...
\input{pictures_tex/Fig_NOCGooYRHLCn.pstricks}
...
\begin{equation}
	S_f(x)=\int_0^xf(t)dt.
\end{equation}
Nous pouvons nous demander si, pour une fonction $f$ donnée, il existe une ou plusieurs
primitives, c'est à dire s'il existe une ou plusieurs fonctions $F$ telles que $F'=f$. La réponse viendra\ldots
...
\input{pictures_tex/Fig_GWOYooRxHKSm.pstricks}
