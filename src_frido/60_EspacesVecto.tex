...
\begin{definition}[matrices semblables] \label{DefCQNFooSDhDpB}
    ...
    nous introduisons la relation d'équivalence \( A\sim B\) si et seulement s'il existe une matrice \( P\in\GL(n,\eK)\) telle que \( B=P^{-1}AP\). Deux matrices équivalentes en ce sens sont dites \defe{semblables}{semblables!matrices}.
\end{definition}
...
\begin{definition}
    ...
    \eC\)). Un nombre réel \( \sigma\) est une \defe{valeur singulière}{valeur!singulière}
