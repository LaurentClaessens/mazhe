...
\begin{normaltext}
    ...
    \begin{itemize}
        \item inversion\footnote{Oui, c'est l'inversion de la géométrie hyperbolique, voir \ref{SSUBSooPOUNooTPilbE}.} \( z\mapsto 1/\bar z\)
...
\begin{normaltext}
    La proposition \ref{PROPooMIMRooTbQRVI} montre que toute inversion transforme un cercle-droite en un cercle-droite, nonobstant d'accepter de prolonger toute droite par \( \infty\). Nous l'acceptons : une droite de \( \hat\eC\) est 
\end{normaltext}
