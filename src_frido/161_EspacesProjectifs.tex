    ...
    ce qui termine de montrer que \( \{ m'_i \}_{i=0,\ldots, n+1}\) est un repère projectif de \( P(F)\).
        ...
        \item[\ref{ITEMooQXQXooDyIsxsh}]
            ...
            \begin{subequations}
                ...
                \end{align}
            \end{subequations}
            Nous considérons un isomorphisme d'espace vectoriel \( \bar\phi\colon E\to F\) tel que \( \bar\phi(e_i)=f_i\) pour tout \( i\).
...
Soit une droite projective \( d\) et trois points distincts \( a\), \( b\) et \( c\) sur cette droite. Étant donné qu'ils forment un repère projectif, il existe une unique homographie\footnote{Théorème \ref{THOooTXPVooJGigne}\ref{ITEMooQXQXooDyIsxsh}.} 
\begin{equation}
    \begin{aligned}
