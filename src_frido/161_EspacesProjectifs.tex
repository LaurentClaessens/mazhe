...
\begin{definition}
    ...
    \begin{subequations}
        ...
        \end{align}
    \end{subequations}
    Une application \( g\colon P(E)\to P(F)\) est une \defe{homographie}{homographie} s'il existe un isomorphisme d'espaces vectoriels \( \tilde g\colon E\to F\) tel que le diagramme
    \begin{equation}
        \xymatrix{%
    ...
    \end{equation}
    commute, c'est à dire s'il existe \( \tilde g\colon E\to F\) telle que
    \begin{equation}
