...
\end{equation}
is the light-cone in $G/H$.  \ifthenelse{\value{siTHZ}=1}{}{Note that in this equation, the first $\exp$ is the
one defined from the $AdS_l$\rnode{AdA}-connection
\ifthenelse{\value{siTHZ}=1}{}{
\marginpar{{\bf Enfin je l'ai plac\'ee !}
       \rput(0,0.1){\rnode{AdB}{}}
          }
}
...
\nccurve[angleA=0,angleB=90]{->}{AdB}{AdA}
