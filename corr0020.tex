...
\end{equation}
de telle manière à ce que $x_k=\sum_{i=0}^kA_k(i)$. Manifestement, tant que $i<k+1$ (ce qui est toujours le cas dans les sommes considérées), $A_k(i)\geq 0$ et $A_{k+1}(i)-A_k(i)\geq 0$ pour tout $k$ et tout $i$. Donc
\begin{equation}
