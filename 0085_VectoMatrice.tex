...
\end{equation}
voir \ref{SubSechZeTuL}. Le polynôme \( \phi_n\) est un polynôme unitaire de degré est donné par l'indicatrice d'Euler\footnote{Définie par l'équation \ref{EqEulerGqPsvi}.} \( \varphi(n)\). Nous avons par exemple
\begin{subequations}
    \begin{align}
        \Delta_1&=\{ 1 \}\\
        \Delta_2&=\{ -1 \}\\
