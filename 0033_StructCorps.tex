    ...
    \begin{subproof}
        ...
        \item[Sens réciproque]
            ...
            \begin{equation}
                [\eQ(\omega):\eQ]=p-1.
            \end{equation}
            Nous considérons le groupe \( G=\Aut_{\eQ}\big( \eQ(\omega) \big)\) des automorphismes du corps \( \eQ(\omega)\) agissant sur \( \eQ\) comme l'identité. Tous les éléments de \( \eQ(\omega)\) étant des polynômes en \( \omega\) (proposition \ref{}<++>)<++>
    \end{subproof}
