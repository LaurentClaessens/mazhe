...
\begin{proof}
    ...
    \begin{remark}
        Attention : ceci n'est pas une preuve. En effet, dans la mesure où nous n'avons même pas donné de définition de la limite, il n'est pas possible de donner une \emph{vraie} preuve de quoi que ce soit. Si vous voulez des démonstrations et de la vraie théorie vous devez lire le chapitre \ref{ChapCalculDiff}.
    \end{remark}
\end{proof}
