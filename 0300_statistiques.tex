...
%AFAIRE : citer Wikipédia pour ce théorème.
\begin{theorem}[Glivenko-Cantelli]  \label{ThoXAEMbTI}
...
\end{proof}
Note : l'hypothèse \( nh_n\to\infty\) revient à dire que nous voulons que chaque boite contienne de plus en plus d'observations. Si nous avions \( nh_n\to 0\), alors avec \( n\) qui augmente, la majorité des boites deviendraient vides, ce qui reviendrait à une perte d'information.
