...
\begin{corollary}\label{CorJKIooBqbqax}
    Soit un corps \( \eK\) et une extension \( \eL\). Soit \( P\in \eK[X]\) et  \( a\in \eL\), une racine de \( P\). Alors le polynôme minimal de \( a\) dans \( \eK[X]\) divise \( P\). En d'autre termes, le polynôme minimal d'une racine divise tout polynôme annulateur.
\end{corollary}
...
\begin{proof}
    Si \( p=1\), alors le résultat est le corollaire \ref{CorJKIooBqbqax} dans lequel il ne faut pas d'extension, d'où le fait que le polynôme minimal de \( \alpha\) soit \( X-\alpha\).
