...
\begin{theorem}[\cite{RATEooJuqgom}]
...
Nous introduisons ici la fonction indicatrice d'Euler et ses liens basiques avec les racines de l'unité. Pour les propriétés plus avancées, voir la section \ref{SecKGDFooAbETjs}.
...
\begin{proposition}[Des intersections]
...
\begin{proof}
    ...
    \item[Sens direct]
        ...
        \begin{equation}
            k\beta=l\alpha.
        \end{equation}
        Le nombre \( \alpha\) divise \( k\beta\); et si nous supposons que \( \alpha\) et \( \beta \) étaient premiers entre eux, cela conduirait via le lemme de Gauss \ref{LemSdnZNX} à dire que \( \alpha\) divise \( k\). Mais \( \alpha\) ne peut pas diviser \( k\) parce que nous avions supposé que \( k\) était strictement plus petit que \( \alpha\).
...
%--------------------------------------------------------------------------------------------------------------------------- 
\subsection{Irrationalité de \texorpdfstring{$ \sqrt{2}$}{racine de 2}}
%---------------------------------------------------------------------------------------------------------------------------
