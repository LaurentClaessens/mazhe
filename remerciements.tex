...
\begin{description}
    \item[Les personnes qui ont mis du code \LaTeX] 
        Des personnes qui m'ont donné du code \LaTeX\ à inclure dans cet ouvrage.
        \begin{enumerate}
            \item
    ...
    \item[Ceux à qui je dois beaucoup plus que un ou deux développements]
        Certaines personnes ont tapé des recueils de développements dans lesquels j'ai abondamment puisé.
        \begin{enumerate}
            \item 
    ...
    \item[Autres contributions et aides]
        Beaucoup de monde m'a fourni de l'aide, en me donnant des cours, en rédigeant des textes bien faits, en me donnant des exemples ou en me signalant des fautes.
\begin{enumerate}
    \item
