...
\begin{definition}\label{DefVJIeTFj}
    Un \defe{produit scalaire}{produit!scalaire!en général} sur un espace vectoriel \( E\) est une forme bilinéaire symétrique strictement définie positive\footnote{Définition \ref{DEFooJIAQooZkBtTy}.}.
\end{definition}
...
\begin{InternalLinks}
    Utilisation norme matricielle et de rayon spectral.
    \begin{enumerate}
        \item
