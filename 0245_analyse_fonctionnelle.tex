...
Nous postposons à la section \ref{SecCKZSrZK}, lorsque nous parlerons de séries de Fourier, l'étude plus avancée de l'espace \( L^2(\mathopen] 0 , 2\pi \mathclose[)\).
    À ce moment, le produit scalaire sera défini avec un coefficient \( 1/2\pi\). Voir l'équation \eqref{EqQBcpyyJ}.
