...
Sources : \cite{GubinelliMartin,PMCmartinLP}.

\begin{theorem}[Doob]\index{théorème!Doob de convergence des martingales}
    \begin{enumerate}
        \item
            Une martingale terminée converge presque partout et en norme \( L^1\).
        \item
            Une martingale bornée dans \( L^2\) converge presque surement et en norme \( L^2\).
    \end{enumerate}
\end{theorem}
...
\begin{example}
    ...
    \end{equation}
    et nous allons voir que c'est une martingale adaptée à la filtration \( \tribF_n=\sigma(V_1,\ldots, V_n)\).
\end{example}
