...
Soit \( (Y_n)\) une suite de variables aléatoires indépendantes et identiquement distribuées telles qui vaut \( -1\) avec une probabilité \( p\) et \( 1\) avec une probabilité \( (1-p)\).
