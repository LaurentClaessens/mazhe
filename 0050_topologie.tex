...
Notons que si \( (E,p_i)\) n'est pas séparé, cette définition n'a pas d'intérêt. Si il y a unicité de l'élément vers lequel une fonction peut converger, alors nous pouvons écrire
\begin{equation}
    \lim_{y\to t_0} f(t)=y.
\end{equation}
